...
<table class="table table-bordered table-striped table-hover">
    <tr>
        ...
        <td rowspan="4" id="imagen"  style="width:40%"  align="center">Imagen del producto</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Sentido</td>
        <td> <select name="lado" id="lado" style="width: 100%;" required>                                                       
...
<div class="modal-footer">
    ...
    <div id="mensaje"></div>
    <br>
    <button type="button" id="guardar_pro" class="btn btn-primary" data-dismiss="modal"  aria-hidden="true">Guardar</button>
    <button type="button" class="btn" data-dismiss="modal" aria-hidden="true">Salir</button>
</div>