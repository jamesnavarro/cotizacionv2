...
function pasarvidrio(){
    window.opener.refvidrios12(document.getElementById('datos1').value,document.getElementById('datos2').value,
...
while($row=mysqli_fetch_array($request))
    ...
    $c += 1;
      $table = $table.'<tr><td>'.$c.'</td>'
              ...
              . '<td><a href="../combos_cotizacion/vidrio1.php?codigo='.$row["id_p"].'">'.$row["producto"].'</a></td>
