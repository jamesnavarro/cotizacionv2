...
function pasarvidrio(){
    window.opener.refvidrios24(document.getElementById('datos1').value,document.getElementById('datos2').value,
...
//        require '../modelo/consulta_empresa.php';
	...
	{       
      $table = $table.'<tr><td>'.$row["id_p"].'</td>'
              ...
              . '<td><a href="../combos_cotizacion/vidrio2.php?codigo='.$row["id_p"].'">'.$row["producto"].'</a></td>
