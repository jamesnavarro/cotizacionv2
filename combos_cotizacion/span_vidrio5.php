...
function pasar(){
    window.opener.vidrios510(document.getElementById('datos1').value,
...
//        require '../modelo/consulta_empresa.php';
	while($row=mysql_fetch_array($request))
	{       
      $table = $table.'<tr><td><a href="../combos_cotizacion/span_vidrio5.php?codigo='.$row["id_vidrio"].'">'.$row["color_v"].'</a></td>
                   <td>'.$row['espesor_v'].'</td>
