...
if($_POST['cot']==''  && $_POST['nom']=='' && $_POST['obr']==''&& $_POST['reg']=='' ){
    $request=mysqli_query($conexion,"SELECT * FROM cotizacion a, cont_terceros b where a.id_tercero=b.id_ter order by a.numero_cotizacion desc LIMIT 30 ");
}else{
$request=mysqli_query($conexion,"SELECT * FROM cotizacion a, cont_terceros b where a.id_tercero=b.id_ter $cot $obr $reg");
}
