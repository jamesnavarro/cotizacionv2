...
$(function() {
    if(jQuery().fullCalendar) {
        ...
        $('#calendar').fullCalendar({
            ...
            editable: true,
            events:  {
            url: 'http://www.google.com/calendar/embed?src=jnavarro%40virtualdiseno.com&ctz=America/Bogota',
...
$(function () {
    if(jQuery().dataTable) {
        ...
        var $table = $('#datatable11').dataTable({
            ...
            "bProcessing": true,
            "sAjaxSource": '../vistas/cliente.txt',
            "aoColumns": [
                { "bSortable": false },
                null,
                null,
            ...
            "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                ...
                $('td:eq(3)', nRow).addClass('hidden-phone');
               $('td:eq(5)', nRow).addClass('hidden-phone');
        ...
        var $table = $('#datatable4').dataTable({
            "bProcessing": true,
            "sAjaxSource": '../vistas/tablas/proyectos.txt',
            "aoColumns": [
                { "bSortable": false },
                null,
                null,
        ...
        //lista de insumos
         var $table = $('#datatable5').dataTable({
            "bProcessing": true,
            "sAjaxSource": '../vistas/tablas/insumos.txt',
            "aoColumns": [
                { "bSortable": false },
                null,
                null,
        ...
        //lista de equipos
         var $table = $('#datatable6').dataTable({
            "bProcessing": true,
            "sAjaxSource": '../vistas/tablas/equipos.txt',
            "aoColumns": [
                { "bSortable": false },
                null,
                null,
        ...
        var $table = $('#datatable7').dataTable({
            "bProcessing": true,
            "sAjaxSource": '../vistas/detalles/proyecto.txt',
            "aoColumns": [
                { "bSortable": false },
                null,
                null,
          ...
          // lista de insumos de la fase
        var $table = $('#datatable8').dataTable({
            "bProcessing": true,
            "sAjaxSource": '../vistas/detalles/ins_proyecto.txt',
            "aoColumns": [
                { "bSortable": false },
                null,
                null,
  ...
  // lista de equipos de la fase
        var $table = $('#datatable9').dataTable({
            "bProcessing": true,
            "sAjaxSource": '../vistas/detalles/equ_proyecto.txt',
            "aoColumns": [
                { "bSortable": false },
                null,
                null,
          ...
          // lista de obreros de la fase
        var $table = $('#datatable10').dataTable({
            "bProcessing": true,
            "sAjaxSource": '../vistas/detalles/obr_proyecto.txt',
            "aoColumns": [
                { "bSortable": false },
                null,
                null,
