...
$tabla = $tabla.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv1/$_GET['cant']).'</td><td></td><td>-</td><td align="right">$'.number_format($totalv1).'</td></td><td></tr></table>';
...
$tabla = $tabla.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv2/$_GET['cant']).'</td><td></td><td>-</td><td align="right">$'.number_format($totalv2).'</td></td><td></tr></table>';
...
$tabla = $tabla.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv3/$_GET['cant']).'</td><td></td><td>-</td><td align="right">$'.number_format($totalv3).'</td></td><td></tr></table>';
...
$tabla = $tabla.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv4/$_GET['cant']).'</td><td></td><td>-</td><td align="right">$'.number_format($totalv4).'</td></td><td></tr></table>';
...
$tabla = $tabla.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv5/$_GET['cant']).'</td><td></td><td>-</td><td align="right">$'.number_format($totalv5).'</td></td><td></tr></table>';
