...
$status = "";
        ...
        if(isset($_GET['editar'])){
             ...
             echo '<script lanquage="javascript">alert("Se ha Editado Satisfactoriamente la informacion del producto '.$_POST["producto"].'");location.href="../vistas/?id=add_fachada&cod='.$_GET['editar'].'"</script>'; 
            ...
            $sql.= "VALUES ('".$hoja."', '".$referencia."', '".$rutaDestino2."', '".$altura_v_c."', '".$altura."', '".$producto."', '".$tipo_p."', '".$codigo."',  '".$tipo_v."', '".$color_a."', '".$ancho."', '".$alto."')";
            mysql_query($sql, $conexion);
            ...
            echo '<script lanquage="javascript">alert("Se ha Guardado Satisfactoriamente ");location.href="../vistas/?id=add_fachada&cod='.$max.'"</script>'; 
