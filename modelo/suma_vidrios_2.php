  ...
  $table = '<table  class="table table-bordered table-striped table-hover">';
             $table = $table.'<thead >';
              ...
              $table = $table.'<th>'.$color.'</th>';
               ...
               $table = $table.'<th>'.'Costo Perforacion y Boquete'.'</th>';
               $table = $table.'<th>'.'Costo Total'.'</th>';
               $table = $table.'<th>'.'Und Med.'.'</th>';
                $table = $table.'</tr>';
              $table = $table.'</thead>';
              
 $table = $table.'<tr><td>COSTO X M<SUP>2</SUP> :</td><td align="right">'.number_format($vvc/$_GET["cant"]).'</td><td></td><td align="right">'.number_format($vvc).'</td><td></td></tr>';
 $table = $table.'<tr><td>COSTO X M<SUP>2</SUP> CON '.$_GET['por'].' :</td><td align="right">'.number_format(($vvc/$porc)/$_GET["cant"]).'</td><td></td><td align="right">'.number_format($vvc/$porc).'</td></td><td></tr>';
...
if($valor1=='7'){
    ...
    $st = $m2 * $cost;
    $table = $table.'<tr><td>SERVICIO DE TEMPLE x M<sup>2</sup> '.$cost.', TOTAL :</td><td align="right">'.number_format($st/$_GET["cant"]).'</td><td></td><td align="right">'.number_format($st).'</td><td> POR KG</td></tr>';
}else{ $st = 0;}
if($und_med=='Kg'){
    $ti = $peso1 * $precio_a*$cp;
    $table = $table.'<tr><td>COSTO DE  '.$valor2.' : $</td><td align="right">'.number_format(($ti)).'</td><td>'.$pa.'</td><td align="right">'.number_format($ti + $pa).'</td><td > POR KG</td></tr>';
}
if($und_med=='Und'){
    $ti = $_GET["cant"] * $precio_a*$cp;
    $table = $table.'<tr><td>COSTO DE '.$valor2.' : $</td><td align="right">'.number_format(($ti)).'</td><td>'.$pa.'</td><td align="right">'.number_format($ti + $pa).'</td><td> POR UND</td></tr>';
}
if($und_med=='M2'){
    $ti = $m2 * $precio_a*$cp;
    $table = $table.'<tr><td>COSTO DE '.$valor2.' : $</td><td align="right">'.number_format(($ti)).'</td><td>'.$pa.'</td><td align="right">'.number_format($ti + $pa).'</td><td> POR M<sup2</sup></td></tr>';
}
...
$table = $table.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv1/$_GET["cant"]).'</td><td></td><td align="right">$'.number_format($totalv1).'</td></td><td></tr></table>';
...
$table = $table.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv2/$_GET["cant"]).'</td><td></td><td align="right">$'.number_format($totalv2).'</td></td><td></tr></table>';
...
$table = $table.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv3/$_GET["cant"]).'</td><td></td><td align="right">$'.number_format($totalv3).'</td></td><td></tr></table>';
...
$table = $table.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv4/$_GET["cant"]).'</td><td></td><td align="right">$'.number_format($totalv4).'</td></td><td></tr></table>';
...
$table = $table.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv5/$_GET["cant"]).'</td><td></td><td align="right">$'.number_format($totalv5).'</td></td><td></tr></table>';
...
$vvc = $m2 * $costo_vidrio;
  $table = '<table  class="table table-bordered table-striped table-hover">';
             $table = $table.'<thead >';
              ...
              $table = $table.'<th>'.$color.'</th>';
            $table = $table.'<th>'.'Costo Und'.'</th>';
             $table = $table.'<th>'.'Costo Per y Boq'.'</th>';
             $table = $table.'<th>'.'Costo Perforacion y Boquete'.'</th>';
               $table = $table.'<th>'.'Costo Total'.'</th>';
               $table = $table.'<th>'.'Und Med.'.'</th>';
                $table = $table.'</tr>';
...
$table = $table.'<tr><td>COSTO TOTAL : </td><td align="right">$'.number_format($totalv6/$_GET["cant"]).'</td><td></td><td align="right">$'.number_format($totalv6).'</td></td><td></tr></table>';
