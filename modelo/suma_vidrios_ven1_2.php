...
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidt']."'";
...
$consulta= 'SELECT * FROM pt_procesos a, subproceso b where  a.id_subpro=b.id_subpro and a.id_proceso="'.$traz_vid3.'"';                     
...
//echo 'total de la cot;'.number_format($totalv1);
if(isset($_POST['vidt2'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidt2']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
...
if(isset($_POST['vidt3'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidt3']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
...
if(isset($_POST['vidt4'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidt4']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
...
//vidrio 5
if(isset($_POST['vidt5'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidt5']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
...
//vidrio 6
if(isset($_POST['vidt6'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidt6']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
