...
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidc']."'";
...
$consulta= 'SELECT * FROM pt_procesos a, subproceso b where  a.id_subpro=b.id_subpro and a.id_proceso="'.$traz_vid4.'"';                     
...
//echo 'total de la cot;'.number_format($totalv1);
if(isset($_POST['vidc2'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidc2']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
...
if(isset($_POST['vidc3'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidc3']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
...
if(isset($_POST['vidc4'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidc4']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
...
//vidrio 5
if(isset($_POST['vidc5'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidc5']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
...
//vidrio 6
if(isset($_POST['vidc6'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidc6']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
