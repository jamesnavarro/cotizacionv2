...
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidd']."'";
...
$consulta= 'SELECT * FROM pt_procesos a, subproceso b where  a.id_subpro=b.id_subpro and a.id_proceso="'.$traz_vid2.'"';                     
...
//echo 'total de la cot;'.number_format($totalv1);
if(isset($_POST['vidd2'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidd2']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
...
if(isset($_POST['vidd3'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidd3']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
...
if(isset($_POST['vidd4'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidd4']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
...
//vidrio 5
if(isset($_POST['vidd5'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidd5']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
...
//vidrio 6
if(isset($_POST['vidd6'])){
    

//luego se calcula el peso del vidrio
$s3 = "SELECT * FROM tipo_vidrio where id_vidrio='".$_POST['vidd6']."'";
$fi3 =mysql_fetch_array(mysql_query($s3));
$costo_vidrio= $fi3["costo_v"];
$espesor= $fi3["espesor_v"];
