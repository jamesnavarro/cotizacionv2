<?php
                ...
                $fi3x =mysql_fetch_array(mysql_query($s3x));
                $porc= $fi3x["p"]/100;
...
$fi32 =mysql_fetch_array(mysql_query($s32));
...
$resultx2=  mysql_query($consultax2);
$total2 = 0;
$stt2=0;
//echo 'cantidad'.$cann.'<br>';      
while($fila=  mysql_fetch_array($resultx2)){
$valor1=$fila['id_subpro'];
$valor2=$fila['nombre_subpro'];
$precio_a = $fila['precio'];
$und_med = $fila['medida'];
...
$resultx3=  mysql_query($consultax3);
$total3 = 0;
$stt3=0;
//echo 'cantidad'.$cann.'<br>';      
while($fila=  mysql_fetch_array($resultx3)){
$valor1=$fila['id_subpro'];
$valor2=$fila['nombre_subpro'];
$precio_a = $fila['precio'];
$und_med = $fila['medida'];
...
$fi34 =mysql_fetch_array(mysql_query($s34));
...
$resultx4=  mysql_query($consultax4);
$total4 = 0;
$stt4=0;
//echo 'cantidad'.$cann.'<br>';      
while($fila=  mysql_fetch_array($resultx4)){
$valor1=$fila['id_subpro'];
$valor2=$fila['nombre_subpro'];
$precio_a = $fila['precio'];
$und_med = $fila['medida'];
...
$fi35 =mysql_fetch_array(mysql_query($s35));
...
$resultx5=  mysql_query($consultax5);
$total5 = 0;
$stt5=0;
//echo 'cantidad'.$cann.'<br>';      
while($fila=  mysql_fetch_array($resultx5)){
$valor1=$fila['id_subpro'];
$valor2=$fila['nombre_subpro'];
$precio_a = $fila['precio'];
$und_med = $fila['medida'];
...
$fi36 =mysql_fetch_array(mysql_query($s36));
...
$resultx6=  mysql_query($consultax6);
$total6 = 0;
$stt6=0;
//echo 'cantidad'.$cann.'<br>';      
while($fila=  mysql_fetch_array($resultx6)){
$valor1=$fila['id_subpro'];
$valor2=$fila['nombre_subpro'];
$precio_a = $fila['precio'];
$und_med = $fila['medida'];
