...
$resultfle=  mysql_query($consultafle);
while($fila=  mysql_fetch_array($resultfle)){
$id_fle=$fila['id_user'];
...
$resultveh=  mysql_query($consultaveh);
while($fila=  mysql_fetch_array($resultveh)){
$id_veh=$fila['id_user'];
...
$resulthoj=  mysql_query($consultahoj);
while($fila=  mysql_fetch_array($resulthoj)){
$id_hoj=$fila['id_user'];
...
$resulttra=  mysql_query($consultatra);
while($fila=  mysql_fetch_array($resulttra)){
$id_tra=$fila['id_user'];
