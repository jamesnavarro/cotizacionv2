...
//consulta de la cotizacion original
        ...
        $fila7 =mysqli_fetch_array(mysqli_query($conexion,$sql6));
...
//                  }
         ...
         $ver = mysqli_query($conexion,"INSERT INTO cotizaciones_servicios (id_cotizacion, id_servicio, cantidad_serv, descuento_serv, obs_servicio, precio_servicio) "
                 . "                                             select '$max', id_servicio, cantidad_serv, descuento_serv, obs_servicio, precio_servicio from cotizaciones_servicios where id_cotizacion='".$_GET['cod']."' and id_cot_mas=0 ;") ;
