...
//consulta de la cotizacion original
        ...
        $fila15 =mysql_fetch_array(mysql_query($sql1));
...
//se consulta las cotizaciones realizadas
         ...
         while($row2=mysql_fetch_array($request2))
	 {
            ...
            $sql5 = "INSERT INTO `cotizaciones_servicios` (`id_cotizacion`, `id_servicio`, `cantidad_serv`, `descuento_serv`)";
            $sql5.= "VALUES ('".$max."', '".$row2['id_servicio']."', '".$row2['cantidad_serv']."', '".$row2['descuento_serv']."')";
