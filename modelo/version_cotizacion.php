...
//consulta de la cotizacion original
        ...
        $numero_cotizacion= $fila6["numero_cotizacion"];
        ...
        $cot =mysqli_fetch_array(mysqli_query($conexion,$s));
        ...
        $sql11 = "SELECT max(id_cot) FROM cotizacion";
        $fila15 =mysqli_fetch_array(mysqli_query($conexion,$sql11));
        $max= $fila15["max(id_cot)"];
        
//se consulta las cotizaciones realizadas
        
         $request=mysqli_query($conexion,"SELECT * FROM cotizaciones  where id_cot=".$_GET["cod"]." and id_compuesto=0 ");
	 ...
	 {  
                 ...
                 mysqli_query($conexion,"insert into cotizaciones (`imagen`, `id_cot`, `id_referencia`, `laminas`, `laminas2`, `laminas3`, `laminas4`, `id_vidrio`, `id_vidrio2`, `id_vidrio3`, `id_vidrio4`, `id_vidrio5`, `id_vidrio6`, `cierre`, `ancho_c`, `ancho_c_original`, `alto_c`, `ancho_abajo`, `hojas`, `cuerpo`, `lado`, `cantidad_c`, `cantidad_temp`, `cant_restante`, `valor_c`, `valor_c_sp`, `valor_fom`, `valor_costob`, `valor_fomp`, `id_cliente`, `tipo_c`, `fecha_c`, `estado_c`, `registrado_por_c`, `aprobado`, `num_pedido`, `orden`, `asignado_a`, `linea_cot`, `cod_traz`, `boq`, `per`, `porcentaje`, `porcentaje_mp`, `descuento_g`, `color_ta`, `precio_item`, `precio_adicional`, `precio_material`, `precio_fom_sp`, `observaciones`, `observaciones2`, `desc`, `verticales`, `horizontales`, `d1`, `duracion`, `install`, `traz_vid`, `traz_vid2`, `traz_vid3`, `traz_vid4`, `ubicacion_c`, `tip`, `imagen_mas`, `an`, `al`, `fila`, `id2_vidrio`, `id2_vidrio2`, `id2_vidrio3`, `id2_vidrio4`, `id2_vidrio5`, `id3_vidrio`, `id3_vidrio2`, `id3_vidrio3`, `id3_vidrio4`, `id3_vidrio5`, `id4_vidrio`, `id4_vidrio2`, `id4_vidrio3`, `id4_vidrio4`, `id4_vidrio5`, `modulo`, `pelicula`, `huacal`, `ancho_temp`, `alto_temp`, `valor_temp`, `id_dolar`, `p_act_sp`, `p_act_cp`, `aprobado_por`, `servicio`, `estado_item`, `aprobado_por_user`, `fecha_aprobada`, `iva`, `ajuste`, `msg`, `msg2`, `peso_producto`, `valor_adicional`, `adicional_per`, `rollo`, `descripcion_rollo`, `cont_item`, `cantlam`, `poli`, `poli_v`, `poli_h`, `verpoli`, `rieles`, `alfajia`, `rejillas`, `cierres`, `rodajas`, `bisagras`, `can_rieles`, `can_alfajia`, `can_rejillas`, `can_cierres`, `can_rodajas`, `can_bisagras`, `poralu`, `porvid`, `poracc`, `porace`, `id_compuesto`, `compuestos`,`termovid1`,`termovid2`,`termovid3`,`termovid4`,`idespaciador`,`cantespaciador`,`id_dolar_actual`,`cobro`,`brazos`,`can_brazos`,`descripciones`,`vidrios`)"
                         . "                      select  `imagen`, '$max', `id_referencia`, `laminas`, `laminas2`, `laminas3`, `laminas4`, `id_vidrio`, `id_vidrio2`, `id_vidrio3`, `id_vidrio4`, `id_vidrio5`, `id_vidrio6`, `cierre`, `ancho_c`, `ancho_c_original`, `alto_c`, `ancho_abajo`, `hojas`, `cuerpo`, `lado`, `cantidad_c`, `cantidad_temp`, `cantidad_c`, `valor_c`, `valor_c_sp`, `valor_fom`, `valor_costob`, `valor_fomp`, `id_cliente`, `tipo_c`, `fecha_c`, `estado_c`, `registrado_por_c`, `aprobado`, `num_pedido`, `orden`, `asignado_a`, `linea_cot`, `cod_traz`, `boq`, `per`, `porcentaje`, `porcentaje_mp`, `descuento_g`, `color_ta`, `precio_item`, `precio_adicional`, `precio_material`, `precio_fom_sp`, `observaciones`, `observaciones2`, `desc`, `verticales`, `horizontales`, `d1`, `duracion`, `install`, `traz_vid`, `traz_vid2`, `traz_vid3`, `traz_vid4`, `ubicacion_c`, `tip`, `imagen_mas`, `an`, `al`, `fila`, `id2_vidrio`, `id2_vidrio2`, `id2_vidrio3`, `id2_vidrio4`, `id2_vidrio5`, `id3_vidrio`, `id3_vidrio2`, `id3_vidrio3`, `id3_vidrio4`, `id3_vidrio5`, `id4_vidrio`, `id4_vidrio2`, `id4_vidrio3`, `id4_vidrio4`, `id4_vidrio5`, `modulo`, `pelicula`, `huacal`, `ancho_temp`, `alto_temp`, `valor_temp`, `id_dolar`, `p_act_sp`, `p_act_cp`, `aprobado_por`, `servicio`, `estado_item`, `aprobado_por_user`, `fecha_aprobada`, `iva`, `ajuste`, `msg`, `msg2`, `peso_producto`, `valor_adicional`, `adicional_per`, `rollo`, `descripcion_rollo`, `cont_item`, `cantlam`, `poli`, `poli_v`, `poli_h`, `verpoli`, `rieles`, `alfajia`, `rejillas`, `cierres`, `rodajas`, `bisagras`, `can_rieles`, `can_alfajia`, `can_rejillas`, `can_cierres`, `can_rodajas`, `can_bisagras`, `poralu`, `porvid`, `poracc`, `porace`, '0', `compuestos`,`termovid1`,`termovid2`,`termovid3`,`termovid4`,`idespaciador`,`cantespaciador`,`id_dolar_actual`,`cobro`,`brazos`,`can_brazos`,`descripciones`,`vidrios` from cotizaciones where id_cotizacion='".$idcc."' ");
                 
                 
                 $sql56 = "SELECT max(id_cotizacion) FROM cotizaciones";
                 $fila56 =mysqli_fetch_array(mysqli_query($conexion,$sql56));
                 $maxcot= $fila56["max(id_cotizacion)"];
                 
                 
                 
//                 $request6=mysqli_query($conexion,"SELECT * FROM cotizaciones  where id_compuesto=".$idcc);
//                    while($rc=mysqli_fetch_array($request6))
//                   {
//                 mysqli_query($conexion,"insert into cotizaciones (`imagen`, `id_cot`, `id_referencia`, `laminas`, `laminas2`, `laminas3`, `laminas4`, `id_vidrio`, `id_vidrio2`, `id_vidrio3`, `id_vidrio4`, `id_vidrio5`, `id_vidrio6`, `cierre`, `ancho_c`, `ancho_c_original`, `alto_c`, `ancho_abajo`, `hojas`, `cuerpo`, `lado`, `cantidad_c`, `cantidad_temp`, `cant_restante`, `valor_c`, `valor_c_sp`, `valor_fom`, `valor_costob`, `valor_fomp`, `id_cliente`, `tipo_c`, `fecha_c`, `estado_c`, `registrado_por_c`, `aprobado`, `num_pedido`, `orden`, `asignado_a`, `linea_cot`, `cod_traz`, `boq`, `per`, `porcentaje`, `porcentaje_mp`, `descuento_g`, `color_ta`, `precio_item`, `precio_adicional`, `precio_material`, `precio_fom_sp`, `observaciones`, `observaciones2`, `desc`, `verticales`, `horizontales`, `d1`, `duracion`, `install`, `traz_vid`, `traz_vid2`, `traz_vid3`, `traz_vid4`, `ubicacion_c`, `tip`, `imagen_mas`, `an`, `al`, `fila`, `id2_vidrio`, `id2_vidrio2`, `id2_vidrio3`, `id2_vidrio4`, `id2_vidrio5`, `id3_vidrio`, `id3_vidrio2`, `id3_vidrio3`, `id3_vidrio4`, `id3_vidrio5`, `id4_vidrio`, `id4_vidrio2`, `id4_vidrio3`, `id4_vidrio4`, `id4_vidrio5`, `modulo`, `pelicula`, `huacal`, `ancho_temp`, `alto_temp`, `valor_temp`, `id_dolar`, `p_act_sp`, `p_act_cp`, `aprobado_por`, `servicio`, `estado_item`, `aprobado_por_user`, `fecha_aprobada`, `iva`, `ajuste`, `msg`, `msg2`, `peso_producto`, `valor_adicional`, `adicional_per`, `rollo`, `descripcion_rollo`, `cont_item`, `cantlam`, `poli`, `poli_v`, `poli_h`, `verpoli`, `rieles`, `alfajia`, `rejillas`, `cierres`, `rodajas`, `bisagras`, `can_rieles`, `can_alfajia`, `can_rejillas`, `can_cierres`, `can_rodajas`, `can_bisagras`, `poralu`, `porvid`, `poracc`, `porace`, `id_compuesto`, `compuestos`,`termovid1`,`termovid2`,`termovid3`,`termovid4`,`idespaciador`,`cantespaciador`,`id_dolar_actual`)"
//                                              . " VALUES ('".$rc['imagen']."', '$max', '".$rc['id_referencia']."', '".$rc['laminas']."', '".$rc['laminas2']."', '".$rc['laminas3']."', '".$rc['laminas4']."', '".$rc['id_vidrio']."', '".$rc['id_vidrio2']."', '".$rc['id_vidrio3']."', '".$rc['id_vidrio4']."', '".$rc['id_vidrio5']."', '".$rc['id_vidrio6']."', '".$rc['cierre']."', '".$rc['ancho_c']."', '".$rc['ancho_c_original']."', '".$rc['alto_c']."', '".$rc['ancho_abajo']."', '".$rc['hojas']."', '".$rc['cuerpo']."', '".$rc['lado']."', '".$rc['cantidad_c']."', '".$rc['cantidad_temp']."', '".$rc['cant_restante']."', '".$rc['valor_c']."', '".$rc['valor_c_sp']."', '".$rc['valor_fom']."', '".$rc['valor_costob']."', '".$rc['valor_fomp']."', '".$rc['id_cliente']."', '".$rc['tipo_c']."', '".$rc['fecha_c']."', '".$rc['estado_c']."', '".$rc['registrado_por_c']."', '".$rc['aprobado']."', '".$rc['num_pedido']."', '".$rc['orden']."', '".$rc['asignado_a']."', '".$rc['linea_cot']."', '".$rc['cod_traz']."', '".$rc['boq']."', '".$rc['per']."', '".$rc['porcentaje']."', '".$rc['porcentaje_mp']."', '".$rc['descuento_g']."', '".$rc['color_ta']."', '".$rc['precio_item']."', '".$rc['precio_adicional']."', '".$rc['precio_material']."', '".$rc['precio_fom_sp']."', '".$rc['observaciones']."', '".$rc['observaciones2']."', '".$rc['desc']."', '".$rc['verticales']."', '".$rc['horizontales']."', '".$rc['d1']."', '".$rc['duracion']."', '".$rc['install']."', '".$rc['traz_vid']."', '".$rc['traz_vid2']."', '".$rc['traz_vid3']."', '".$rc['traz_vid4']."', '".$rc['ubicacion_c']."', '".$rc['tip']."', '".$rc['imagen_mas']."', '".$rc['an']."', '".$rc['al']."', '".$rc['fila']."', '".$rc['id2_vidrio']."', '".$rc['id2_vidrio2']."', '".$rc['id2_vidrio3']."', '".$rc['id2_vidrio4']."', '".$rc['id2_vidrio5']."', '".$rc['id3_vidrio']."', '".$rc['id3_vidrio2']."', '".$rc['id3_vidrio3']."', '".$rc['id3_vidrio4']."', '".$rc['id3_vidrio5']."', '".$rc['id4_vidrio']."', '".$rc['id4_vidrio2']."', '".$rc['id4_vidrio3']."', '".$rc['id4_vidrio4']."', '".$rc['id4_vidrio5']."', '".$rc['modulo']."', '".$rc['pelicula']."', '".$rc['huacal']."', '".$rc['ancho_temp']."', '".$rc['alto_temp']."', '".$rc['valor_temp']."', '".$rc['id_dolar']."', '".$rc['p_act_sp']."', '".$rc['p_act_cp']."', '".$rc['aprobado_por']."', '".$rc['servicio']."', '".$rc['estado_item']."', '".$rc['aprobado_por_user']."', '".$rc['fecha_aprobada']."', '".$rc['iva']."', '".$rc['ajuste']."', '".$rc['msg']."', '".$rc['msg2']."', '".$rc['peso_producto']."', '".$rc['valor_adicional']."', '".$rc['adicional_per']."', '".$rc['rollo']."', '".$rc['descripcion_rollo']."', '".$rc['cont_item']."', '".$rc['cantlam']."', '".$rc['poli']."', '".$rc['poli_v']."', '".$rc['poli_h']."', '".$rc['verpoli']."', '".$rc['rieles']."', '".$rc['alfajia']."', '".$rc['rejillas']."', '".$rc['cierres']."', '".$rc['rodajas']."', '".$rc['bisagras']."', '".$rc['can_rieles']."', '".$rc['can_alfajia']."', '".$rc['can_rejillas']."', '".$rc['can_cierres']."', '".$rc['can_rodajas']."', '".$rc['can_bisagras']."', '".$rc['poralu']."', '".$rc['porvid']."', '".$rc['poracc']."', '".$rc['porace']."', '$maxcot', '".$rc['compuestos']."', '".$rc['termovid1']."', '".$rc['termovid2']."', '".$rc['termovid3']."', '".$rc['termovid4']."', '".$rc['idespaciador']."', '".$rc['cantespaciador']."', '".$rc['id_dolar_actual']."' ) ");
//                   }
                       mysqli_query($conexion,"insert into cotizaciones (`imagen`, `id_cot`, `id_referencia`, `laminas`, `laminas2`, `laminas3`, `laminas4`, `id_vidrio`, `id_vidrio2`, `id_vidrio3`, `id_vidrio4`, `id_vidrio5`, `id_vidrio6`, `cierre`, `ancho_c`, `ancho_c_original`, `alto_c`, `ancho_abajo`, `hojas`, `cuerpo`, `lado`, `cantidad_c`, `cantidad_temp`, `cant_restante`, `valor_c`, `valor_c_sp`, `valor_fom`, `valor_costob`, `valor_fomp`, `id_cliente`, `tipo_c`, `fecha_c`, `estado_c`, `registrado_por_c`, `aprobado`, `num_pedido`, `orden`, `asignado_a`, `linea_cot`, `cod_traz`, `boq`, `per`, `porcentaje`, `porcentaje_mp`, `descuento_g`, `color_ta`, `precio_item`, `precio_adicional`, `precio_material`, `precio_fom_sp`, `observaciones`, `observaciones2`, `desc`, `verticales`, `horizontales`, `d1`, `duracion`, `install`, `traz_vid`, `traz_vid2`, `traz_vid3`, `traz_vid4`, `ubicacion_c`, `tip`, `imagen_mas`, `an`, `al`, `fila`, `id2_vidrio`, `id2_vidrio2`, `id2_vidrio3`, `id2_vidrio4`, `id2_vidrio5`, `id3_vidrio`, `id3_vidrio2`, `id3_vidrio3`, `id3_vidrio4`, `id3_vidrio5`, `id4_vidrio`, `id4_vidrio2`, `id4_vidrio3`, `id4_vidrio4`, `id4_vidrio5`, `modulo`, `pelicula`, `huacal`, `ancho_temp`, `alto_temp`, `valor_temp`, `id_dolar`, `p_act_sp`, `p_act_cp`, `aprobado_por`, `servicio`, `estado_item`, `aprobado_por_user`, `fecha_aprobada`, `iva`, `ajuste`, `msg`, `msg2`, `peso_producto`, `valor_adicional`, `adicional_per`, `rollo`, `descripcion_rollo`, `cont_item`, `cantlam`, `poli`, `poli_v`, `poli_h`, `verpoli`, `rieles`, `alfajia`, `rejillas`, `cierres`, `rodajas`, `bisagras`, `can_rieles`, `can_alfajia`, `can_rejillas`, `can_cierres`, `can_rodajas`, `can_bisagras`, `poralu`, `porvid`, `poracc`, `porace`, `id_compuesto`, `compuestos`,`termovid1`,`termovid2`,`termovid3`,`termovid4`,`idespaciador`,`cantespaciador`,`id_dolar_actual`,`cobro`,`brazos`,`can_brazos`,`descripciones`,`vidrios`)"
                                                   . " select  `imagen`, '$max', `id_referencia`, `laminas`, `laminas2`, `laminas3`, `laminas4`, `id_vidrio`, `id_vidrio2`, `id_vidrio3`, `id_vidrio4`, `id_vidrio5`, `id_vidrio6`, `cierre`, `ancho_c`, `ancho_c_original`, `alto_c`, `ancho_abajo`, `hojas`, `cuerpo`, `lado`, `cantidad_c`, `cantidad_temp`, `cantidad_c`, `valor_c`, `valor_c_sp`, `valor_fom`, `valor_costob`, `valor_fomp`, `id_cliente`, `tipo_c`, `fecha_c`, `estado_c`, `registrado_por_c`, `aprobado`, `num_pedido`, `orden`, `asignado_a`, `linea_cot`, `cod_traz`, `boq`, `per`, `porcentaje`, `porcentaje_mp`, `descuento_g`, `color_ta`, `precio_item`, `precio_adicional`, `precio_material`, `precio_fom_sp`, `observaciones`, `observaciones2`, `desc`, `verticales`, `horizontales`, `d1`, `duracion`, `install`, `traz_vid`, `traz_vid2`, `traz_vid3`, `traz_vid4`, `ubicacion_c`, `tip`, `imagen_mas`, `an`, `al`, `fila`, `id2_vidrio`, `id2_vidrio2`, `id2_vidrio3`, `id2_vidrio4`, `id2_vidrio5`, `id3_vidrio`, `id3_vidrio2`, `id3_vidrio3`, `id3_vidrio4`, `id3_vidrio5`, `id4_vidrio`, `id4_vidrio2`, `id4_vidrio3`, `id4_vidrio4`, `id4_vidrio5`, `modulo`, `pelicula`, `huacal`, `ancho_temp`, `alto_temp`, `valor_temp`, `id_dolar`, `p_act_sp`, `p_act_cp`, `aprobado_por`, `servicio`, `estado_item`, `aprobado_por_user`, `fecha_aprobada`, `iva`, `ajuste`, `msg`, `msg2`, `peso_producto`, `valor_adicional`, `adicional_per`, `rollo`, `descripcion_rollo`, `cont_item`, `cantlam`, `poli`, `poli_v`, `poli_h`, `verpoli`, `rieles`, `alfajia`, `rejillas`, `cierres`, `rodajas`, `bisagras`, `can_rieles`, `can_alfajia`, `can_rejillas`, `can_cierres`, `can_rodajas`, `can_bisagras`, `poralu`, `porvid`, `poracc`, `porace`, '$maxcot', `compuestos`,`termovid1`,`termovid2`,`termovid3`,`termovid4`,`idespaciador`,`cantespaciador`,`id_dolar_actual`,`cobro`,`brazos`,`can_brazos`,`descripciones`,`vidrios` from cotizaciones where id_compuesto='".$idcc."' ");
                 
                 
                  $result5 = mysqli_query($conexion,"select * from comentarios where id_cotizacion='".$row['id_cotizacion']."' ");
                 while($m = mysqli_fetch_array($result5)){
                     mysqli_query($conexion,"insert into comentarios (textos_com,id_cotizacion,fecha_registro_com,registrado_com)"
                 ...
                 $request_acc=mysqli_query($conexion,"SELECT * FROM referencia_acce a, referencias b where a.num_ref=b.id_referencia and a.cotizacion=".$_GET["cod"]." and a.id_cot=".$row['id_cotizacion']."  ");
                 ...
                 {   
                     ...
                     $requestser=mysqli_query($conexion,"SELECT * FROM cotizaciones_servicios b where id_cotizacion=".$_GET['cod']." and id_cot_mas=".$row['id_cotizacion']." ");
                     while($row55=mysqli_fetch_array($requestser))
	        {
            ...
            mysqli_query($conexion,$sql55);
             
         }
         
                 // se agrega los kit 
                 
                 $request_kit=mysqli_query($conexion,"SELECT * FROM producto a, cotizaciones_kit b where a.id_p=b.id_producto and b.id_cot=".$_GET['cod']." and b.id_prod_mas=".$row['id_cotizacion']." and b.comp='1' ");
...
//                  $request2=mysqli_query($conexion,"SELECT * FROM producto a, cotizaciones_sub c where c.id_referencia_sub=a.id_p and c.id_cot_sub=".$_GET["cod"]." and c.id_producto_cot=".$row['id_cotizacion']."");
...
//                  }
            ...
            $ver = mysqli_query($conexion,"INSERT INTO cotizaciones_servicios (id_cotizacion, id_servicio, cantidad_serv, descuento_serv, obs_servicio, precio_servicio) select '$max', id_servicio, cantidad_serv, descuento_serv, obs_servicio, precio_servicio from cotizaciones_servicios where id_cotizacion='".$_GET['cod']."' and id_cot_mas=0 ;") ;
        
             
         
         $request3=mysqli_query($conexion,"SELECT * FROM referencias a, cotizaciones_materiales b where a.id_referencia=b.id_material and b.id_cotizacion=".$_GET['cod']." ");
         while($row21=mysqli_fetch_array($request3))
	{
         ...
         $request4=mysqli_query($conexion,"SELECT * FROM producto a, cotizaciones_kit b where a.id_p=b.id_producto and b.id_cot=".$_GET['cod']."  and b.comp='0'");
	...
	{  
        ...
        $sql7 = "INSERT INTO `cotizaciones_kit` (`color_k`, `por_k`, `id_cot`, `id_producto`, `cantidad_k`, `desc_k`)";
          ...
          echo '<script lanquage="javascript">alert("Se ha Versionado la cotizacion #'.$numero_cotizacion.', Su nueva version es '.$version.'. ");location.href="../vistas/?id=lista_cot"</script>'; 
