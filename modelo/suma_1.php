...
if($linea_cot!='Vidrio'){
    $alum_por = "SELECT (".$porcentaje_mp.")  as p FROM porcentajes where area_por='MP' and grupo='Perfileria'";
                ...
                $porca= $fia["p"]/100;
$request=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_alu b, referencias c where b.id_ref_alum=c.id_referencia and a.id_p=b.id_p and a.id_p=".$reff);
...
$request_v=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_vid b, referencias c where b.id_ref_vid=c.id_referencia and a.id_p=b.id_p and a.id_p=".$reff);
...
$request_rej=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_rej b, referencias c where b.id_referencia=c.id_referencia and a.id_p=b.id_p and a.id_p=".$reff);
            ...
            if($fil_an['signo']=='+'){
               ...
               if($fil_an['signo']=='-'){
                ...
                $al = ($altt+$fil_an["descuento"])/ $fil_an['variable'];
                 ...
                 $request_vrej=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_vid b, referencias c where b.id_ref_vid=c.id_referencia and a.id_p=b.id_p and a.id_p=".$reff." and b.id_r_v=".$row["medida_rej"]." ");
...
// FIN REJILLASSSS----------------------------------------<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>
 $acc_por = "SELECT (".$porcentaje_mp.") as p FROM porcentajes where area_por='MP' and grupo='Accesorios'";
                ...
                $porcacc= $fipa["p"]/100; 
$request_acE=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_acc b, referencias c where b.id_ref_acc=c.id_referencia and a.id_p=b.id_p and a.id_p=".$reff);
...
if($request_acE){
	...
	{  
            ...
            //--------------------------------------------------------------------
                        if($row['can_rej']!=0){
    $request_v2=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_rej b, referencias c where b.id_referencia=c.id_referencia and a.id_p=b.id_p and a.id_p=".$reff." and b.id_r_rej=".$row['can_rej']." ");
...
//echo $total_vid.'<br>';
//echo $ff.'<br>';
$request_mano=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_ma b, referencia_ma c where b.id_ref_ma=c.id_ref_ma and a.id_p=b.id_p and a.id_p=".$reff);
...
$request_maq=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_mo b, referencia_mo c where c.instalacion='No' and b.id_ref_mo=c.id_ref_mo and a.id_p=b.id_p and a.id_p=".$reff);
...
if($instal=='Si'){
$req=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_mo b, referencia_mo c where c.instalacion='Si' and  b.id_ref_mo=c.id_ref_mo and a.id_p=b.id_p and a.id_p=".$reff);   
if($req){
...
$request_ad=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_ad b, referencia_admin c where b.id_ref_ad=c.id_ref_ad and a.id_p=b.id_p and a.id_p=".$reff);
...
$request_ot=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_otro b, referencia_otro c where b.id_ref_ot=c.id_ref_ot and a.id_p=b.id_p and a.id_p=".$reff);
