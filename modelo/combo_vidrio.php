...
if($_POST["num"]==1){
$rpta2= $rpta2."<input type='hidden' name='vid' id='valor2'  required><input type='text' placeholder='Lam 1/1 del  modulo 1' name='xxxv' id='valor1'  required onclick='atencion()'> ";

}
if($_POST["num"]==2){
$rpta2= $rpta2."<input type='hidden' name='vid' id='valor2'  required><input placeholder='Lam 1/2 del  modulo 1' type='text' name='xxxv' id='valor1'  required onclick='atencion()'> ";
$rpta2= $rpta2."<input type='hidden' name='vid2' id='valor4'  required><input  placeholder='Lam 2/2 del  modulo 1' type='text' name='xxxv2' id='valor3'  required onclick='atencion2()'> ";
}
if($_POST["num"]==3){
$rpta2= $rpta2."<input type='hidden' name='vid' id='valor2'  required><input  placeholder='Lam 1/3 del  modulo 1' type='text' name='xxxv' id='valor1'  required onclick='atencion()'> ";
$rpta2= $rpta2."<input type='hidden' name='vid2' id='valor4'  required><input type='text' placeholder='Lam 2/3 del  modulo 1' name='xxxv2' id='valor3'  required onclick='atencion2()'> ";
$rpta2= $rpta2."<input type='hidden' name='vid3' id='valor6'  required><input type='text' placeholder='Lam 3/3 del  modulo 1' name='xxxv3' id='valor5'  required onclick='atencion3()'> ";
}
if($_POST["num"]==4){
