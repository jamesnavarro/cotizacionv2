<?php
    ...
    $sql = "INSERT INTO `cotizaciones_servicios` (`id_cot_mas`, `id_cotizacion`, `id_servicio`, `cantidad_serv`, `descuento_serv`)";
    $sql.= "VALUES ('".$mas."', '".$cotizacion."', '".$servicio."', '".$cant."', '".$desc."')";
    mysqli_query($conexion,$sql);
    
    $request2=mysqli_query($conexion,"SELECT * FROM referencia_mo a, cotizaciones_servicios b where a.id_ref_mo=b.id_servicio and b.id_cotizacion=".$cotizacion." and b.id_cot_mas=".$mas." ");
