...
$request=mysql_query("SELECT * FROM producto a,  cotizaciones_sub c, tipo_vidrio d where d.id_vidrio=c.id_vidrio_sub  and c.id_referencia_sub=a.id_p and c.id_cot_sub=".$cotizacion." and c.id_producto_cot=".$mas."");   
if($request){
        $ta2 =0;
        $cont =0;
