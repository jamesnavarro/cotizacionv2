<?php
    ...
    $filc =mysql_fetch_array(mysql_query($sqlcot));
    ...
    $request=mysql_query("SELECT * FROM producto a, cotizaciones_sub c where c.id_referencia_sub=a.id_p and c.id_cot_sub=".$cotizacion." and c.id_producto_cot=".$idcot."");
