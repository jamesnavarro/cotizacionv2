...
if(isset($_POST['buscar'])){
     $request=mysqli_query($conexion,"SELECT * FROM referencias where codigo like '".$_POST['buscar']."%' or descripcion like '%".$_POST['buscar']."%'  or referencia like '%".$_POST['buscar']."%'  group by descripcion");
}else{
 $request=mysqli_query($conexion,"SELECT * FROM producto where kit=1 ");
}
...
<?php 
     ...
     $request2=mysqli_query($conexion,'SELECT * FROM producto WHERE id_p='.$_GET['codigo'].'');
