...
if($_SESSION['k_username']=='admin'){
    $request=mysqli_query($conexion,"SELECT count(*) FROM requerimientos ");
}else{
    $request=mysqli_query($conexion,"SELECT count(*) FROM requerimientos where usuario='".$_SESSION['k_username']."' ");
}
if($request){
...
if($_SESSION['k_username']=='admin'){
    $request_ac=mysqli_query($conexion,"SELECT * FROM requerimientos order by id_r desc ".$limit);
}else{
    $request_ac=mysqli_query($conexion,"SELECT * FROM requerimientos where usuario='".$_SESSION['k_username']."' order by id_r desc  ".$limit);
}
