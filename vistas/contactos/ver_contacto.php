...
//require '../vistas/contactos/otros.php';
                                ...
                                if(isset($_GET['cod'])){
$request=mysql_query('select count(*) from cotizacion where id_cliente='.$_GET['cod']);
if($request){
...
//    echo'<hr>';
 ...
 $request=mysql_query("SELECT * FROM prestamo a, sis_contacto b where a.id_cliente=b.id_contacto");
