<?php 
$request=mysqli_query($conexion,'select count(*) from sis_contacto  where tipo="Contactado"');
if($request){
...
if(isset($_GET['pasar'])){
    $re=mysqli_query($conexion,"SELECT * FROM sis_contacto where tipo='Contactado' ");
    $v = 0;
...
if(isset($_POST['empresa']) || isset($_POST['nombre']) || isset($_POST['user'])){
    ...
    $request=mysqli_query($conexion,"SELECT * FROM sis_contacto where tipo='Contactado' and  municipio like '%".$_POST['empresa']."%' and nombre_cont like '%".$_POST['nombre']."%' and usuario like '%".$_POST['user']."%'");
}else{
$request=mysqli_query($conexion,"SELECT * FROM sis_contacto where tipo='Contactado' ");
  }
