...
<?php
    ...
    $request=mysqli_query($conexion,"select count(*) from cont_terceros ");
if($request){
...
$limit = 'LIMIT ' .($page - 1) * $rows_by_page .',' .$rows_by_page;
    ...
    if(isset($_POST['btnbuscar'])){
        $request_ac=mysqli_query($conexion,"select * from cont_terceros where concat(cod_ter,'',nom_ter) like '%".$_POST['buscar']."%' and estado_ter='0' ");
    }else{
        $request_ac=mysqli_query($conexion,"select * from cont_terceros where estado_ter='0' ".$limit);
    }
