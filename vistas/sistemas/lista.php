...
if(isset($_SESSION['k_username'])){ 
    ...
    $nombres= $_GET['nombb'];
    $page= $_GET['page'];
            $request = mysql_query("SELECT count(*) FROM sistemas where nombre_sistema like '%".$nombres."%' ");
            if($request){
...
<div class="table-responsive">  
  ...
  <table class="table table-hover">
    ...
    $query = mysql_query("SELECT * FROM sistemas where nombre_sistema like '%".$nombres."%' ".$limit );
