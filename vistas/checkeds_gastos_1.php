                        ...
                        <div class="span12 widget lime">
                            ...
                            <section class="body">
                                ...
                                <div class="body-inner no-padding">
                                    ...
                                    <form name="buscarA" action="../vistas/checkeds_gastos_1.php?cod=<?php echo $_GET['cod'] ?>&add" method="post" enctype="multipart/form-data">
...
$request=mysql_query("SELECT * FROM `referencia_admin` ");
}
