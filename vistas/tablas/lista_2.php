...
if(isset($_POST['buscar'])){
    ...
    $request=mysqli_query($conexion,"SELECT count(*) FROM producto where estado_producto=1 and revisado=0 and  concat(producto, ' ', codigo,' ',referencia_p) like '%".$_POST['b']."%' and linea like '%".$_POST['linea']."%' $id ");
    ...
    $request=mysqli_query($conexion,"SELECT count(*) FROM producto where estado_producto=1 and  concat(producto, ' ', codigo,' ',referencia_p) like '%".$_GET['b']."%' and linea like '%".$_GET['linea']."%' $id ");

}else{
    $request=mysqli_query($conexion,'select count(*) from producto where estado_producto=1 and   revisado=0 and aprobado=1');
}
}  
...
if(isset($_POST['buscar'])){
    ...
    $request=mysqli_query($conexion,"SELECT * FROM producto where estado_producto=1 and  revisado=0 and  concat(producto, ' ', codigo,' ',referencia_p) like '%".$_POST['b']."%' and linea like '%".$_POST['linea']."%' $id $rev $up order by id_p asc ".$limit);
   ...
   if(isset($_GET['linea'])){
    ...
    $request=mysqli_query($conexion,"SELECT * FROM producto where estado_producto=1 and  revisado=0 and  concat(producto, ' ', codigo,' ',referencia_p) like '%".$_GET['b']."%' and linea like '%".$_GET['linea']."%' $id order by id_p asc ".$limit);

}else{
    $request=mysqli_query($conexion,"SELECT * FROM producto where estado_producto=1 and  revisado=0 and aprobado=1 order by id_p asc ".$limit);
}
}  
