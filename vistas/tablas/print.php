...
//        echo '<hr><h5><p align="right">TOTAL COT: $<strong>'.number_format($tad).'</strong></h5></p>'; 
                ...
                //-----------------------------------------servicios-----------------------------------------------
$request2=mysql_query("SELECT * FROM referencia_mo a, cotizaciones_servicios b where a.id_ref_mo=b.id_servicio and b.id_cotizacion=".$_GET['cot']."");
 $r2=mysql_query("SELECT * FROM referencia_mo a, cotizaciones_servicios b where a.id_ref_mo=b.id_servicio and b.id_cotizacion=".$_GET['cot']."");
$c2 = mysql_fetch_row($r2);
    $c2 = $c2[0];
if($c2!=0){
//    echo'<hr>';
