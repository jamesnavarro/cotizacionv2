...
if($bus5!=''){
    ...
    $b4 = "";
            ...
            $request = mysqli_query($conexion,"SELECT count(*) FROM producto where estado_producto=0  and ptfom=2 and id_p like '%".$item."%' and codigo like '%".$cod."%' and referencia_p like '%".$ref."%'  and producto like '%".$bus1."%' $b1 $b2 $b3 $b4   and linea like '%".$lin."%'  and sistemas like '%".$sis."%' and ptfom like '%".$per."%' ");
            if($request){
    ...
    $query = mysqli_query($conexion,"SELECT * FROM producto where estado_producto=0  and ptfom=2 and id_p like '%".$item."%' and codigo like '%".$cod."%' and referencia_p like '%".$ref."%'  and producto like '%".$bus1."%'  $b1 $b2 $b3 $b4 and linea like '%".$lin."%'  and sistemas like '%".$sis."%' and ptfom like '%".$per."%' ".$limit );
