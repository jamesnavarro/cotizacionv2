<?php 
$request=mysql_query('select count(*) from usuarios');
if($request){
...
if(isset($_POST['nombre'])){
    ...
    $request=mysql_query("SELECT a.*,(b.nombre) as empresa FROM usuarios a,inf_empresa b where a.id_empresa = b.id_emp and CONCAT(a.nombre, ' ',a.apellido, ' ',a.usuario) like '%".$_POST['nombre']."%'");
}else{
$request=mysql_query("SELECT a.*,(b.nombre) as empresa FROM usuarios a,inf_empresa b where a.id_empresa = b.id_emp ".$limit);
  }
