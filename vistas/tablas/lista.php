...
if(isset($_POST['buscar'])){
    ...
    $request=mysqli_query($conexion,"SELECT count(*) FROM producto where estado_producto=0 and  ok=0 and  concat(producto, ' ', codigo,' ',referencia_p) like '%".$_POST['b']."%' and linea like '%".$_POST['linea']."%' $id ");
    ...
    $request=mysqli_query($conexion,"SELECT count(*) FROM producto where estado_producto=0 and  concat(producto, ' ', codigo,' ',referencia_p) like '%".$_GET['b']."%' and linea like '%".$_GET['linea']."%' $id ");

}else{
    $request=mysqli_query($conexion,'select count(*) from producto where estado_producto=0 and ok=0 and aprobado=1');
}
}  
...
if($page>1){?>
	<a href="../vistas/?id=lista&page=1<?php echo $lin; ?>"><img src="../images/a1.png"></a>
	<a href="../vistas/?id=lista&page=<?php echo $page - 1;?><?php echo $lin; ?>"><img src="../images/a11.png"></a>
<?php
}else{
...
<?php
if($page<$last_page){?>
	<a href="../vistas/?id=lista&page=<?php echo $page + 1;?><?php echo $lin; ?>"><img src="../images/p1.png"></a>
	<a href="../vistas/?id=lista&page=<?php echo $last_page;?><?php echo $lin; ?>"><img src="../images/p11.png"></a>
<?php
}else{
...
if(isset($_POST['buscar'])){
    ...
    $request=mysqli_query($conexion,"SELECT * FROM producto where estado_producto=0 and ok=0 and  concat(producto, ' ', codigo,' ',referencia_p) like '%".$_POST['b']."%' and linea like '%".$_POST['linea']."%' $id $rev $up order by id_p asc ".$limit);
   ...
   if(isset($_GET['linea'])){
    ...
    $request=mysqli_query($conexion,"SELECT * FROM producto where estado_producto=0 and  ok=0 and  concat(producto, ' ', codigo,' ',referencia_p) like '%".$_GET['b']."%' and linea like '%".$_GET['linea']."%' $id order by id_p asc ".$limit);

}else{
    $request=mysqli_query($conexion,"SELECT * FROM producto where estado_producto=0 and  ok=0 and aprobado=1 order by id_p asc ".$limit);
}
}  
...
//    echo'<hr>';
       $table = '<table class="table table-bordered table-striped table-hover" id="">';
               ...
               $table = $table.'<th width="3%">'.'Item'.'</th>';
                 $table = $table.'<th><img src="../images/pesos.png"></th>';
               ...
               $table = $table.'<th  class="hidden-phone">'.'Linea'.'</th>';
                $table = $table.'<th  class="hidden-phone">'.'sistemas'.'</th>';
	...
	{       
            ...
            $res2 = 'select count(*) FROM producto_rep_ad where id_p='.$row['id_p'].'';
            ...
            $request2=mysqli_query($conexion,'select count(*) FROM compuestos  where id_prod='.$row['id_p'].' ');
	    if($request2){
	      ...
	      $num_items = 0;
              ...
              if($ver_conf == 'Habilitado'){
                    ...
                    $res = 'select count(*) from pt_procesos where id_proceso='.$row['id_p'].' ';
                    ...
                    $requestr=("SELECT count(*) FROM producto_rep_alu  where id_p=".$row['id_p']);
                    $cf =mysqli_fetch_array(mysqli_query($conexion,$requestr));
                    $co = $cf['count(*)'];
                    if($co==0){
                        $costo = '<img src="../imagenes/ok.png">';
                    }else{
                        $costo = '<img src="../imagenes/warning.png" width="15px">';
                    }
            $table = $table.'<tr>'
                    ...
                    . '<td  class="hidden-phone">'.$row["linea"].'<font></a></td>
                       <td  class="hidden-phone">'.$row["sistemas"].'<font></a></td> 
