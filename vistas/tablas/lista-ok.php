...
if(isset($_POST['buscar'])){
    ...
    $request=mysqli_query($conexion,"SELECT count(*) FROM producto where estado_producto=0 and ok=1 and concat(producto, ' ', codigo,' ',referencia_p) like '%".$_POST['b']."%' and linea like '%".$_POST['linea']."%' $id ");
    ...
    $request=mysqli_query($conexion,"SELECT count(*) FROM producto  where estado_producto=0 and ok=1 and concat(producto, ' ', codigo,' ',referencia_p) like '%".$_GET['b']."%' and linea like '%".$_GET['linea']."%' $id ");

}else{
    $request=mysqli_query($conexion,'select count(*) from producto where estado_producto=0 and ok=1 ');
}
}  
                      ...
                      <!-- START Widget Collapse -->
                        ...
                        <div class="span12 widget dark stacked">
                            ...
                            <header>
                                ...
                                <h4 class="title">Listado Productos Revisados</h4>
...
if($page>1){?>
	<a href="../vistas/?id=lista_ok&page=1<?php echo $lin; ?>"><img src="../images/a1.png"></a>
	<a href="../vistas/?id=lista_ok&page=<?php echo $page - 1;?><?php echo $lin; ?>"><img src="../images/a11.png"></a>
<?php
}else{
	?><img src="../images/ant.png"><?php
}
?>
(Pagina x <?php echo $page;?> de <?php echo $last_page;?>)
<?php
if($page<$last_page){?>
	<a href="../vistas/?id=lista_ok&page=<?php echo $page + 1;?><?php echo $lin; ?>"><img src="../images/p1.png"></a>
	<a href="../vistas/?id=lista_ok&page=<?php echo $last_page;?><?php echo $lin; ?>"><img src="../images/p11.png"></a>
<?php
}else{
...
if(isset($_POST['buscar'])){
    ...
    $request=mysqli_query($conexion,"SELECT * FROM producto where estado_producto=0 and ok=1 and  concat(producto, ' ', codigo,' ',referencia_p) like '%".$_POST['b']."%' and linea like '%".$_POST['linea']."%' $id $rev $up  order by id_p asc ".$limit);
   ...
   if(isset($_GET['linea'])){
    ...
    $request=mysqli_query($conexion,"SELECT * FROM producto where estado_producto=0 and ok=1 and concat(producto, ' ', codigo,' ',referencia_p) like '%".$_GET['b']."%' and linea like '%".$_GET['linea']."%' $id order by id_p asc ".$limit);

}else{
    $request=mysqli_query($conexion,"SELECT * FROM producto where estado_producto=0 and ok=1 order by id_p asc ".$limit);
}
}  
	    ...
	    if($request2){
	      ...
	      $num_items = 0;
              ...
              if($ver_conf == 'Habilitado'){
                    ...
                    $requestr=("SELECT count(*) FROM producto a, producto_rep_alu b, referencias c where b.id_ref_alum=c.id_referencia and a.id_p=b.id_p and c.costo_mt=0 and a.id_p=".$row['id_p']);
