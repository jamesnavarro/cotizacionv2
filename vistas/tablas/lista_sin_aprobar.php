<?php 
$request=mysql_query('select count(*) from producto where aprobado=0');
if($request){
...
if(isset($_POST['buscar'])){
    $request=mysql_query("SELECT * FROM producto where producto like '%".$_POST['buscar']."%' or codigo like '".$_POST['buscar']."%' or referencia_p like '%".$_POST['buscar']."%'  order by linea ");

}else{
    $request=mysql_query("SELECT * FROM producto where aprobado=0 order by linea  ");
}  
