                      ...
                      <!-- START Widget Collapse -->
                        ...
                        <div class="span12 widget dark stacked">
                            ...
                            <header>
                                ...
                                <h4 class="title">Cotizaciones Aprobadas x Items <span id="load"></span></h4>
				...
				<?php
					if (isset($_GET['cot'])) {
						...
						echo "<option value=''>Asesores</option>";
                                        ...
                                        $result2=  mysqli_query($conexion,$consulta2);        echo"<option value='ADMIN'>ADMIN</option>";  
...
<?php
if(isset($_GET['abrir'])){
    mysqli_query($conexion,"update cotizacion set estado='En proceso' where id_cot='".$_GET['abrir']."'");
