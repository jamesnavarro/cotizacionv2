...
if(isset($_POST['nombre']) || isset($_POST['fecha']) || isset($_POST['user'])){
    ...
    $request=mysqli_query($conexion,"SELECT * FROM clientes  where nombre_cli like '%".$_POST['nombre']."%' and cedu_nit like '%".$_POST['fecha']."%' and registrado_por like '%".$_POST['user']."%'");
}else{
