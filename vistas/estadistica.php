...
//        include '../vistas/imprimir_reportes_2.php';
    ...
    $fecha2 = $_POST['fecha2'].' 23:00:00';
      ...
      ?>
        ...
        <?php
        if(isset($_POST['fecha'])!=''){
            $ciudad = mysql_query("SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='En proceso' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.grabado=b.usuario group by b.usuario order by count(*) desc");
        ...
        $fila=  mysql_fetch_array($result);
            ...
            $ciudad = mysql_query("SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where  a.estado='En proceso' and a.grabado=b.usuario group by b.usuario order by count(*) desc");
        ...
        if(isset($_POST['fecha'])!=''){
                ...
                $productos = mysql_query("(SELECT count(*), sum(cantidad_c), producto FROM producto a, cotizaciones c, cotizacion b where c.id_cot=b.id_cot and c.id_referencia=a.id_p  and b.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.grabado like '".$_POST['empresa']."%' group by id_p order by sum(cantidad_c) desc)");
        }else{
       ...
       <?php
        if(isset($_POST['fecha'])){
                ...
                $linea = mysql_query("(SELECT count(*), sum(cantidad_c), a.linea FROM producto a, cotizaciones c, cotizacion b where c.id_cot=b.id_cot and c.id_referencia=a.id_p  and b.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.grabado like '".$_POST['empresa']."%' group by a.linea order by sum(cantidad_c) desc)");
        }else{
        ...
        ?>
         ...
         <?php
        if(isset($_POST['fecha'])){
            $por_aprobar = mysql_query("SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Pedido por aprobar' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.grabado=b.usuario group by b.usuario order by count(*) desc");
        ...
        $fila=  mysql_fetch_array($result);
            ...
            $por_aprobar = mysql_query("SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Pedido por aprobar' and a.grabado=b.usuario group by b.usuario order by count(*) desc");
        ...
        ?>
          ...
          <?php
        if(isset($_POST['fecha'])){
            $aprobar = mysql_query("SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Aprobado' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.grabado=b.usuario group by b.usuario order by count(*) desc");
        ...
        $fila=  mysql_fetch_array($result);
            ...
            $aprobar = mysql_query("SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Aprobado' and a.grabado=b.usuario group by b.usuario order by count(*) desc");
