...
$request=mysqli_query($conexion,'select count(*) from ordenes where estado_ord!="En proceso" and estado_ord!="Anulado"');
if($request){
                      ...
                      <!-- START Widget Collapse -->
                        ...
                        <div class="span12 widget dark stacked">
                            ...
                            <header>
                                ...
                                <h4 class="title">Generar estadisticas</h4>
...
//        include '../vistas/imprimir_reportes_2.php';
        ...
        IF(isset($_POST['fecha'])!=''){
            $consulta= "SELECT * FROM `usuarios` where usuario='".$_POST['empresa']."'";                     
        $result=  mysqli_query($conexion,$consulta);
      ...
      ?>
        ...
        <?php
        if(isset($_POST['fecha'])!=''){
            $ciudad = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='En proceso' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.grabado=b.usuario group by b.usuario order by count(*) desc");
        $consulta2= "SELECT count(*) FROM cotizacion a, usuarios b where  a.estado='En proceso' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.grabado=b.usuario";                     
        $result=  mysqli_query($conexion,$consulta2);
        $fila=  mysqli_fetch_array($result);
            
        }else{
            $ciudad = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where  a.estado='En proceso' and a.grabado=b.usuario group by b.usuario order by count(*) desc");
        ...
        $c1 = 0;$p1 = 0;
        while($ciu = mysqli_fetch_array($ciudad)){
            $c1 += $ciu['count(*)'];$p1 += 1;
        ...
        if(isset($_POST['fecha'])!=''){
                ...
                $productos = mysqli_query($conexion,"(SELECT count(*), sum(cantidad_c), producto FROM producto a, cotizaciones c, cotizacion b where c.id_cot=b.id_cot and c.id_referencia=a.id_p  and b.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.grabado like '".$_POST['empresa']."%' group by id_p order by sum(cantidad_c) desc)");
        }else{
        $productos = mysqli_query($conexion,"(SELECT count(*), sum(cantidad_c), producto FROM producto a, cotizaciones c, cotizacion b where c.id_cot=b.id_cot and c.id_referencia=a.id_p  group by id_p order by sum(cantidad_c) desc)");
        }
        $c2 = 0;        
        $c3 = 0;
        $p2 = 0;
       ...
       <?php
        if(isset($_POST['fecha'])){
                ...
                $linea = mysqli_query($conexion,"(SELECT count(*), sum(cantidad_c), a.linea FROM producto a, cotizaciones c, cotizacion b where c.id_cot=b.id_cot and c.id_referencia=a.id_p  and b.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.grabado like '".$_POST['empresa']."%' group by a.linea order by sum(cantidad_c) desc)");
        }else{
        $linea = mysqli_query($conexion,"(SELECT count(*), sum(cantidad_c), a.linea FROM producto a, cotizaciones c, cotizacion b where c.id_cot=b.id_cot and c.id_referencia=a.id_p  group by a.linea order by sum(cantidad_c) desc)");
        }
        $l2 = 0;        
        $l3 = 0;
        $lp2 = 0;
        ...
        while($lin= mysqli_fetch_array($linea)){
        ...
        ?>
         ...
         <?php
        if(isset($_POST['fecha'])){
            $por_aprobar = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Pedido por aprobar' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.grabado=b.usuario group by b.usuario order by count(*) desc");
        $consulta21= "SELECT count(*) FROM cotizacion a, usuarios b where a.estado='Pedido por aprobar' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.grabado=b.usuario";                     
        $result=  mysqli_query($conexion,$consulta21);
        $fila=  mysqli_fetch_array($result);
            
        }else{
            $por_aprobar = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Pedido por aprobar' and a.grabado=b.usuario group by b.usuario order by count(*) desc");
        ...
        echo '<tr><td width="5px">Items</td><td>Nombre del Usuario</td><td>Numero de Cotizaciones</td><td>Porcentaje de Rendimiento</td>';
        $c11 = 0;$p11 = 0;
        while($ciu = mysqli_fetch_array($por_aprobar)){
            $c11 += $ciu['count(*)'];$p11 += 1;
        ...
        ?>
          ...
          <?php
        if(isset($_POST['fecha'])){
            $aprobar = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Aprobado' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.grabado=b.usuario group by b.usuario order by count(*) desc");
        $consulta21= "SELECT count(*) FROM cotizacion a, usuarios b where a.estado='Aprobado' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.grabado=b.usuario";                     
        $result=  mysqli_query($conexion,$consulta21);
        $fila=  mysqli_fetch_array($result);
            
        }else{
            $aprobar = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Aprobado' and a.grabado=b.usuario group by b.usuario order by count(*) desc");
        ...
        echo '<tr><td width="5px">Items</td><td>Nombre del Usuario</td><td>Numero de Cotizaciones</td><td>Porcentaje de Rendimiento</td>';
        $c111 = 0;$p111 = 0;
        while($ciu = mysqli_fetch_array($aprobar)){
