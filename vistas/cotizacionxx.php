...
function Header()
{
	...
	$numfilas1 = mysqli_num_rows($historial1);
        ...
        for ($i=0; $i<$numfilas1; $i++){
            $fila1 = mysqli_fetch_array($historial1);
...
function Footer()
{
	...
	// N�mero de p�gina
        $this->Cell(0,2,'TEMPLADO S.A.S CALLE 72 No 65-228, TEL 3530218 - 3537791. FAX 3600173',0,0,'C');
        $this->Cell(-280,10,'BARRANQUILLA-ATLANTICO',0,0,'C');
