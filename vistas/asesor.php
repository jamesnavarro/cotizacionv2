...
include "../modelo/conexion.php";
     ...
     //$request2=mysqli_query($conexion,'SELECT * FROM `usuarios` where area = "Ventas" and id_user='.$_GET['codigo'].' order by nombre');
     $request2=mysqli_query($conexion,'SELECT * FROM `usuarios` where id_user='.$_GET['codigo'].' order by nombre');
