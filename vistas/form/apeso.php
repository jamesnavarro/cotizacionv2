<?php
 ...
 $fil =mysql_fetch_array(mysql_query($sqlq));
        $id_p= $fil["id_p"];
...
$ac =mysql_query("SELECT  count(*) FROM referencia_acce a, referencias b where a.num_ref=b.id_referencia and a.cotizacion=".$_GET['cot']." and a.id_cot=".$row["id_referencia"]."  ");
...
$alum_por = "SELECT (".$row["porcentaje_mp"].") as p FROM porcentajes where area_por='MP' and grupo='Perfileria'";
                ...
                $porca= $fia["p"]/100;
 $request1=mysql_query("SELECT * FROM producto a, producto_rep_alu b, referencias c where b.id_ref_alum=c.id_referencia and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]);
...
//    echo'<hr>';
	...
	while($rower=mysql_fetch_array($request1))
	{    
            if($rower['signo']=='+'){
...
$request_v=mysql_query("SELECT * FROM producto a, producto_rep_vid b, referencias c where b.id_ref_vid=c.id_referencia and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]);
...
if($request_v){
	...
	while($rower=mysql_fetch_array($request_v))
	{      
...
$request_rej=mysql_query("SELECT * FROM producto a, producto_rep_rej b, referencias c where b.id_referencia=c.id_referencia and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]);
...
if($request_rej){
        ...
        $xx=0; 
        $peso_rej=0;
	while($rower=mysql_fetch_array($request_rej))
	{      
       ...
       $request_vrej=mysql_query("SELECT * FROM producto a, producto_rep_vid b, referencias c where b.id_ref_vid=c.id_referencia and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]." and b.id_r_v=".$rower["medida_rej"]." ");
       $tvR=0;
...
$request_v=mysql_query("SELECT * FROM producto a, vidrios_divisiones b, referencias c where b.id_vidrio=c.id_referencia and a.id_p=b.id_producto and a.id_p=".$row["id_referencia"]);
...
<?php 
  $acc_por = "SELECT (".$row["porcentaje_mp"].") as p FROM porcentajes where area_por='MP' and grupo='Accesorios'";
                ...
                $porcacc= $fipa["p"]/100; 
$request_acE=mysql_query("SELECT * FROM producto a, producto_rep_acc b, referencias c where b.id_ref_acc=c.id_referencia and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]." order by b.para ");
...
if($request_acE){
	...
	//Por cada resultado pintamos una linea
        ...
        $tac = 0;
        $peso_acc=0;
	while($rower=mysql_fetch_array($request_acE))
	{      
            
            //--------------------------------------------------------------------
                        if($rower['can_rej']!=0){
    $request_v2=mysql_query("SELECT * FROM producto a, producto_rep_rej b, referencias c where b.id_referencia=c.id_referencia and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]." and b.id_r_rej=".$rower['can_rej']." ");
while($rowerz=mysql_fetch_array($request_v2))
{
$sqlx=("SELECT * FROM producto a, producto_rep_alu b, referencias c where b.id_ref_alum=c.id_referencia and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]." and b.id_r_a=".$rowerz["id_referencia_med"]."");
     ...
     $cant_rej = number_format($al / $rowerz['var3']);
        ...
        $request_ac=mysql_query("SELECT * FROM referencia_acce a, referencias b where a.num_ref=b.id_referencia and a.cotizacion=".$_GET['cot']." and a.id_cot=".$row["id_cotizacion"]."  ");
     
if($request_ac){

	//Por cada resultado pintamos una linea
        $t=0;$total2a=0;
	while($rower=mysql_fetch_array($request_ac))
	{       $t = $t +1;
...
$request_mano=mysql_query("SELECT * FROM producto a, producto_rep_ma b, referencia_ma c where  b.id_ref_ma=c.id_ref_ma and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]);
...
if($request_mano){
        ...
        $tot2=0;
        $tot2_p=0;
	while($rower=mysql_fetch_array($request_mano))
	{      
...
$request_maq=mysql_query("SELECT * FROM producto a, producto_rep_mo b, referencia_mo c where b.id_ref_mo=c.id_ref_mo and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]);
    
     
if($request_maq){

        $tot=0;
	while($rower=mysql_fetch_array($request_maq))
	{       
            $mt2 = ($row["alto_c"]/1000)*($row["ancho_c"]/1000);
...
$request_ad=mysql_query("SELECT * FROM producto a, producto_rep_ad b, referencia_admin c where b.id_ref_ad=c.id_ref_ad and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]);
...
if($request_ad){
	...
	//Por cada resultado pintamos una linea
        $tota=0;$tota_p=0;
	while($rower=mysql_fetch_array($request_ad))
	{       
            $por = 100;
...
$request_ot=mysql_query("SELECT * FROM producto a, producto_rep_otro b, referencia_otro c where b.id_ref_ot=c.id_ref_ot and a.id_p=b.id_p and a.id_p=".$row["id_referencia"]);
    
     
if($request_ot){
        $t2=0;
	while($rower=mysql_fetch_array($request_ot))
	{       
