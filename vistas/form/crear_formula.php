...
<?php  if(isset($_GET['del'])){ $sql = "DELETE FROM formulas WHERE id_f=".$_GET['del'].""; mysqli_query($conexion,$sql); echo "<script language='javascript' type='text/javascript'>";echo "location.href='../vistas/?id=add_form'";echo "</script>";} ?> 
