...
//echo $row33['id_p'].'<br>';          
$request_v8r=mysql_query("SELECT * FROM producto a, producto_rep_vid b, referencias c, cotizaciones d where d.id_referencia=a.id_p and b.id_ref_vid=c.id_referencia and a.id_p=b.id_p  and d.id_cot=".$row33['id_cot']." and d.traz_vid=".$row33['traz_vid']." and d.id_vidrio=".$row33['id_vidrio']." ");
...
if($request_v8r){
	...
	while($rowt=mysql_fetch_array($request_v8r))
	{  
...
// echo $_GET['tv'].' - '.$rowt["id_vidrio"].' - '.$rowt["id_p"];
            ...
            $fil_an =mysql_fetch_array(mysql_query($sqlxh));
            $id_p= $fil_an["id_p"];
            ...
            $fil_al =mysql_fetch_array(mysql_query($sqlwj));
            ...
            $fil_an2 =mysql_fetch_array(mysql_query($sqlx2k));
            ...
            if($rowt['alto_v2']!=0){
             ...
             $fil_al2 =mysql_fetch_array(mysql_query($sqlw2l));
