<?php 
if(isset($_GET['up'])){
    $query = mysqli_query($conexion,"SELECT * FROM pagos_rangos where id_pr=".$_GET['up']." ");
...
$request_ac=mysqli_query($conexion,"SELECT * FROM pagos_rangos where id_pago=".$_GET['cod']." ");
