...
<td class="hidden-phone" style="text-align:right">$'.number_format($c1t).'</font></td>
<td class="hidden-phone" style="text-align:right">$'.number_format($c2).'</font></td>
<td class="hidden-phone" style="text-align:right">$<font color="red">'.number_format($c3t).'</font></td>
<td class="hidden-phone" style="text-align:right"><font color="red">$'.number_format($c4t).'</font></td>'
. '</tr>';   
	} 
 $table = $table.'<tr>-<td>-<td>-<td style="text-align:center"><b>TOTALES</b><td>-<td>-<td>-<td>-<td>-<td>-<td>'
