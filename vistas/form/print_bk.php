...
if(isset($_GET['cot'])){ 
 $request=mysqli_query($conexion,"SELECT * FROM producto a, cotizaciones c, tipo_vidrio d where c.estado_c='Cotizado' and d.id_vidrio=c.id_vidrio and c.id_referencia=a.id_p and c.id_cot=".$_GET["cot"]);
