<?php 
$request=mysql_query('select count(*) from roles');
if($request){
...
$limit = 'LIMIT ' .($page - 1) * $rows_by_page .',' .$rows_by_page;
 ...
 $request=mysql_query("SELECT * FROM roles ".$limit);
...
<select name="acceso10"  style="width:120px;">
    ...
    while($fila=  mysql_fetch_array($result10)){
...
<select name="acceso11"  style="width:120px;">
    ...
    while($fila2=  mysql_fetch_array($result11)){
...
<select name="acceso13"  style="width:120px;">
 <?php
    ...
    $result13=  mysql_query($consulta13);
    while($fila=  mysql_fetch_array($result13)){
...
<select name="acceso14"  style="width:120px;">
 <?php
    ...
    while($fila=  mysql_fetch_array($result14)){
...
<select name="acceso15"  style="width:120px;">
 <?php
    ...
    $result15=  mysql_query($consulta15);
    while($fila=  mysql_fetch_array($result15)){
...
<select name="acceso16"  style="width:120px;">
 <?php
    ...
    $result16=  mysql_query($consulta16);
    while($fila=  mysql_fetch_array($result16)){
...
<select name="acceso17"  style="width:120px;">
 <?php
    ...
    $result17=  mysql_query($consulta17);
    while($fila=  mysql_fetch_array($result17)){
...
<select name="acceso18"  style="width:120px;">
 <?php
    ...
    $result18=  mysql_query($consulta18);
    while($fila=  mysql_fetch_array($result18)){
...
<select name="acceso19"  style="width:120px;">
 <?php
    ...
    $result19=  mysql_query($consulta19);
    while($fila=  mysql_fetch_array($result19)){
...
<select name="acceso20"  style="width:120px;">
 <?php
    ...
    $result20=  mysql_query($consulta20);
    while($fila=  mysql_fetch_array($result20)){
...
<select name="acceso21"  style="width:120px;">
 <?php
    ...
    $result21=  mysql_query($consulta21);
    while($fila=  mysql_fetch_array($result21)){
...
<select name="acceso23"  style="width:120px;">
 <?php
    ...
    $result23=  mysql_query($consulta23);
    while($fila=  mysql_fetch_array($result23)){
...
<select name="acceso24"  style="width:120px;">
 <?php
    ...
    $result24=  mysql_query($consulta24);
    while($fila=  mysql_fetch_array($result24)){
...
<select name="acceso25"  style="width:120px;">
 <?php
    ...
    $result25=  mysql_query($consulta25);
    while($fila=  mysql_fetch_array($result25)){
