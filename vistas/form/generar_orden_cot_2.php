<input type="text" id="estcot" value="<?php echo $estado ?>"  style="width:60px">
<script src="../vistas/presupuestos/funciones.js?v=2.0" type="text/javascript"></script>
<script>
    mostrar_tabla_items(<?php echo $_GET['cot'] ?>,<?php echo $_GET['cli'] ?>,1);
...
//                       
         ...
         function confirmarx(co,cot,cli){
        var con = confirm("Desea congelar esta cotizacion ? ");
            if(con){
                window.location.href='../vistas/?id=new_fac&cot='+cot+'&cli='+cli+'&congelar='+co;
            }
        }
...
<script>
	...
	function infoTipoServicio(id_tipo_servicio, tipo_servicio, valor_tipo_servicio) {
		...
		$("#cant_servicio").focus();
            ...
            function calculo(){
               ...
               var dec = $("#porcentaje_servicio").val();
                if(ser===''){
           ...
           var gt = (dec / 100) * tot;
           var r = (parseFloat(gt) + parseFloat(tot)) / 0.336;
            $("#total").val(tot);
            $("#total_servicio").val(r);
    }
    $(function(){
	...
	function tipoAccesorio() {
        ...
        function CalcularServ(){
            var gtu = $("#total_servicio").val();
            var ca = $("#cant_servicio").val();
            var gt = (0.336 * gtu);
            $("#valor_servicio").val((gt/ca));
            //$("#cant_servicio").val('1');
            $("#total").val(gt);  
        }
</script>
<?php
	$query_select_cot = mysqli_query($conexion,"SELECT * FROM cotizacion WHERE id_cot = '" . $_GET['cot'] . "'");
	$row_cot = mysqli_fetch_array($query_select_cot);
...
//include '../vistas/imprimir_reportes.php';
	...
	$query_total_item = mysqli_query($conexion,"SELECT (sum(`precio_item`*(`desc`/100))) + (sum(`precio_item`)) as granto, count(id_cot) FROM `cotizaciones` where id_cot=".$_GET["cot"]." and id_compuesto=0");
	$rg = mysqli_fetch_array($query_total_item);
 ?> 
          <form name="buscarA" action="../vistas/print.php" method="get"  target="_blank"  enctype="multipart/form-data">
                <div align="right">
                    ...
                    <input style="width:30px;" type="hidden" name="total_item" id="TotalItem" value="<?php echo $rg[1]; ?>" /><!--Codigo Agregado (Jaime)-->
                    <input style="width:30px;" type="number" name="col" value="<?php if(isset($_POST['col'])){echo $_POST['col'];}else{echo '7';} ?>">
                  <input style="width:30px;" type="hidden" name="granto" id="to" value="<?php echo $rg[0]; ?>">
                 
                    
                    <button type="submit"><img src="../imagenes/print.png"> Imprimir PDF</button>   
                </div>
          </form>
                                      <form name="buscarA" action="../vistas/print_aiu.php" method="get"  target="_blank"  enctype="multipart/form-data">
                <div align="right">
                    <input style="width:30px;" type="hidden" name="cot" id="cotizacionx" value="<?php echo $_GET['cot']; ?>">
                    <input style="width:30px;" type="hidden" name="c" value="">
                    <input style="width:30px;" type="hidden" name="ciudad" value="<?php if(isset($_POST['col'])){echo $_POST['ciudad'];} ?>">
                  ...
                  <input style="width:30px;" type="hidden" name="granto" id="to" value="<?php echo $rg[0]; ?>">
                    ...
                    <button type="submit"><img src="../imagenes/print.png"> Imprimir AIU</button>   
                </div>
          </form>
			<?php
				if ($express == 1) { ?>
			...
			?>
                                    <div align="right">
                                <a title="Editor de porcentajes por item y general" href="../vistas/configuracion_idioma.php?cot=<?php echo $_GET['cot'].'&cli='.$_GET['cli'].'&max='.$po; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=1200,height=700'); return false;"><button type="button"> US.</button></a>
                                        <button type="button" onclick="window.open('../vistas/calculos.php?cot=<?php echo $_GET['cot']; ?>','Desglose','width=1200px , height=900px')"> <img src="../imagenes/list1_add.png"> Informe </button>
                                        <button type="button" onclick="window.open('../vistas/hoja_materiales_1.php?cot=<?php echo $_GET['cot']; ?>','Desglose','width=1000px , height=900px')"> <img src="../imagenes/list1_add.png"> Desglose </button>
                                       <a title="Reporte de utilidad" href="../vistas/costos.php?cot=<?php echo $_GET['cot'].'&col='.$filas; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=800,height=800'); return false;">
                                           <button type="button"> <img src="../imagenes/bars.png"> REPORTE </button>
                                       </a>
...
<!--                                        <button><a target="_blank" href="../vistas/?id=send&cot=<?php echo $_GET['cot']; ?>&cli=<?php echo $_GET['cli'].'&tipo='.$tipo.' '; ?>"><img src="../imagenes/carta.jpg"> Enviar Email</a></button>-->
                                        <button> <a title="Hoja de Costo Temporal" href="#" onClick="materia_prima()"><img src="../imagenes/hoja.png"> Costo de Materia Prima</a></button>
<!--                                        <button onclick="window.open('form/asignar_huacal.php?cot=<?php echo $_GET["cot"];?>', 'Asignar', 'width=500, height=200');"><img src="../imagenes/add.png"> HUACAL</a></button>-->
                               ...
                               <?php  if($estado=='En proceso'){  ?>  <?php echo '<button type="button"  onclick="confirmarx(0,'.$_GET["cot"].','.$_GET["cli"].')"><img src="../imagenes/guardar.jpg"> Congelar Cotizacion</button>';  ?>
                              <?php } ?>
                   ...
                   <div class="row-fluid">
                        <!-- START Form Wizard -->
                            ...
                            <section class="body">
                                ...
                                <header style="background: yellow;"><center><h4 class="title">Productos cotizados (<?php echo 'Cotizacion No.'.$numero_cotizacion; ?>) <?php echo '    (<font color="red">V.'.$numero_cotizacion.'.'.$version.'</font>)'  ?></h4> <button onclick="reporte_itemsxd(<?php echo $_GET['cot'] ?>)" type="button" id="btn_report">Generar Reporte de Costo Materia Prima</button></center> </header>
                                 <?php  }else{  ?>  
                                 <header style="background: yellow;"><center><h4 class="title">Lista de Pedidos Aprobados <?php  echo '(Pedido No.'. $orden_p.') | Cotizacion No.'.$numero_cotizacion  ?></h4></center></header>
                                 <?php  }  ?>  
                                <div class="body-inner">
                                        
                                        <div class="control-group">
                                           <?php
                                           if(isset($_GET['up']) || isset($_GET['compuesto'])){
            $sql21 = ("SELECT *, a.rieles as cherieles,a.alfajia as chealfajia, a.cierres as checierres, a.rodajas as cherodajas, a.brazos as chemanijas   FROM producto a, cotizaciones c where a.id_p=c.id_referencia and c.id_cotizacion='".$_GET['up']."' ");
            $fila21 =mysqli_fetch_array(mysqli_query($conexion,$sql21));
            ...
            echo '<script>console.log('.$pelicula.')</script>';
            ...
            $manijas = $fila21["manijas"];
            $brazos = $fila21["brazos"];
            
            $cherieles = $fila21["cherieles"];
            $chealfajia = $fila21["chealfajia"];
            $checierres = $fila21["checierres"];
            $cherodajas = $fila21["cherodajas"];
            $chemanijas = $fila21["chemanijas"];
            if($cherieles=='true'){ $disar = ''; }else{ $disar = 'disabled'; }
            if($chealfajia=='true'){ $disaa = ''; }else{ $disaa = 'disabled'; }
            if($checierres=='true'){ $disac = ''; }else{ $disac = 'disabled'; }
            if($cherodajas=='true'){ $disaro = ''; }else{ $disaro = 'disabled'; }
            if($chemanijas=='true'){ $disama = ''; }else{ $disama = 'disabled'; }
            ...
            $result_cie = mysqli_query($conexion,"SELECT descripcion FROM receta_kits   where idkit='$cierres' ");
            $cie = mysqli_fetch_array($result_cie);
            $descierres = $cie[0];
            
            $result_rod = mysqli_query($conexion,"SELECT descripcion FROM receta_kits   where idkit='$rodajas' ");
            $rod = mysqli_fetch_array($result_rod);
            $desrodajas = $rod[0];
            
            $result_bra = mysqli_query($conexion,"SELECT descripcion FROM receta_kits   where idkit='$brazos' ");
            $bra = mysqli_fetch_array($result_bra);
            $desbrazos = $bra[0];
            ...
            $termovid1 = $fila21["termovid1"];
            $termovid2 = $fila21["termovid2"];
            $termovid3 = $fila21["termovid3"];
            $termovid4 = $fila21["termovid4"];
            
            $item = $fila21["fila"];
            
            $idespaciador = $fila21["idespaciador"];
            $cantespaciador = $fila21["cantespaciador"];
            
            if($termovid1=='46'){
                $destermovid1='VIDRIO TEMPLADO BPB';  
                $type1 = 'text';
            }else{
                if($termovid1=='1'){
                   $destermovid1='VIDRIO RECOCIDO AL CORTE';  
                   $type1 = 'text';
                }else{
                    $destermovid1='No aplica';
                    $type1 = 'hidden';
                }
            }
            if($termovid2=='46'){
                $destermovid2='VIDRIO TEMPLADO BPB'; 
                $type2 = 'text';
            }else{
                if($termovid2=='1'){
                   $destermovid2='VIDRIO RECOCIDO AL CORTE';  
                   $type2 = 'text';
                }else{
                    $destermovid2='No aplica';
                    $type2 = 'hidden';
                }
            }
            if($termovid3=='46'){
                $destermovid3='VIDRIO TEMPLADO BPB';  
                $type3 = 'text';
            }else{
                if($termovid3=='1'){
                   $destermovid3='VIDRIO RECOCIDO AL CORTE'; 
                   $type3 = 'text';
                }else{
                    $destermovid3='No aplica';
                    $type3 = 'hidden';
                    
                }
            }
            if($termovid4=='46'){
                $destermovid4='VIDRIO TEMPLADO BPB';  
                $type4 = 'text';
            }else{
                if($termovid4=='1'){
                   $destermovid4='VIDRIO RECOCIDO AL CORTE'; 
                   $type4 = 'text';
                   
                }else{
                    $destermovid4='No aplica';
                    $type4 = 'hidden';
                   
                }
            }
              if($laminas=='1'){
                   echo '<script>$(document).ready(function(){ $("#tg1").show() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg2").hide() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg3").hide() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg4").hide() });  </script>';
              }else if($laminas=='2'){
                  echo '<script>$(document).ready(function(){ $("#tg1").show() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg2").show() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg3").hide() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg4").hide() });  </script>';
              }else if($laminas=='3'){
                   echo '<script>$(document).ready(function(){ $("#tg1").show() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg2").show() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg3").show() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg4").hide() });  </script>';
              }else{
                  echo '<script>$(document).ready(function(){ $("#tg1").show() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg2").show() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg3").show() });  </script>';
                   echo '<script>$(document).ready(function(){ $("#tg4").show() });  </script>';
              }
              if($fila21["verpoli"]=='0'){
                  $checkver = '';
              }else{
                  $checkver = 'checked';
					...
					<?php
						...
						<?php
                                                    ...
                                                    ?>
							<form class="span12 widget shadowed dark form-horizontal bordered" action="<?php echo '../modelo/cotizacion_1.php?cot='.$_GET['cot'].'&cli='.$_GET['cli'].'&compuesto='.$_GET['compuesto'].'&tipo_cli=Empresarial'; ?>" method="post" id="form_validate_html" enctype="multipart/form-data">
                                                    <?php }
                                                    if (isset($_GET['mas'])) {
                                                        $mass = '&compuesto='.$_GET['mas'];
                                                    }else{
                                                        $mass = '';
                                                    }
                                                    ?>
                                                    	<form class="span12 widget shadowed dark form-horizontal bordered" action="<?php echo '../modelo/cotizacion_1.php?cot='.$_GET['cot'].'&cli='.$_GET['cli'].'&editar='.$_GET['up'].'&tipo_cli='.$tipo.''.$mass.''; ?>" method="post" id="form_validate_html" enctype="multipart/form-data">
                                ...
                                <div class="body-inner">
                                   <hr>
                                    <button type="submit" ><img src="../imagenes/guardar.jpg">Guardar Cambios*</button>
                                     ...
                                     <select id="dolar" name="dolar"  style="width:50px;">
                                         <?php 
                                         $quedol = mysqli_query($conexion,"select * from dolar_actual order by id_actual desc limit 30");
                                         while($do = mysqli_fetch_array($quedol)){
                                             echo '<option value="'.$do[0].'">'.$do[1].'</option>';
                                         }
                                         
                                         
                                         ?>
                                     </select>
                                     Notificaciones: <input type="text" value="<?php echo $msg ?>" name="msg" id="msg3" readonly="false" style="width:50px">
                                     <input type="text" value="<?php echo $msg2 ?>" name="msg2" id="msg4" readonly="false"  style="width:50px">
                                     <input type="hidden" value="<?php echo $cons['id_dolar'] ?>" name="id_dolar" style="width:40px;" >
                                     <input type="hidden" id="ciu" name="ciu" value="<?php echo $ciudadx ?>" readonly  style="width:100px">
                                     %Alu: <input type="text" id="dalu" name="despalu" value="<?php if(isset($_GET['compuesto'])){ echo '20'; }else{echo $poralu; }  ?>" style="width:20px" > |
                                     %Vid: <input type="text" id="dalu" name="despvid" value="<?php if(isset($_GET['compuesto'])){ echo '20'; }else{echo $porvid; } ?>" style="width:20px" > |
                                     %Acc: <input type="text" id="dalu" name="despacc" value="<?php if(isset($_GET['compuesto'])){ echo '5'; }else{echo $poracc; } ?>" style="width:20px" > |
                                     %Ace: <input type="text" id="dalu" name="despace" value="<?php if(isset($_GET['compuesto'])){ echo '20'; }else{echo $porace; } ?>" style="width:20px" >
                                     <?php if(!isset($_GET["compuesto"])){ ?>
<!--                                     <a href="../vistas/?id=new_fac&cot=<?php echo $_GET['cot'].'&cli='.$_GET['cli'].'&compuesto='.$_GET['up']  ?>"><button type="button" ><img width="18px" height="18px" src="../imagenes/cambiar.png">Agregar Compuesto directo</button></a>-->
                                     <?php }else{
                                         echo '<i>Estas agregando un compuesto</i>';
                                     } ?>
<!--                                     <button onclick="calcu(<?php echo $_GET['up']; ?>)" type="button"> * </button>-->
                                         <hr>
                                     <table class="table table-bordered table-striped table-hover">
                                        <tr>
                                            ...
                                            <td> <select name="install"  style="width: 80px;">
                                                        ...
                                                        <td rowspan="9"  style="width:30%">
                                                            <div align="center"  id="imagen"><?php if(isset($_GET['up'])){
                                                if($lado=='Derecho'){
                                               ...
                                               <table>
                                                     ...
                                                     <tr>
                                                        <td>Rieles</td>
                                                        <td><input type="hidden" id="rieles" name="rieles" style="width:40px" value="<?php if(isset($_GET['up'])){echo $rieles;} ?>" ></td>
                                                        <td><input type="text" id="desriel" style="width:140px" onclick="rielesform('rieles')" value="<?php if(isset($_GET['up'])){echo $desrieles;} ?>" <?php echo $disar ?>></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Alfajia</td>
                                                        <td><input type="hidden" id="alfajias" name="alfajias" style="width:40px"  value="<?php if(isset($_GET['up'])){echo $alfajia;} ?>"></td>
                                                        <td><input type="text" id="desalfa" style="width:140px" onclick="alfajiasform('alfajias')" value="<?php if(isset($_GET['up'])){echo $desalfajias;} ?>" <?php echo $disaa ?>></td>
                                                        <td></td>
                                                    </tr>
<!--                                                 <tr>
                                                        <td>Manijas</td>
                                                        <td><input type="hidden" id="manijas" name="rejillas" style="width:40px"></td>
                                                        <td><input type="text" id="desmani" style="width:140px" onclick="manijasform('manijas')"></td>
                                                        <td>X<input type="text" id="canmani" name="canmani" style="width:20px"></td>
                                                    </tr>-->
                                                    
                                                    <tr>
                                                        <td>Rodajas</td>
                                                        <td><input type="hidden" id="rodajas" name="rodajas" style="width:40px"  value="<?php if(isset($_GET['up'])){echo $rodajas;} ?>"></td>
                                                        <td><input type="text" id="desroda" style="width:140px" onclick="rodajasform('rodajas')"  value="<?php if(isset($_GET['up'])){echo $desrodajas;} ?>" <?php echo $disaro ?>></td>
                                                        <td>X<input type="text" id="canroda" name="canroda" style="width:20px"  value="<?php if(isset($_GET['up'])){echo $canrodajas;} ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Cierres</td>
                                                        <td><input type="hidden" id="cierres" name="cierres" style="width:40px" value="<?php if(isset($_GET['up'])){echo $cierres;} ?>"></td>
                                                        <td><input type="text" id="descier" style="width:140px" onclick="cierresform('cierres')"  value="<?php if(isset($_GET['up'])){echo $descierres;} ?>" <?php echo $disac ?>></td>
                                                        <td>X<input type="text" id="cancier" name="cancier" style="width:20px"  value="<?php if(isset($_GET['up'])){echo $cancierres;} ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>brazos</td>
                                                        <td><input type="hidden" id="brazos" name="brazos" style="width:40px" value="<?php if(isset($_GET['up'])){echo $brazos;} ?>"></td>
                                                        <td><input type="text" id="desbrazos" style="width:140px" onclick="brazosform('brazos')"  value="<?php if(isset($_GET['up'])){echo $desbrazos;} ?>"></td>
                                                        <td>X<input type="text" id="canbrazos" name="canbrazos" style="width:20px"  value="<?php if(isset($_GET['up'])){echo $canbrazos;} ?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Color</td>
                                                        <td colspan="3" id="cierre">
                                                            <select name="cierre"  required>
                                                    <?php if(isset($_GET['up'])){echo "<option value='".$cierre_cot."'>".$cierre_cot."</option>";}else{echo "<option value=''>.:Seleccione el color:.</option>"; } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <div id="busqueda"><a href="../vistas/lista_productos_1.php?linea=<?php echo $linea_cot; ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=800,height=700'); return false;"> <img src="../imagenes/pop.png"> Busqueda Avanzada</a></div>
                                            ...
                                            <td>Ubicacion</td>
                                            <td>
                                                <input type="hidden" name="precio" id="codig" value="p1">
                                       
                                            <textarea name="ubicacion" placeholder="digite la ubicacion de este producto"><?php if(isset($_GET['up'])){echo $ubica;} ?></textarea></td>
                                        ...
                                        <tr>
                                            ...
                                            <td id="vidrios"> 
                                                   <?php if(isset($_GET['up'])){
                                                       ...
                                                       $con23= "SELECT * FROM `producto` where linea='Vidrio' and id_p=".$traz_vid3." "; //lineas de codigos de generar orden
                                                ...
                                                . "<input placeholder='Vidrio #1' type='text' value='".$nombre1."' name='xxxnv' id='valo2'  required onclick='vidrio()'><br> ";

                                                }if($hoja >=2){
                                                echo "<input type='hidden' name='traz_vid2' id='valo3' value='".$idco2."'  required>"
                                                . "<input type='text' placeholder='Vidrio #2' value='".$nombre2."' name='xxxnv2' id='valo4'  required onclick='vidrio2()'><br> ";

                                                }if($hoja >=3){
                                                echo "<input type='hidden' name='traz_vid3' id='valo5' value='".$idco3."'  required>"
                                                . "<input type='text' placeholder='Vidrio #2' value='".$nombre3."' name='xxxnv3' id='valo6'  required onclick='vidrio3()'><br> ";

                                                }if($hoja >=4){
                                                echo "<input type='hidden' name='traz_vid4' id='valo7' value='".$idco4."'  required>"
                                                . "<input type='text' placeholder='Vidrio #2' value='".$nombre4."' name='xxxnv4' id='valo8'  required onclick='vidrio4()'><br> ";
                                            ...
                                            <td>Posicion Items</td>
                                            <td><input type="text"  name="item" value="<?php if(isset($_GET['up'])){echo $item;} ?>"  style="width: 70px;"  placeholder="" >
                                                <input type="hidden" name="desc" value="<?php  echo $desc;  ?>"  style="width: 60px;"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <div  id="lam">
                                                    <?php 
                                                        if($laminas!=0){  ?>
                                                     <select name="laminas"  style="width: 80px;" required id="lamina">                                                       
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div  id="vid">
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vid' id='valor2' value='0' required>"
                                                        . "<input type='text' name='xxxv' id='valor1' value='No tiene vidrio'  required>";
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vid' id='valor2' value='".$id_vidrio."' required>"
                                                                . "<input type='text' name='xxxv' id='valor1' value='".$color_v."'  required onclick='atencion()'><br>";
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vid2' id='valor4' value='".$id_vidrio2."' required>"
                                                                . "<input type='text' name='xxxv2' id='valor3' value='".$color_v2."'  required onclick='atencion2()'><br>";
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vid3' id='valor6' value='".$id_vidrio3."' required>"
                                                                . "<input type='text' name='xxxv3' id='valor5' value='".$color_v3."'  required onclick='atencion3()'><br>";
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vid4' id='valor8' value='".$id_vidrio4."' required>"
                                                                . "<input type='text' name='xxxv4' id='valor7' value='".$color_v4."'  required onclick='atencion4()'><br>";
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vid5' id='valor10' value='".$id_vidrio5."' required>"
                                                                . "<input type='text' name='xxxv5' id='valor9' value='".$color_v5."'  required onclick='atencion5()'><br>";
                                            ...
                                            <div  id="vid2">
                                                <?php if($laminas2>=1) {  
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vidd' id='valor22' value='".$id2_vidrio."' required>"
                                                                . "<input type='text' name='xxxvv' id='valor21' value='".$color_v."'  required onclick='atenciond()'><br>";
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vidd2' id='valor24' value='".$id2_vidrio2."' required>"
                                                                . "<input type='text' name='xxxvv2' id='valor23' value='".$color_v2."'  required onclick='atenciond2()'><br>";
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vidd3' id='valor26' value='".$id_vidrio3."' required>"
                                                                . "<input type='text' name='xxxvv3' id='valor25' value='".$color_v3."'  required onclick='atenciond3()'><br>";
                                                    ...
                                                    if(isset($_GET['up'])){
                                                        ...
                                                        echo "<input type='hidden' name='vidd4' id='valor28' value='".$id2_vidrio4."' required>"
                                                                . "<input type='text' name='xxxvv4' id='valor27' value='".$color_v4."'  required onclick='atenciond4()'><br>";
                                            ...
                                            <td>Trazabilidad por vidrios (solo termo)	</td>
                                            <td>
                                                <div  id="tvid">
                                                     <select name="termo1"  style="width: 180px;" id="tg1">
                                                         <?php echo '<option value="'.$termovid1.'">'.$destermovid1.'</option>'; ?>
                                                         <option value="0">No aplica</option>
                                                         <option value="46">VIDRIO TEMPLADO BPB</option>
                                                         <option value="1">VIDRIO RECOCIDO AL CORTE</option>
                                                     </select>
                                                 </div>
                                                 <div  id="tvid2">
                                                     <select name="termo2"  style="width: 180px;" id="tg2">
                                                         <?php echo '<option value="'.$termovid2.'">'.$destermovid2.'</option>'; ?>
                                                         <option value="0">No aplica</option>
                                                        <option value="46">VIDRIO TEMPLADO BPB</option>
                                                         <option value="1">VIDRIO RECOCIDO AL CORTE</option>
                                                     </select>
                                                 ...
                                                 <div  id="tvid3">
                                                     <select name="termo3"  style="width: 180px;" id="tg3">
                                                         <?php echo '<option value="'.$termovid3.'">'.$destermovid3.'</option>'; ?>
                                                         <option value="0">No aplica</option>
                                                         <option value="46">VIDRIO TEMPLADO BPB</option>
                                                         <option value="1">VIDRIO RECOCIDO AL CORTE</option>
                                                     </select>
                                                 ...
                                                 <div  id="tvid4">
                                                     ...
                                                     <select name="termo4"  style="width: 180px;" id="tg4">
                                                         <?php echo '<option value="'.$termovid4.'">'.$destermovid4.'</option>'; ?>
                                                         <option value="0">No aplica</option>
                                                         <option value="46">VIDRIO TEMPLADO BPB</option>
                                                         <option value="1">VIDRIO RECOCIDO AL CORTE</option>
                                                     </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="pel" name="pel">
                                                    <?php if(isset($_GET['up'])){
                                                        $query2= "SELECT * FROM `referencias` where id_referencia in ($rollo) ";                     
                                                            $resul2=  mysqli_query($conexion,$query2);
                                                            $f = mysqli_fetch_array($resul2);
                                                     ...
                                                     <?php         
                                                           $query= "SELECT * FROM `referencias` where id_referencia in ('1107','1764','1765','1766','1959') ";                      
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <select id="idesp" name="idesp">
                                                     ...
                                                     <?php     
                                                     $query2eup= "SELECT * FROM receta_kits where idkit='$idespaciador' ";                     
                                                            $resul2eup=  mysqli_query($conexion,$query2eup);
                                                            $fila2=  mysqli_fetch_array($resul2eup);
                                                            
                                                            echo"<option value='".$fila2['idkit']."'>   ".$fila2['descripcion']."</option>";
                                                           $query2e= "SELECT * FROM receta_kits where modulo like 'Espaciadores' and estado='ACTIVO' and idkit!='$idespaciador' ";                     
                                                            $resul2e=  mysqli_query($conexion,$query2e);
                                                            while($fila=  mysqli_fetch_array($resul2e)){
                                                            $valor1=$fila['idkit'];
                                            ...
                                            <td>Cant. Esp </td>
                                            <td><input  type="number"  name="cantesp" style="width: 40px;" value="<?php echo $cantespaciador ?>" placeholder=""></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>Observaciones adicioneles</td>
...
?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" autocomplete="off" name="cuerpo" id="cuerpo2" value="<?php if(isset($_GET['up'])){echo $cuerpo;} ?>" style="width: 70px;"  placeholder="Alto en mm" </td>
                                        ...
                                        <tr>
                                           ...
                                           <td>Ancho Cuerpo Fijo</td>
                                            <td><input type="text" autocomplete="off" name="ladomm" id="ladomm" value="<?php if(isset($_GET['up'])){echo $ladomm;} ?>" style="width: 70px;"  placeholder="Lado" ></td>
                                           
                                        </tr>
                                         <tr>
                                            <td>Medidas Totales con Compuestos</td>
                                             <td><input type="text" name="ancho_temp" autocomplete="off" value="<?php if(isset($_GET['up'])){echo $ancho_temp;} ?>" style="width: 70px;"  placeholder="Ancho en mm" >
                                              X <input type="text" name="alto_temp" autocomplete="off" value="<?php if(isset($_GET['up'])){echo $alto_temp;} ?>" style="width: 70px;"  placeholder="Alto en mm" ></td>
                                            ...
                                            <tr>
                                                <td>POLIURETANO   <input type="checkbox" name="verp" value="1" <?php if(!isset($_GET['compuesto'])){echo $checkver;} ?>></td>
                                                <td>
                                                    <select id="poli" name="poli" style="width:50px">
                                                        
                                                        <?php if(isset($_GET['up'])){echo "<option value='".$poli."'>".$poli."</option>";} ?>
                                                        <option value="No">No</option>
                                                        <option value="Si">Si</option>
                                                        
                                                    </select> <input type="number" id="cvp" name="cvp" placeholder="Verticales" style="width:50px" value="<?php if(isset($_GET['up'])){echo $poli_v;} ?>">
                                                    <input type="number" id="chp" name="chp" placeholder="Horizontales" style="width:50px" value="<?php if(isset($_GET['up'])){echo $poli_h;} ?>">
                                                </td>
                                        <td>Lleva Huacal?</td>
                                            <td>
                                                <select name="huacal">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td> 
                                                <input type="hidden" autocomplete="off" name="ancho_abajo" value="<?php if(isset($_GET['up'])){echo $aa;} ?>"  style="width: 70px;"  placeholder="Alto en mm" >
                                                </td>
                                             <td></td>
                                            <td></td>
...
?></div>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td> <input type="checkbox" name="d1"  <?php if(!isset($_GET['compuesto'])){if($d1!='0'){echo 'checked';}}  ?> value="1">Automatico</td>
                                            <td></td><td></td>
                                        </tr>
                                    </table>
                                     <br>
                                     ...
                                     <div class="container">
                                         ...
                                         <?php }
                                            ...
                                            $com=mysqli_query($conexion,"SELECT producto,id_p, codigo,ancho_c,alto_c,id_cotizacion  FROM producto a, cotizaciones c where c.id_referencia=a.id_p and c.id_cot=".$_GET["cot"]." and c.id_compuesto=".$_GET["up"]."");
                $compuesto ='<ul>';
                $up = '';
                while($cpt = mysqli_fetch_array($com)){
                    
                    $compuesto = $compuesto.'<li><a href="../vistas/?id=new_fac&cot='.$_GET["cot"].'&cli='.$_GET["cli"].'&up='.$cpt['id_cotizacion'].'">'.$cpt['producto'].' Med: '.$cpt['ancho_c'].'x'.$cpt['alto_c'].' </a></li>';
                }
                        ...
                        <!--/ END Form Wizard -->
                                ...
                                <input type="text" name="buscar" id="buscar" class="span4" placeholder="Digite el tipo, referencia ó descripcion del producto" onchange="mostrar_tabla_items(<?php echo $_GET['cot'] ?>,<?php echo $_GET['cli'] ?>,1)">
                       
                                <select id="paginas"  style="width:60px" onchange="mostrar_tabla_items(<?php echo $_GET['cot'] ?>,<?php echo $_GET['cli'] ?>,1);" >
                                    <option value="20">20</option> 
                                    <option value="50">50</option>
                                    <option value="100">100</option>
                                    
                                </select>
                                Total Cot:<input style="width:100px;" type="text" value="<?php echo number_format($rg[0]); ?>" disabled>
                                <br>
                                <?php  if($estado=='En proceso'){  ?>
                                <select id="color_alum">
                                    ...
                                    <?php
                                        ...
                                        $result62=  mysqli_query($conexion,$consulta62);
                                        while($fila=  mysqli_fetch_array($result62)){
                                        $valor3=$fila['color_a'];
                                        echo"<option value='".$valor3."'>".$valor3."</option>";
                                        }
                                    ?>
        ...
        <form name="buscarA" action="../vistas/?id=new_fac&cot=<?php echo $_GET['cot'] ?>&cli=<?php echo $_GET['cli'] ?>&por" method="post" enctype="multipart/form-data">
            ...
            $request2=mysqli_query($conexion,"SELECT * FROM referencia_mo a, cotizaciones_servicios b where a.id_ref_mo=b.id_servicio and b.id_cotizacion=".$_GET['cot']." and id_cot_mas=0 ");
...
//    echo'<hr>';
       $table2 = '<table class="table table-bordered table-striped table-hover" id="">';
	      ...
	      $table2 = $table2.'<th width="50%">'.'Descripción del Servicio'.'</th>';
            ...
            $fr = ($row2["precio_servicio"]) ; 
             ...
             $total_serv = $dd / 0.336;
              $to_serv = $to_serv + $total_serv;
               $table2 = $table2.'<tr><td width="5%">'.$total2s.'</a></td><td width="5%">'.$row2['cod_serv'].'</font></td>'
                    . '<td width="50%">'.$row2['descripcion_mo'].'</br>' . $row2["obs_servicio"] . '</td>
                    ...
                    . '<td width="10%">'.$row2["cantidad_serv"].'</td><td width="10%">'.number_format($dd).'</td>'
                         . '<td width="10%">'.number_format(($total_serv)).'</td>'
...
//    echo'<hr>';
	...
	{       
            ...
            $perimetro = $row21["area"]/1000;
             ...
             $table2 = $table2.'<tr><td width="5%">'.$vc.' '.$perimetro.' - '.($row21["med"]/1000).'</a></td>'
                    . '<td width="5%">'.$row21['codigo'].'</font></td>'
                    . '<td width="40%">'.$row21['descripcion'].' '.$cm.'.<br><b>ubicacion: </b>.'.$row21['ubicacion'].'</font></td>'
                    ...
                    . '<td width="10%">'.$row21["med"].'</td>
                     ...
                     . '<td width="10%">' .number_format($valor_acabado). '</td>'
...
//    echo'<hr>';
	...
	{       
                 ...
                 $table4 = $table4.'<tr><td width="5%">'.$t2e.'</a></td>'
                         . '<td width="5%">'.$row21k['codigo'].'</td>'
                         . '<td width="40%">'.$row21k['producto'].' '.$ck.'</td>'
                         . '<td width="10%">'.$row21k["referencia_p"].'</td>
                            <td width="10%">N/A</td>
                            <td width="10%">$'.number_format(($totk)/ $porcacc).'</td>'
...
$tacot = $rg[0];
          ...
          mysqli_query($conexion,"update cotizacion set costo_total='$gt_total' where id_cot='".$_GET["cot"]."' ");
          mysqli_query($conexion,"update seguimientos_cot set vtotal_obra='$gt_total' where id_relacion='".$_GET["cot"]."' ");
          if($estado!='Aprobado'){                             
          ?>
          <table>
             <tr>
                            ...
                            <section class="body">
                                <div class="body-inner">
                                    <hr>
                                     ...
                                     Notificaciones: <input type="text" value="" name="msg" id="msg" readonly="false"  style="width:50px" > 
                                     <input type="text" value="" name="msg2" id="msg2" readonly="false"  style="width:50px" >
                                     <input type="hidden" value="<?php echo $cons['id_dolar'] ?>" name="id_dolar" style="width:40px;">
                                    Peso: <input type="text" id="pesov" name="pesov" value="0Kgs" readonly  style="width:20px" > 
                                         <input type="hidden" id="ciu" name="ciu" value="<?php echo $ciudadx ?>" readonly style="width:100px" >
                                         %Alum: <input type="text" id="dalu" name="despalu" value="20" style="width:20px" > |
                                     %Vid: <input type="text" id="dalu" name="despvid" value="20" style="width:20px" > |
                                     %Acc.: <input type="text" id="dalu" name="despacc" value="5" style="width:20px" > |
                                     %Ace: <input type="text" id="dalu" name="despace" value="5" style="width:20px" >
                                     ...
                                     <table class="table table-bordered table-striped table-hover">
                                        <tr>
                                            ...
                                            <td rowspan="7"   style="width:40%">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>Rieles</td>
                                                        <td><input type="hidden" id="rieles" name="rieles" style="width:40px"></td>
                                                        <td><input type="text" id="desriel" style="width:140px" onclick="rielesform('rieles')"></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Alfajia</td>
                                                        <td><input type="hidden" id="alfajias" name="alfajias" style="width:40px"></td>
                                                        <td><input type="text" id="desalfa" style="width:140px" onclick="alfajiasform('alfajias')"></td>
                                                        <td></td>
                                                    </tr>
                                                    <!--<tr>
                                                        <td>Rejillas</td>
                                                        <td><input type="text" id="rejillas" name="rejillas" style="width:40px"></td>
                                                        <td><input type="text" id="desreji" style="width:140px" onclick="rejillasform('rejillas')"></td>
                                                        <td>/<input type="text" id="canreji" name="canreji" style="width:20px"></td>
                                                    </tr>-->
                                                    
                                                    <tr>
                                                        <td>Rodajas</td>
                                                        <td><input type="hidden" id="rodajas" name="rodajas" style="width:40px"></td>
                                                        <td><input type="text" id="desroda" style="width:140px" onclick="rodajasform('rodajas')"></td>
                                                        <td>X<input type="text" id="canroda" name="canroda" style="width:20px"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Cierres</td>
                                                        <td><input type="hidden" id="cierres" name="cierres" style="width:40px"></td>
                                                        <td><input type="text" id="descier" style="width:140px" onclick="cierresform('cierres')"></td>
                                                        <td>X<input type="text" id="cancier" name="cancier" style="width:20px"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>brazos</td>
                                                        <td><input type="hidden" id="brazos" name="brazos" style="width:40px" value=""></td>
                                                        <td><input type="text" id="desbrazos" style="width:140px" onclick="brazosform('brazos')"  value=""></td>
                                                        <td>X<input type="text" id="canbrazos" name="canbrazos" style="width:20px"  value=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Color</td>
                                                        <td colspan="3" id="cierre">
                                                            <select name="cierre"  required >
                                                    <option value=''>.:Color de Cierre:.</option>  
                                                                   <?php
                                                                       require '../modelo/conexion.php';
                                                           $consulta= "SELECT * FROM `tipo_aluminio`";                     
                                                            $result=  mysqli_query($conexion,$consulta);
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td> 
                                                <input type="hidden" readonly name="precio_mp" value="p1"  style="width: 80px;">
                                                 </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>Posicion Items</td>
                                            <td id="descuento">  
                                                <input type="hidden" name="desc" value="0"  style="width: 60px;">
                                             <input type="text"  name="item" value=""  style="width: 70px;"  placeholder="" ></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               Trazabilidad por vidrios (solo termo)
                                            </td>
                                             <td>
                                                 <div  id="tvid">
                                                     <select name="termo1"  style="width: 180px;" id="tg1">
                                                         <option value="0">No aplica</option>
                                                         <option value="VT0046">VIDRIO TEMPLADO BPB</option>
                                                         <option value="VC0001">VIDRIO RECOCIDO AL CORTE</option>
                                                     </select>
                                                 </div>
                                                 <div  id="tvid2">
                                                     <select name="termo2"  style="width: 180px;" id="tg2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="idesp" name="idesp">
                                                    <option value="">Seleccione</option>
                                                     <?php         
                                                           $query2= "SELECT * FROM receta_kits where modulo like 'Espaciadores' and estado='ACTIVO' ";                     
                                                            $resul2=  mysqli_query($conexion,$query2);
                                            ...
                                            <td>Cant. Esp </td>
                                            <td><input  type="number"  name="cantesp" style="width: 40px;" value="0" placeholder=""></td>
                                        </tr>
                                        <tr>
                                            <td>Color del Aluminio</td>
                                        ...
                                        <tr>
                                          <td>Observaciones</td>
                                            <td><textarea name="descripcion" placeholder="Comente las especificaciones de este producto"><?php if(isset($_GET['up'])){echo $obs;} ?></textarea></td>
                                              <td>Observaciones adcionales</td>
                                            <td><textarea name="obs2" placeholder="Observacion adicional"><?php if(isset($_GET['up'])){echo $obs2;} ?></textarea></td>
                                        ...
                                        <tr>
                                        <td>POLIURETANO <input type="checkbox" name="verp" value="1"> Ver?</td>
                                                <td>
                                                    <select id="poli" name="poli" style="width:50px">
                                                        <option value=""></option>
                                                        <option value="Si">Si</option>
                                                        <option value="No">No</option>
                                                    </select> <input type="number" id="cvp" name="cvp" placeholder="Verticales" style="width:50px">
                                                    <input type="number" id="chp" name="chp" placeholder="Horizontales" style="width:50px">
                                                </td>
                                        <td>Lleva Huacal?</td>
                                            <td>
                                                 <select name="huacal">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><input type="hidden" name="ancho_abajo" value="0"></td>
                                            <td></td>
                                            <td></td>
				...
				<div class="body-inner">                    
					<?php
						if (isset($_GET['up_serv'])) {
							$sql21 = "SELECT * FROM referencia_mo a, cotizaciones_servicios b
							...
							$fr = ($fila21["valor_mo"] );
							$des = ($dd / 100) * $valor_sv;
							$vv = ($valor_sv + $des) * $fila21["cantidad_serv"];
                                                        $vvt = $vv / 0.336;
						}
					...
					<div class="row-fluid">
						<br>
						 ...
						 <table class="table table-bordered table-striped table-hover">
                                        <tr>
                                            <th style="width:20%">Seleccionar Servicios</th>
                                            <td><input type="text" id="servicio_hidden" name="servicio_hidden" style="width:40px" readonly  value="<?php if(isset($_GET['up_serv'])){ echo $idfrm; } ?>" >
                                                <input type="text" id="servicio" name="servicio" style="width:240px" value="<?php if(isset($_GET['up_serv'])){ echo $des_sv; } ?>" readonly>
                                         ...
                                         <tr>
                                            <th>Codigo</th>
                                            <td><input type="text" name="cod_servicio" value="<?php if(isset($_GET['up_serv'])){ echo $cod_sv; } ?>"  style="width:100px" id="cod_servicio">  <span id="msgs"></span></td>
                                        </tr> 
                                        <tr>
                                            <th>Cantidad</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="porcentaje_servicio" value="0" id="porcentaje_servicio" style="width:40px" >
                                             ...
                                             <tr>
                                            <th>Valor Total</th>
                                            <td><input type="text" name="total" value="<?php if(isset($_GET['up_serv'])){ echo ($valor_sv*$cant_sv); } ?>"  style="width:80px" id="total">=
                                            <input type="text" value="<?php if(isset($_GET['up_serv'])){ echo ($vvt); } ?>"  style="width:80px" id="total_servicio"  onchange="CalcularServ()"></td>
                                        </tr>
                                             <tr>
                                        ...
                                        <tr>
                                            <th>Observaciones para el cliente</th>
                                            <td><textarea name="descripcion_servicio2" id="descripcion_servicio2" style="width:80%"><?php if(isset($_GET['up_serv'])){ echo ($observaciones_sv2); } ?></textarea></td>
                                        </tr>
                                        <tr>
                                            <th>Sumar</th>
                                                    <td>
                                                        <select id="suma" name="suma">
                                                            <?php if(isset($_GET['up_serv'])){ echo ($suma); } ?>
                                                            <option value="Si">Si</option>
                                                            <option value="No">No</option>
                                                       </select>
                                                    </td>
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <td  id="alum"> <select name="color"  required>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    <th>Ubicacion</th>
                                                    <td><input type="text" id="ubicac" name="ubicac" value="<?php if(isset($_GET['up_mat'])){ echo $ubicac; }else{echo '';} ?>"></td>
                                                </tr>
                                                <tr>
                                                	<th>Observaciones</th>
                                                	<td>
...
if(isset($_GET['por'])){
        ...
        for($x=1; $x<=$n; $x=$x+1){
            if(isset($_POST["valor$x"])){
                ...
                mysqli_query($conexion,$sqlr);
                  ...
                  mysqli_query($conexion,$sqlr);echo '<script lanquage="javascript">alert("Se ha Actualizado los porcentajes");location.href="../vistas/?id=new_fac&cot='.$_GET['cot'].'&cli='.$_GET['cli'].'"</script>'; 
}}
 if (isset($_GET['del_serv'])) {
		$sql = "DELETE FROM cotizaciones_servicios WHERE id_cot_serv = " . $_GET['del_serv'] . "";
		mysqli_query($conexion,$sql);
		mysqli_query($conexion,"DELETE FROM info_servicios WHERE id_servicio = " .  $_GET['del_serv'] . "");
  ...
  if (isset($_GET['del_vid'])) {
		$query_select_valor_delete = mysqli_query($conexion,"SELECT precio_unitario, id_servicio FROM info_servicios WHERE id_info_servicio = " . $_GET['del_vid']);
		$row_valor_delete = mysqli_fetch_array($query_select_valor_delete);
		//echo "<script>alert('" . $row_valor_delete['id_servicio'] . "');</script>";
		mysqli_query($conexion,"UPDATE cotizaciones_servicios SET precio_accesorios = precio_accesorios - " . $row_valor_delete["precio_unitario"] . " WHERE id_cot_serv = " . $row_valor_delete["id_servicio"]);
		mysqli_query($conexion,"DELETE FROM info_servicios WHERE id_info_servicio = " . $_GET['del_vid']);
		echo "<script language='javascript' type='text/javascript'>";
  ...
  if (isset($_GET['del_k'])) {
   ...
   if(isset($_GET['copy'])){
                 ...
                 mysqli_query($conexion,"insert into cotizaciones (`imagen`, `id_cot`, `id_referencia`, `laminas`, `laminas2`, `laminas3`, `laminas4`, `id_vidrio`, `id_vidrio2`, `id_vidrio3`, `id_vidrio4`, `id_vidrio5`, `id_vidrio6`, `cierre`, `ancho_c`, `ancho_c_original`, `alto_c`, `ancho_abajo`, `hojas`, `cuerpo`, `lado`, `cantidad_c`, `cantidad_temp`, `cant_restante`, `valor_c`, `valor_c_sp`, `valor_fom`, `valor_costob`, `valor_fomp`, `id_cliente`, `tipo_c`, `fecha_c`, `estado_c`, `registrado_por_c`, `aprobado`, `num_pedido`, `orden`, `asignado_a`, `linea_cot`, `cod_traz`, `boq`, `per`, `porcentaje`, `porcentaje_mp`, `descuento_g`, `color_ta`, `precio_item`, `precio_adicional`, `precio_material`, `precio_fom_sp`, `observaciones`, `observaciones2`, `desc`, `verticales`, `horizontales`, `d1`, `duracion`, `install`, `traz_vid`, `traz_vid2`, `traz_vid3`, `traz_vid4`, `ubicacion_c`, `tip`, `imagen_mas`, `an`, `al`, `fila`, `id2_vidrio`, `id2_vidrio2`, `id2_vidrio3`, `id2_vidrio4`, `id2_vidrio5`, `id3_vidrio`, `id3_vidrio2`, `id3_vidrio3`, `id3_vidrio4`, `id3_vidrio5`, `id4_vidrio`, `id4_vidrio2`, `id4_vidrio3`, `id4_vidrio4`, `id4_vidrio5`, `modulo`, `pelicula`, `huacal`, `ancho_temp`, `alto_temp`, `valor_temp`, `id_dolar`, `p_act_sp`, `p_act_cp`, `aprobado_por`, `servicio`, `estado_item`, `aprobado_por_user`, `fecha_aprobada`, `iva`, `ajuste`, `msg`, `msg2`, `peso_producto`, `valor_adicional`, `adicional_per`, `rollo`, `descripcion_rollo`, `cont_item`, `cantlam`, `poli`, `poli_v`, `poli_h`, `verpoli`, `rieles`, `alfajia`, `rejillas`, `cierres`, `rodajas`, `bisagras`, `can_rieles`, `can_alfajia`, `can_rejillas`, `can_cierres`, `can_rodajas`, `can_bisagras`, `poralu`, `porvid`, `poracc`, `porace`, `id_compuesto`, `compuestos`) select  `imagen`, 'id_cot', `id_referencia`, `laminas`, `laminas2`, `laminas3`, `laminas4`, `id_vidrio`, `id_vidrio2`, `id_vidrio3`, `id_vidrio4`, `id_vidrio5`, `id_vidrio6`, `cierre`, `ancho_c`, `ancho_c_original`, `alto_c`, `ancho_abajo`, `hojas`, `cuerpo`, `lado`, `cantidad_c`, `cantidad_temp`, `cant_restante`, `valor_c`, `valor_c_sp`, `valor_fom`, `valor_costob`, `valor_fomp`, `id_cliente`, `tipo_c`, `fecha_c`, `estado_c`, `registrado_por_c`, `aprobado`, `num_pedido`, `orden`, `asignado_a`, `linea_cot`, `cod_traz`, `boq`, `per`, `porcentaje`, `porcentaje_mp`, `descuento_g`, `color_ta`, `precio_item`, `precio_adicional`, `precio_material`, `precio_fom_sp`, `observaciones`, `observaciones2`, `desc`, `verticales`, `horizontales`, `d1`, `duracion`, `install`, `traz_vid`, `traz_vid2`, `traz_vid3`, `traz_vid4`, `ubicacion_c`, `tip`, `imagen_mas`, `an`, `al`, `fila`, `id2_vidrio`, `id2_vidrio2`, `id2_vidrio3`, `id2_vidrio4`, `id2_vidrio5`, `id3_vidrio`, `id3_vidrio2`, `id3_vidrio3`, `id3_vidrio4`, `id3_vidrio5`, `id4_vidrio`, `id4_vidrio2`, `id4_vidrio3`, `id4_vidrio4`, `id4_vidrio5`, `modulo`, `pelicula`, `huacal`, `ancho_temp`, `alto_temp`, `valor_temp`, `id_dolar`, `p_act_sp`, `p_act_cp`, `aprobado_por`, `servicio`, `estado_item`, `aprobado_por_user`, `fecha_aprobada`, `iva`, `ajuste`, `msg`, `msg2`, `peso_producto`, `valor_adicional`, `adicional_per`, `rollo`, `descripcion_rollo`, `cont_item`, `cantlam`, `poli`, `poli_v`, `poli_h`, `verpoli`, `rieles`, `alfajia`, `rejillas`, `cierres`, `rodajas`, `bisagras`, `can_rieles`, `can_alfajia`, `can_rejillas`, `can_cierres`, `can_rodajas`, `can_bisagras`, `poralu`, `porvid`, `poracc`, `porace`, `id_compuesto`, `compuestos` from cotizaciones where id_cotizacion='".$_GET['copy']."' ");
                 
                 $sql5 = "SELECT max(id_cotizacion) FROM cotizaciones";
                 $fila5 =mysqli_fetch_array(mysqli_query($conexion,$sql5));
                 $maxcot= $fila5["max(id_cotizacion)"];
                 
                 mysqli_query($conexion,"insert into cotizaciones (`imagen`, `id_cot`, `id_referencia`, `laminas`, `laminas2`, `laminas3`, `laminas4`, `id_vidrio`, `id_vidrio2`, `id_vidrio3`, `id_vidrio4`, `id_vidrio5`, `id_vidrio6`, `cierre`, `ancho_c`, `ancho_c_original`, `alto_c`, `ancho_abajo`, `hojas`, `cuerpo`, `lado`, `cantidad_c`, `cantidad_temp`, `cant_restante`, `valor_c`, `valor_c_sp`, `valor_fom`, `valor_costob`, `valor_fomp`, `id_cliente`, `tipo_c`, `fecha_c`, `estado_c`, `registrado_por_c`, `aprobado`, `num_pedido`, `orden`, `asignado_a`, `linea_cot`, `cod_traz`, `boq`, `per`, `porcentaje`, `porcentaje_mp`, `descuento_g`, `color_ta`, `precio_item`, `precio_adicional`, `precio_material`, `precio_fom_sp`, `observaciones`, `observaciones2`, `desc`, `verticales`, `horizontales`, `d1`, `duracion`, `install`, `traz_vid`, `traz_vid2`, `traz_vid3`, `traz_vid4`, `ubicacion_c`, `tip`, `imagen_mas`, `an`, `al`, `fila`, `id2_vidrio`, `id2_vidrio2`, `id2_vidrio3`, `id2_vidrio4`, `id2_vidrio5`, `id3_vidrio`, `id3_vidrio2`, `id3_vidrio3`, `id3_vidrio4`, `id3_vidrio5`, `id4_vidrio`, `id4_vidrio2`, `id4_vidrio3`, `id4_vidrio4`, `id4_vidrio5`, `modulo`, `pelicula`, `huacal`, `ancho_temp`, `alto_temp`, `valor_temp`, `id_dolar`, `p_act_sp`, `p_act_cp`, `aprobado_por`, `servicio`, `estado_item`, `aprobado_por_user`, `fecha_aprobada`, `iva`, `ajuste`, `msg`, `msg2`, `peso_producto`, `valor_adicional`, `adicional_per`, `rollo`, `descripcion_rollo`, `cont_item`, `cantlam`, `poli`, `poli_v`, `poli_h`, `verpoli`, `rieles`, `alfajia`, `rejillas`, `cierres`, `rodajas`, `bisagras`, `can_rieles`, `can_alfajia`, `can_rejillas`, `can_cierres`, `can_rodajas`, `can_bisagras`, `poralu`, `porvid`, `poracc`, `porace`, `id_compuesto`, `compuestos`) select  `imagen`, '$maxcot', `id_referencia`, `laminas`, `laminas2`, `laminas3`, `laminas4`, `id_vidrio`, `id_vidrio2`, `id_vidrio3`, `id_vidrio4`, `id_vidrio5`, `id_vidrio6`, `cierre`, `ancho_c`, `ancho_c_original`, `alto_c`, `ancho_abajo`, `hojas`, `cuerpo`, `lado`, `cantidad_c`, `cantidad_temp`, `cant_restante`, `valor_c`, `valor_c_sp`, `valor_fom`, `valor_costob`, `valor_fomp`, `id_cliente`, `tipo_c`, `fecha_c`, `estado_c`, `registrado_por_c`, `aprobado`, `num_pedido`, `orden`, `asignado_a`, `linea_cot`, `cod_traz`, `boq`, `per`, `porcentaje`, `porcentaje_mp`, `descuento_g`, `color_ta`, `precio_item`, `precio_adicional`, `precio_material`, `precio_fom_sp`, `observaciones`, `observaciones2`, `desc`, `verticales`, `horizontales`, `d1`, `duracion`, `install`, `traz_vid`, `traz_vid2`, `traz_vid3`, `traz_vid4`, `ubicacion_c`, `tip`, `imagen_mas`, `an`, `al`, `fila`, `id2_vidrio`, `id2_vidrio2`, `id2_vidrio3`, `id2_vidrio4`, `id2_vidrio5`, `id3_vidrio`, `id3_vidrio2`, `id3_vidrio3`, `id3_vidrio4`, `id3_vidrio5`, `id4_vidrio`, `id4_vidrio2`, `id4_vidrio3`, `id4_vidrio4`, `id4_vidrio5`, `modulo`, `pelicula`, `huacal`, `ancho_temp`, `alto_temp`, `valor_temp`, `id_dolar`, `p_act_sp`, `p_act_cp`, `aprobado_por`, `servicio`, `estado_item`, `aprobado_por_user`, `fecha_aprobada`, `iva`, `ajuste`, `msg`, `msg2`, `peso_producto`, `valor_adicional`, `adicional_per`, `rollo`, `descripcion_rollo`, `cont_item`, `cantlam`, `poli`, `poli_v`, `poli_h`, `verpoli`, `rieles`, `alfajia`, `rejillas`, `cierres`, `rodajas`, `bisagras`, `can_rieles`, `can_alfajia`, `can_rejillas`, `can_cierres`, `can_rodajas`, `can_bisagras`, `poralu`, `porvid`, `poracc`, `porace`, '$maxcot', `compuestos` from cotizaciones where id_compuesto='".$_GET['copy']."' ");
 ...
 if(isset($_GET['ok'])){ 
     ...
     $result = mysqli_query($conexion,"select ultimo_estado from cotizacion where id_cot=".$_GET['cot']." ");
                 ...
                 if($cq['ultimo_estado']==''){
                     ...
                     $sql = "UPDATE `cotizacion` SET `estado` = '$estado_u', `fecha_guardado` = '".$fecha_hoy."' WHERE `id_cot` = ".$_GET['cot']."";
                      mysqli_query($conexion,$sql);
                      mysqli_query($conexion,"INSERT INTO `modificaciones` (`id_m`, `descripcion`, `por`, `modulo`, `id_cotizacion`,registro)"
            . " VALUES (NULL, 'Cotizacion guardada por ".$_SESSION['k_username']." ultimo estado $estado_u ', '".$_SESSION['k_username']."', 'Cotizacion', '".$_GET['cot']."','$fecha_hoy')");
