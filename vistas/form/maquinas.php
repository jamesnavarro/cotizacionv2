												...
												<div class="body-inner no-padding">
													<?php
														...
														<?php
																...
																$request = mysqli_query($conexion,"SELECT * FROM subproceso_maq WHERE id_subproceso = " . $_GET['cod'] . " ");
																if ($request) {
																	//echo'<hr>';
																	...
																	while ($row = mysqli_fetch_array($request)) {
																		...
																		$query_select_grupo = mysqli_query($conexion,"SELECT * FROM grupo WHERE id_g = '" . $row['id_g'] . "'");
																		$row_grupo = mysqli_fetch_array($query_select_grupo);
