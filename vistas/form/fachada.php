...
$request_ac=mysqli_query($conexion,"SELECT * FROM item_fachada a, referencias b where a.id_ref=b.id_referencia and id_producto=".$_GET['cod']);
...
$request_ac=mysqli_query($conexion,"SELECT * FROM item_fachada_rep a, referencias b  where b.id_referencia=a.id_referencia and a.id_ver=".$_GET['ver']);
...
$request_ac=mysqli_query($conexion,"SELECT * FROM item_fachada_vid a, tipo_vidrio b  where b.id_vidrio=a.id_referencia and a.id_ver=".$_GET['ver']);
