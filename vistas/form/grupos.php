<?php 
if(isset($_GET['cod'])){
    $query = mysqli_query($conexion,"SELECT * FROM subproceso a, grupo b, pagos c where b.id_pago=c.id_pago and a.id_subpro=b.id_area and b.id_g=".$_GET['cod']." ");
...
$request_ac=mysqli_query($conexion,"SELECT * FROM subproceso a, grupo b, pagos c where b.id_pago=c.id_pago and a.id_subpro=b.id_area ");
