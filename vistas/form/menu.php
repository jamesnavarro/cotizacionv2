            ...
            $responsable= $fila21["responsable"];
             $tel_responsable= $fila21["tel_responsable"];
              ...
              if($fila21["precio"]==''){$precio = 'p3';}else{$precio= $fila21["precio"]; }
                                            ...
                                            $fi2 =mysql_fetch_array(mysql_query($s2));
              $multiplicador= $fi2["p"]/100;
              }else{
                  $precio= $fila21["precio"];
                $multiplicador= 1;  
              }                    
$request=mysql_query("SELECT * FROM producto a, clientes b, cotizaciones c, tipo_vidrio d where d.id_vidrio=c.id_vidrio and c.id_cliente=b.id_cli and c.id_referencia=a.id_p and c.id_cot=".$_GET["cot"]);  
