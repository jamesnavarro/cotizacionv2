...
$sqle = "UPDATE `item_fachada_c1` SET `cantidad_1` = '".$_POST['cant2']."' WHERE `id_c1` = ".$_GET["add2"]."  and id_cot=".$_GET['cot'].";";
                 mysqli_query($conexion,$sqle);
                 $request_ac1=mysqli_query($conexion,"SELECT * FROM item_fachada_rep a, referencias b, item_fachada_c1 c  where c.id_c1=a.id_fr and  b.id_referencia=a.id_referencia and a.id_ver=".$_GET['ver']."  and c.id_cot=".$_GET['cot']."");   

        $t1 =0;
	while($row=mysqli_fetch_array($request_ac1))
	{      
        ...
        $request_ac2=mysqli_query($conexion,"SELECT * FROM item_fachada_vid a, tipo_vidrio b, item_fachada_c2 c  where a.id_fr=c.id_c1 and b.id_vidrio=a.id_referencia and a.id_ver=".$_GET['ver']."  and c.id_cot=".$_GET['cot']."");
        $t2=0;
	while($row=mysqli_fetch_array($request_ac2))
	{    
