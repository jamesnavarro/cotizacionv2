...
echo '<tr>';
echo "<td><h5>Valor de Venta Unitario: $<font color='red'>".number_format($_GET['unidad']).'<h5>';
echo "<td><h5>Valor de Venta Total : $<font color='red'>".number_format($_GET['unidad'] * $_GET['cant']).'<h5>';
echo "<td>";
echo "<td><h5>Valor de Venta Unitario Bogota : $<font color='blue'>".number_format($precio_venta_fom_con_p).'<h5>';
echo '<tr>';
echo "<td><h5>Incremento/Descuento x Und. ".$fi["desc"]."% $<font color='red'>".number_format($_GET['descuento']).'<h5>';
echo "<td><h5>Incremento/Descuento Total ".$fi["desc"]."% $<font color='red'>".number_format($_GET['descuento']*$_GET['cant']).'<h5>';
echo "<td>";
echo "<td><h5>Valor de Venta Total Bogota : $<font color='blue'>".($precio_venta_fom_con_p*$_GET['cant']).'<h5>';

echo '<tr>';
echo "<td><h5>Neto Total Und $<font color='red'>".number_format($_GET['unidad']+$_GET['descuento']).'<h5>';
echo "<td><h5>Neto Total $<font color='red'>".number_format(($_GET['unidad']+$_GET['descuento'])*$_GET['cant']).'<h5>';
echo "<td>";
echo "<td>";
...
echo '<tr>';
echo "<td><h5>Gran Total Und. $<font color='red'>".number_format($_GET['unidad']+$_GET['descuento']).'<h5>';
echo "<td><h5>Gran Total$<font color='red'>".number_format(($_GET['unidad']+$_GET['descuento'])*$_GET['cant']).'<h5>';
echo "<td>";
