...
$request_ac=mysqli_query($conexion,"SELECT * FROM subproceso a, asignacion_grupo b, grupo c where c.id_g=b.id_g and a.id_subpro=b.id_area and b.id_area=".$_GET['cod']." ");
