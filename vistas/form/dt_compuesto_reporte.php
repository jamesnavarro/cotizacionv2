...
if($tap!=0){
   $aluminio = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizacion_mas='".$_GET['idcot']."'  and tipo_costo='Aluminio' ");
   $at = mysql_fetch_row($aluminio);
   if($at[0]==0){
//       $tap = $tap * $_GET['cant_principal'];
      $ver =  mysql_query("insert into costo_totales (id_cot,id_cotizaciones,id_cotizacion_mas, tipo_costo,unidad_med,costo_totales,porcentajes, cantidades_totales,peso_totales)"
               . " values ('".$_GET['cot']."','".$_GET['id_cot']."','".$_GET['idcot']."','Aluminio','Ml','$tap','$porca','$contador_alup','$ptt') ") or die(mysql_error());
   }
}
...
if($comp_vid!=0){
 $vidrios = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizacion_mas='".$_GET['idcot']."' and tipo_costo='Vidrio' ");
                       $av = mysql_fetch_row($vidrios);
                       if($av[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones,id_cotizacion_mas, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('$nombre_vidrio','".$_GET['cot']."','".$_GET['id_cot']."','".$_GET['idcot']."','Vidrio','M2', '$metro_cuadrado' ,'$comp_vid','$porcv','".$_GET['cant']."','$peso_vid') ") or die(mysql_error());
                       }
}
...
if($xx_p!=0){
   $aluminior = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizacion_mas='".$_GET['idcot']."' and tipo_costo='Rejillas' ");
   $atr = mysql_fetch_row($aluminior);
   if($atr[0]==0){
      $ver =  mysql_query("insert into costo_totales (id_cot,id_cotizaciones,id_cotizacion_mas, tipo_costo,unidad_med,costo_totales,porcentajes, cantidades_totales,peso_totales)"
               . " values ('".$_GET['cot']."','".$_GET['id_cot']."','".$_GET['idcot']."','Rejillas','Ml','$xx_p','$porca','1','$peso_rej') ") or die(mysql_error());
   }
}
...
if($tac_p!=0){
$accesorios = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizacion_mas='".$_GET['idcot']."' and tipo_costo='Accesorios' ");
                       $aa = mysql_fetch_row($accesorios);
                       if($aa[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones,id_cotizacion_mas, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('$nombre_accesorios','".$_GET['cot']."','".$_GET['id_cot']."','".$_GET['idcot']."','Accesorios','Und', '0' ,'".($tac_p*$_GET['cant_principal'])."','$porcacc','".$caccc."','0') ") or die(mysql_error());
                       }
}
?>
                        <!--/ END Datatable 2 -->
...
if($fabc!=0 || $insc!=0){
 $fabricacion = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizacion_mas='".$_GET['idcot']."' and tipo_costo='Fabricacion' ");
                       $aa1 = mysql_fetch_row($fabricacion);
                       if($aa1[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones,id_cotizacion_mas, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('','".$_GET['cot']."','".$_GET['id_cot']."','".$_GET['idcot']."','Fabricacion','Und', '0' ,'".($fabc*$_GET['cant_principal'])."','0','".$_GET['cant']."','0') ") or die(mysql_error());
                       }
                       $instalacion = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizacion_mas='".$_GET['idcot']."' and tipo_costo='Instalacion' ");
                       $aa2 = mysql_fetch_row($instalacion);
                       if($aa2[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones,id_cotizacion_mas, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('','".$_GET['cot']."','".$_GET['id_cot']."','".$_GET['idcot']."','Instalacion','Und', '0' ,'".($insc*$_GET['cant_principal'])."','0','".$_GET['cant']."','0') ") or die(mysql_error());
                       }
                       $polimax = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizacion_mas='".$_GET['idcot']."' and tipo_costo='Polimask' ");
                       $aa3 = mysql_fetch_row($polimax);
                       if($aa3[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones,id_cotizacion_mas, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('','".$_GET['cot']."','".$_GET['id_cot']."','".$_GET['idcot']."','Polimask','Und', '0' ,'".($poli*$_GET['cant_principal'])."','0','".$_GET['cant']."','0') ") or die(mysql_error());
                       }
}
?>
                        <!--/ END Datatable 2 -->
