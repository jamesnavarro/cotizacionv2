...
if(isset($_GET['aprobar'])){
    if($_GET['aprobar']==0){
         ...
         $que = mysql_query("INSERT INTO `modificaciones` (`id_m`, `descripcion`, `por`, `modulo`, `id_cotizacion`) VALUES (NULL, 'Se aprobo el producto','".$_SESSION['k_username']."','Productos','".$_GET["cod"]."') ");

    }else{
         $sql = "UPDATE `producto` SET `aprobado`='0' WHERE `id_p` = ".$_GET["cod"].";";
         $que = mysql_query("INSERT INTO `modificaciones` (`id_m`, `descripcion`, `por`, `modulo`, `id_cotizacion`) VALUES (NULL, 'Se Desaprobo el producto','".$_SESSION['k_username']."','Productos','".$_GET["cod"]."') ");
    }
...
<table class="table table-bordered table-striped table-hover">
    ...
    <tr>
        ...
        <td>
            ...
            if($_SESSION['k_username']=='admin'){
                ...
                if($rev==0){
                    echo ' | <a href="../vistas/?id=add_cot&cod='.$_GET['cod'].'&revisar='.$rev.'"><button type="button"><img src="../imagenes/stop.png"> DT SIN ACTUALIZAR</button></a>';
                }else{
                    echo ' | <a href="../vistas/?id=add_cot&cod='.$_GET['cod'].'&revisar='.$rev.'"><button type="button"><img src="../imagenes/ok.png"> DT ACTUALIZADA </button></a>';
                }
                if($des==0){
                     echo ' | <a href="../vistas/?id=add_cot&cod='.$_GET['cod'].'&actu='.$des.'"><button type="button"><img src="../imagenes/stop.png"> Sin Desglose</button></a>';
                }else{
                    echo ' | <a href="../vistas/?id=add_cot&cod='.$_GET['cod'].'&actu='.$des.'"><button type="button"><img src="../imagenes/ok.png"> Desglose Actualizado </button></a>';
                }
                }ELSE{
                    if($aprobado==0){
    ...
    <tr>
        ...
        <td>Ancho</td>
        <td>
            <input type="text" name="ancho"  id="ancho"  value="<?php if(isset($_GET['cod'])){echo $ancho;}else{echo "1000";} ?>"  placeholder=" " required class="span6"> (mm)
        </td>
    </tr>
<tr>
...
<td>Alto</td>
<td><input type="text" name="alto" id="alto" value="<?php if(isset($_GET['cod'])){echo $alto;}else{echo "1000";} ?>"  placeholder=" " required class="span6"> (mm)</td>
</tr>
<tr>
    <td>Referencia</td>
...
<tr>
    ...
    <td>Alto Maximo</td>
    <td> <input type="text" name="alto_maximo"  style="width:20%;"  value="<?php if(isset($_GET['cod'])){echo $alto_maximno;} ?>" ></td>
<?php  } ?>
</tr>
            ...
            echo"<option value='".$row['id_ref_vid']."'>(".$tv." mm) ".$row['descripcion']."</option>";
                                              ...
                                              <?php if(isset($_GET['up_1'])){echo '<option value="'.$m.'">'.$m.'</option>';}  ?>
                                                ...
                                                <select name="signo" style="width: 40px;">
                                                  ...
                                                  <label></label>
                                                  <div class="controls"> Digite la formula: por Ej: (Ancho + 7) / 2</div>
...
$request=mysql_query("SELECT * FROM producto a, producto_rep_alu b, referencias c where b.id_ref_alum=c.id_referencia and a.id_p=b.id_p and a.id_p=".$_GET['cod']." order by b.lado, b.id_r_a");
               ...
               if($row['signo']=='-'){
                ...
                if($row['medida_r_a']==1){
                    ...
                    if($row['medida_r_a']>4)
                        ...
                        //codigo-------------------------------
                           require '../modelo/conexion.php';
                         $request_v2=mysql_query("SELECT * FROM producto a, producto_rep_vid b, referencias c where b.id_ref_vid=".$row['medida_r_a']." and b.id_ref_vid=c.id_referencia and a.id_p=b.id_p and a.id_p=".$_GET['cod']);
    
     
if($request_v2){

        $total2=0;
	while($rowx=mysql_fetch_array($request_v2))
	{      
           ...
           $formula = '('.$x.''.$s.''.$row["descuento"].')'.$row["signo"].''.$row["variable"];
            $table = $table.'<tr><td width="10%">'.$row['codigo'].'</a></td><td width="40%" '.$st.'>'.$row['descripcion'].'</a></td><td width="10%">'.$row['referencia'].'</font></td><td width="10%">'.$row['lado'].'</a></td><td width="10%">'.$row["medida"].' mm<font></a></td>
               <td class="hidden-phone">'.  number_format($numero,1,',','.').'</font></td><td width="10%">'.$row["cantidad"].'<font></a></td><td width="20%">'.number_format($al).' mm<font></a></td>
                   <td class="hidden-phone">'.$row["cantidad"].'</font></td><td class="hidden-phone" >$'.number_format($al*$row["costo_mt"]/$n).'</font></td>'
                    ...
                    . '<td><a href="../vistas/?id=add_cot&cod='.$_GET['cod'].'&del_1='.$row["id_r_a"].'&pr='.$row['descripcion'].'"><button>Eliminar</button></a></td></tr>';   
 ...
 ?>
	...
	{      
            ...
            echo"<option value='".$row['id_ref_vid']."'>(".$tv." mm) ".$row['descripcion']."</option>";
                                       ...
                                       <tr>
                                            <th>Observaciones</th>
                                            <td><textarea name="obs_a" id="obs_a" style="width:100%"><?php if(isset($_GET['up_serv'])){ echo ($obs_a); } ?></textarea></td>
                                        </tr>
                                            </table> 
...
$cantidad_v= $fil["cantidad_v"];
  $si= $fil["utilizar"];$cp= $fil["cp"];$ddesc= $fil["desc"];$pertenece= $fil["pertenece"];
            ...
            $fil_al =mysql_fetch_array(mysql_query($sqlxa));
            ...
            $fil_al2 =mysql_fetch_array(mysql_query($sqlxa2));
...
//            echo $row["ancho_v2"]. 'x'. $row["alto_v2"].'<br>';
            ...
            $table = $table.'<tr><td width="10%">'.$al2. ' '.$tv2 .' '. $nx .' '. $cf .' '. $dess.'</a></td>'
                    ...
                    . '<td>  <a href="../vistas/?id=add_cot&cod='.$_GET['cod'].'&del_2='.$row["id_r_v"].'&vr='.$row['descripcion'].'"><button><img src="../imagenes/eliminar.png"></button></a></font></td></tr>';   
                            ...
                            <div class="tabbable" style="margin-bottom: 25px;">
                                <ul class="nav nav-tabs">
                                    <div style="float: right">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalRejillas" onclick="LimpiarRejilla()">Agregar Rejilla</button>
                                </div>
                                </ul>
                                <div class="tab-content">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <table>
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        <select name="perfil_med" id="perfil_med"  style="width: 80px;" required>
                                               <?php
            ...
            $formato = number_format($numero,1,',','.');
                        ...
                        / <input type="number" name="var3" id="var3" value="1" style="width: 80px;">
                                        * <input type="number" name="multiplo"  id="multiplo" value="1" style="width: 80px;"></td>
                             
                                    </tr>
                                    <tr>
                                        <td>Medida del perfil (mm)</td>
                                        <td>
                                            <select name="med_rej" id="med_rej" style="width: 120px;">
...
?>
                        ...
                        <input type="number" name="varr" id="varr" value="" style="width: 40px;"> /
                        <input type="number" name="en" id="en" value="1" style="width: 40px;"></td>
                 </tr>
              </table>
      </div>
...
$request_v=mysql_query("SELECT * FROM producto a, producto_rep_rej b, referencias c where b.id_referencia=c.id_referencia and a.id_p=b.id_p and a.id_p=".$_GET['cod']);
...
//    echo'<hr>';
	...
	{      
      ...
      $request_vrej=mysql_query("SELECT * FROM producto a, producto_rep_vid b, referencias c where b.id_ref_vid=c.id_referencia and a.id_p=b.id_p and a.id_p=".$_GET['cod']." and b.id_r_v=".$row["medida_rej"]." ");
                        ...
                        <div class="span12 widget dark stacked">
                            ...
                            <div class="tabbable" style="margin-bottom: 25px;">
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active"><a href="#tab3x" data-toggle="tab"><span class="icon icone-eye-open"></span>Accesorios</a></li>

                                    <li class=""><a href="#tab4x" data-toggle="tab"><span class="icon icone-pencil"></span> Agregar Accesorio</a></li>
...
$rejilla = mysql_query("SELECT * FROM producto a, producto_rep_rej b, referencias c where b.id_referencia=c.id_referencia and a.id_p=b.id_p and a.id_p=".$_GET['cod']." and b.id_r_rej=".$cj." ");
$cd = mysql_fetch_array($rejilla);
                                                      ...
                                                      <td><?php if($grupo=='Perfileria'){ echo 'Medida=<input type="number" name="med" value="'.$med.'" class="span3" placeholder=" " required> Valor de Fabricacion=<input type="number" name="valor" value="'.$valor.'" class="span3" placeholder=" " required>'; }else{echo 'Medida=<input type="hidden" name="med" value="1" class="span6" placeholder=" " required><input type="hidden" name="valor" value="1" class="span3" placeholder=" " required>'; } ?></td>
                                                       <td><select name="can_rej" class="span4" required>
                                                                   ...
                                                                   if($des_rej==''){echo ' <option value="0">1</option>';}else{echo ' <option value="'.$cj.'">'.$des_rej.'</option>';}
                                                                       ...
                                                                       require '../modelo/conexion.php';
                                                           $request_v2=mysql_query("SELECT * FROM producto a, producto_rep_rej b, referencias c where b.id_referencia=c.id_referencia and a.id_p=b.id_p and a.id_p=".$_GET['cod']);
                                                            while($row=mysql_fetch_array($request_v2))
                                                            {
...
$request_ac=mysql_query("SELECT * FROM producto a, producto_rep_acc b, referencias c where b.id_ref_acc=c.id_referencia and a.id_p=b.id_p and a.id_p=".$_GET['cod']." order by b.para ");
...
//    echo'<hr>';
	...
	{     
            ///----------------------------------------
            if($row['can_rej']!=0){
    $request_v2=mysql_query("SELECT * FROM producto a, producto_rep_rej b, referencias c where b.id_referencia=c.id_referencia and a.id_p=b.id_p and a.id_p=".$_GET['cod']." and b.id_r_rej=".$row['can_rej']." ");
...
$request_ac=mysql_query("SELECT * FROM producto a, producto_rep_ma b, referencia_ma c where b.id_ref_ma=c.id_ref_ma and a.id_p=b.id_p and a.id_p=".$_GET['cod']);
...
$request_ac=mysql_query("SELECT * FROM producto a, producto_rep_mo b, referencia_mo c where b.id_ref_mo=c.id_ref_mo and a.id_p=b.id_p and a.id_p=".$_GET['cod']);
...
$request_ac=mysql_query("SELECT * FROM producto a, producto_rep_ad b, referencia_admin c where b.id_ref_ad=c.id_ref_ad and a.id_p=b.id_p and a.id_p=".$_GET['cod']);
...
$request_ac=mysql_query("SELECT * FROM producto a, producto_rep_otro b, referencia_otro c where b.id_ref_ot=c.id_ref_ot and a.id_p=b.id_p and a.id_p=".$_GET['cod']);
...
$que = mysql_query("INSERT INTO `modificaciones` (`id_m`, `descripcion`, `por`, `modulo`, `id_cotizacion`) VALUES (NULL, 'Se elimino el perfil ".$_GET['pr']."  ','".$_SESSION['k_username']."','Productos','".$_GET["cod"]."') ");
...
mysql_query($sql, $conexion);
$que = mysql_query("INSERT INTO `modificaciones` (`id_m`, `descripcion`, `por`, `modulo`, `id_cotizacion`) VALUES (NULL, 'Se elimino el vidrio ".$_GET['vr']."  ','".$_SESSION['k_username']."','Productos','".$_GET["cod"]."') ");
