<?php
 ...
 $reques2=mysqli_query($conexion,"SELECT * FROM producto a, cotizaciones c, producto_rep_alu b, referencias d where b.id_ref_alum=d.id_referencia and a.id_p=b.id_p and c.id_referencia=a.id_p and c.id_cot=".$_GET["cot"]." and d.id_referencia=".$row["id_referencia"]." ");
$total2=0;
        $tacot =0;
        $cont =0; $ta2 =0;$ptt =0;
        $med_t = 0;
        $cant_t = 0;
          $ccc = 0;
	while($rower=mysqli_fetch_array($reques2))
	{            
