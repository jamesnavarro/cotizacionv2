<?php
$reques27=mysql_query("SELECT * FROM producto a, producto_rep_acc b, referencias c where b.id_ref_acc=c.id_referencia and a.id_p=b.id_p and a.id_p=".$rowd["id_p"]." and c.id_referencia=".$row['ref']." ");
 ...
 // fin codigo	
	...
	//Por cada resultado pintamos una linea
            ...
            //--------------------------------------------------------------------
                        if($rowacc['can_rej']!=0){
    $request_v2=mysql_query("SELECT * FROM producto a, producto_rep_rej b, referencias c where b.id_referencia=c.id_referencia and a.id_p=b.id_p and a.id_p=".$rowd["id_p"]." and b.id_r_rej=".$rowacc['can_rej']." ");
