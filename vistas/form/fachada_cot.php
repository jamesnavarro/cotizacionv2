...
$request_ac=mysqli_query($conexion,"SELECT * FROM item_fachada a, referencias b, item_fachada_c c where c.id_fac=a.id_f and a.id_ref=b.id_referencia and id_producto=".$_GET['ref']." and id_cot=".$_GET['cot']."");
...
$request_ac=mysqli_query($conexion,"SELECT * FROM item_fachada_rep a, referencias b, item_fachada_c1 c  where c.id_c1=a.id_fr and  b.id_referencia=a.id_referencia and a.id_ver=".$_GET['ver']."  and id_cot=".$_GET['cot']."");
...
$request_ac=mysqli_query($conexion,"SELECT * FROM item_fachada_vid a, tipo_vidrio b, item_fachada_c2 c  where a.id_fr=c.id_c1 and b.id_vidrio=a.id_referencia and a.id_ver=".$_GET['ver']."  and id_cot=".$_GET['cot']."");
