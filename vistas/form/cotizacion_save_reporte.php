...
mysql_query("DELETE FROM `costo_totales` WHERE `id_cotizaciones` = '".$_GET['idcot']."'");
echo '<b>Costo Total de aluminio '.number_format($vr2).' </b>';
if($vr2!=0){
   $aluminio = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['idcot']."' and tipo_costo='Aluminio' and id_cotizacion_mas=0 ");
   ...
   if($at[0]==0){
      $ver =  mysql_query("insert into costo_totales (id_cot,id_cotizaciones, tipo_costo,unidad_med,costo_totales,porcentajes, cantidades_totales,peso_totales)"
               . " values ('".$_GET['cot']."','".$_GET['idcot']."','Aluminio','Ml','$vr2','$porca','$contador_alu','$ptt') ") or die(mysql_error());
   }
...
//                   echo $m2;
       ...
       $rt = $total_vid * $porcv; 
        if($total_vidsp!=0){
                $vidrios = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['idcot']."' and tipo_costo='Vidrio' and id_cotizacion_mas=0 ");
                       $av = mysql_fetch_row($vidrios);
                       if($av[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('$nombre_vidrio','".$_GET['cot']."','".$_GET['idcot']."','Vidrio','M2', '$metro_cuadrado' ,'".($rt)."','$porc','".$_GET['cant']."','$peso_vid') ") or die(mysql_error());
                       }
...
if($xx_p!=0){
   $aluminior = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['idcot']."' and tipo_costo='Rejillas' and id_cotizacion_mas=0 ");
   $atr = mysql_fetch_row($aluminior);
   if($atr[0]==0){
      $ver =  mysql_query("insert into costo_totales (id_cot,id_cotizaciones, tipo_costo,unidad_med,costo_totales,porcentajes, cantidades_totales,peso_totales)"
               . " values ('".$_GET['cot']."','".$_GET['idcot']."','Rejillas','Ml','$xx_p','$porca','1','$peso_rej') ") or die(mysql_error());
   }
...
number_format($tac_p = $tac * $porcacc);
        ...
        $tac_p = $tac * $porcacc;
        if($tac_p!=0){
                  $accesorios = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['idcot']."' and tipo_costo='Accesorios' and id_cotizacion_mas=0 ");
                       $aa = mysql_fetch_row($accesorios);
                       if($aa[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('$nombre_accesorios','".$_GET['cot']."','".$_GET['idcot']."','Accesorios','Und', '0' ,'$tac_p','$porcacc','".$cacc."','0') ") or die(mysql_error());
                       }
...
if($and!=0){
     $andamios = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['idcot']."' and tipo_costo='Andamios' and id_cotizacion_mas=0 ");
                       $aa1 = mysql_fetch_row($andamios);
                       if($aa1[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('','".$_GET['cot']."','".$_GET['idcot']."','Andamios','Und', '0' ,'$and','0','".$_GET['cant']."','0') ") or die(mysql_error());
                       }
}
 ?>
                                </div>
...
if($fab!=0 || $ins!=0){
                       $fabricacion = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['idcot']."' and tipo_costo='Fabricacion' and id_cotizacion_mas=0 ");
                       $aa1 = mysql_fetch_row($fabricacion);
                       if($aa1[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('','".$_GET['cot']."','".$_GET['idcot']."','Fabricacion','Und', '0' ,'$fab','0','".$_GET['cant']."','0') ") or die(mysql_error());
                       }
                       $instalacion = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['idcot']."' and tipo_costo='Instalacion' and id_cotizacion_mas=0 ");
                       $aa2 = mysql_fetch_row($instalacion);
                       if($aa2[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('','".$_GET['cot']."','".$_GET['idcot']."','Instalacion','Und', '0' ,'$ins','0','".$_GET['cant']."','0') ") or die(mysql_error());
                       }
                       $polim = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['idcot']."' and tipo_costo='Polimask' and id_cotizacion_mas=0 ");
                       $aa3 = mysql_fetch_row($polim);
                       if($aa3[0]==0){
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('','".$_GET['cot']."','".$_GET['idcot']."','Polimask','Und', '0' ,'$polip','0','".$_GET['cant']."','0') ") or die(mysql_error());
                       }
}
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span12 widget lime">
                            ...
                            <section class="body">
                                ...
                                <div class="body-inner no-padding">
                                           <?php 
   $request2=mysql_query("SELECT * FROM referencia_mo a, cotizaciones_servicios b where a.id_ref_mo=b.id_servicio and b.id_cotizacion=".$_GET['cot']." and b.id_cot_mas=".$_GET['idcot']." ");
...
if($to_serv!=0){
    $tx = $to_serv *$_GET['cant'];
                          ...
                          $ver =  mysql_query("insert into costo_totales (vidrios,id_cot,id_cotizaciones, tipo_costo,unidad_med,medidas_totales,costo_totales,porcentajes, cantidades_totales,peso_totales)"
                                   . " values ('','".$_GET['cot']."','".$_GET['idcot']."','Instalacion','Und', '0' ,'$tx','0','".$_GET['cant']."','0') ") or die(mysql_error());
                       }
...
if($cb!=0){
   $aluminio = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['de']."' and tipo_costo='Adicional' and id_cotizacion_mas=0 ");
   $at = mysql_fetch_row($aluminio);
   echo $at[0].'<br>'.$_GET['de'].'<br>';
   if($at[0]==0){
      $ver =  mysql_query("insert into costo_totales (id_cot,id_cotizaciones, tipo_costo,unidad_med,costo_totales,porcentajes, cantidades_totales,peso_totales)"
               . " values ('".$_GET['cot']."','".$_GET['de']."','Adicional','Und','".($cb*$_GET['cant_principal'])."','$mult','$t','0') ") or die(mysql_error());
   echo $ver;
...
if($ksp!=0){
   $aluminio = mysql_query("select count(id_cot) from costo_totales where id_cot='".$_GET['cot']."' and id_cotizaciones='".$_GET['de']."' and tipo_costo='Kits' and id_cotizacion_mas=0 ");
   $at = mysql_fetch_row($aluminio);
   if($at[0]==0){
      $ver =  mysql_query("insert into costo_totales (id_cot,id_cotizaciones, tipo_costo,unidad_med,costo_totales,porcentajes, cantidades_totales,peso_totales)"
               . " values ('".$_GET['cot']."','".$_GET['de']."','Kits','Und','".($ksp*$_GET['cant_principal'])."','$porcacck','".($t2e*$_GET['cant_principal'])."','0') ") or die(mysql_error());
   }
...
//$fiaV =mysql_fetch_array(mysql_query($alum_por1V));
