                                             ...
                                             <td id="vidrios"> 
                                                   <?php if(isset($_GET['up_a'])){
                                                       if($traz_vid==0){
                                                        ...
                                                        $res3=  mysqli_query($conexion,$con3);
                                                        ...
                                                        $res4=  mysqli_query($conexion,$con4);
                                                         while($f4=  mysqli_fetch_array($res4)){
                                                        $idco4=$f4['id_p'];
                                                        $nombre4=$f4['producto'];
...
//                                                        $res=  mysqli_query($conexion,$con2);
//                                                         while($f=  mysqli_fetch_array($res)){
//                                                        $idco=$f['id_p'];
//                                                        $nombre1=$f['producto'];
...
//            $request=mysqli_query($conexion,"SELECT * FROM producto a,  cotizaciones_sub c, tipo_vidrio d where d.id_vidrio=c.id_vidrio_sub  and c.id_referencia_sub=a.id_p and c.id_cot_sub=".$_GET["cot"]." and c.id_producto_cot=".$_GET['mas']."");
//     
//if($request){
//        $ta2 =0;
//        $cont =0;
