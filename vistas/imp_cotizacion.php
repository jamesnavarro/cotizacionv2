        ...
        <body onload="">
            ...
            function tabla() {
                ...
                if ($request) {
                    ...
                    if ($fila3['orden'] == '0') {
                        $abc = 'COT. No. : ';
                        $num = $fila3['numero_cotizacion'] . '- V.' . $fila3['version'].$tec;
                    } else {
                        $abc = 'PED No. :';
                ...
                ?>         
            <table class="estilo1" border="0"  cellpadding="0" cellspacing="0" style="width:100%">
                    <tr>
                        <td rowspan="9"  style="margin: 15px;padding: 15px;color:white" width="30%">
...
//                  echo '<fieldset style="height:670px;">';
					...
					$table3 = $table3 .'<tr BGCOLOR="#13173B">';
                                        $table3 = $table3 .'<th width="2%" style="font-size:14px; color:white">' . '#'.'</h6></th>';
					$table3 = $table3 .'<th width="4%" style="font-size:14px; color:white">' . 'TIPO'.'</h6></th>';
					$table3 = $table3 .'<th width="300px" style="font-size:14px; color:white">' . 'DESCRIPCION' . '</th>';
					
					$table3 = $table3 .'<th width="10%" style="font-size:14px; color:white">' . 'VIDRIO' . '</th>';
					$table3 = $table3 .'<th  width="8%" style="font-size:14px; color:white">' . 'ANCHO X ALTO' . '</th>';
				$table3 = $table3 .'<th  width="25%" style="font-size:14px; color:white">' . 'DISEÑO.' . '</th>';
				
					$table3 = $table3 .'<th  width="3%" style="font-size:14px; color:white">' . 'UND.' . '</th>';
					$table3 = $table3 .'<th  width="7%" style="font-size:14px; color:white">' . 'VLR. UND.' . '</th>';
					$table3 = $table3 .'<th  width="8%" style="font-size:14px; color:white">' . 'V. TOTAL' . '</th>';
					$table3 = $table3 . '</tr>';
					$table3 = $table3 . '</thead>';
                } else {
                    $table3 = '<table   border="1"  class="estilo2" width="100%">';
...
if($row['msg']!=''){$noti='<br><b> <font color="red">'.$row['msg'].' </b>';}else{$noti='';}
    ...
    $table3 = $table3.'<tr>'
                    . '<td width="2%" style="font-size:14px"><p align="center">'.$tc.'</p></td>'
            . '<td width="4%"  height="8" style="font-size:14px"><p align="center">'.$row['tip'].'</p></td>          
                       <td width="400px" style="font-size:14px"><p align="justify">  '.strtoupper($row['producto']).' '.$esp.' '.strtoupper($obs).' '.strtoupper($v).' '.strtoupper($peli).'  '.strtoupper($d1).'  '.strtoupper($obs2).'  '.$noti.''.$noti2.'<br>'.$row["descripcion_rollo"].''.$poli.' '.$referencia.'</p></td>
                       '
                    . '<td width="10%" style="font-size:14px"><p align="center">'.$vi.'<br><br>'.$vi2.'</p></td>             
                       <td  width="8%" style="font-size:14px"><p align="center">'.$med.'</p></td>'
                        . '<td  width="26%"><p align="center">'.$img.' </p></td>'
                    . '<td  width="3%" style="font-size:14px"><p align="center">'.$row["cantidad_c"].' </p></h6></td>
                       <td  width="7%" style="font-size:14px"><p align="center">$'.number_format($pudt).'</p></td>
                       <td  width="8%" style="font-size:14px"><p align="center">$'.number_format($ptt2).'</p></td></tr></div>';   
           $table3 = $table3.'</table>';
...
//-----------------------------------------servicios-----------------------------------------------
            ...
            if ($csv != 0) {
                ...
                $table2 = $table2 . '<th width="5%" style="font-size:14px; color:white">' . 'ITEMS' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'CODIGO' . '</th>';
                //$table2 = $table2 . '<th width="40%" style="font-size:14px; color:white">' . 'DESCRIPCION DEL SERVICIO' . '</th>';
                $table2 = $table2 . '<th width="40%" style="font-size:14px; color:white">' . 'DESCRIPCIÓN' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'REFERENCIA' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'MEDIDA' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'CANTIDAD' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'VLR. UND.' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'V. TOTAL SERVICIO' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'V. TOTAL ACCESORIOS' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'V. TOTAL' . '</th>';
                $table2 = $table2 . '</tr>';
                $table2 = $table2 . '</thead>';
                ...
                while ($row2 = mysqli_fetch_array($request2)) {
                    ...
                    $table2 = $table2 . '<tr>'
                            . '<td width="5%" style="font-size:14px;"  align="center">' . $total2 . '</td>'
                            . '<td width="10%" style="font-size:14px;"  align="center" >' . $row2['id_ref_mo'] . '</td>'
                            //. '<td width="40%" style="font-size:14px; "  align="center">' . $row2['descripcion_mo'] . '</td>'
                            . '<td width="40%" style="font-size:14px; "  align="center">' . $row2['descripcion_mo'] . '</td>'
                            . '<td width="10%" style="font-size:14px;"   align="center">' . $row2["referencia"] . '</td>'
                            . '<td width="10%" style="font-size:14px;" align="center">N/A</td>'
                            . '<td width="10%" style="font-size:14px; "  align="center">' . $row2["cantidad_serv"] . '</td>'
                            . '<td width="10%" style="font-size:14px;"   align="center">' . number_format(($dd ) / $row2["cantidad_serv"]) . '</td>'
                            . '<td width="10%" style="font-size:14px;"   align="center" >' . number_format(($dd)) . '</td>'
                            . '<td width="10%" style="font-size:14px;"   align="center" >' . number_format(($row2["precio_accesorios"])) . '</td>'
                            . '<td width="10%" style="font-size:14px;"   align="center" >' . number_format(($dd + $row2["precio_accesorios"])) . '</td>'
                            . '</tr>';
                }
                $table2 = $table2 . '</table>';
...
//    echo'<hr>';
                ...
                $table2 = $table2 . '<th width="5%" style="font-size:14px; color:white">' . 'ITEMS' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'CODIGO' . '</th>';
                $table2 = $table2 . '<th width="40%" style="font-size:14px; color:white">' . 'DESCRIPCION DE LOS MATERIALES' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'REFERENCIA' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'MEDIDA' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'CANTIDAD' . '</th>';
                $table2 = $table2 . '<th width="10%" style="font-size:14px; color:white">' . 'VLR UND.' . '</th>';
             ...
             $fipav =mysqli_fetch_array(mysqli_query($conexion,$acc_porv));
             $porcven= $fipav["p"]/100; 
            ...
            $perimetro = $row21["area"]/1000;
             ...
             $totalpintado = ($prt3*$mt) + $valor_acabado;
                    ...
                    $table2 = $table2 . '<tr><td width="5%" style="font-size:14px;" align="center">' . $total2 . '</a></td>'
                            . '<td width="10%" style="font-size:14px;" align="center">' . $row21['codigo'] . '</font></td>'
                            . '<td width="40%" style="font-size:14px;" align="center">' . $row21['descripcion'] . ' ' . $cm . '</font></td>'
                            . '<td width="10%" style="font-size:14px;" align="center">' . $row21["referencia"] . '<font></a></td>'
                            . '<td width="10%" style="font-size:14px;" align="center">' . $row21["med"] . '</td>'
                            . '<td width="10%" style="font-size:14px;" align="center">' . $row21["cantidad_mat"] . '</td>'
                            . '<td width="10%" style="font-size:14px;" align="center">$' . number_format($ddm / $row21["cantidad_mat"]) . '</td>'
                            . '<td width="10%" style="font-size:14px;" align="center">' . number_format($ddm) . '</td>'
                            . '</tr>';
                }
                $table2 = $table2 . '</table>';
                echo 'Suministros<hr>';
...
//    echo'<hr>';
                ...
                $table4 = $table4 . '<th width="5%" style="font-size:14px; color:white">' . 'ITEMS' . '</th>';
                $table4 = $table4 . '<th width="10%" style="font-size:14px; color:white">' . 'CODIGO' . '</th>';
                $table4 = $table4 . '<th width="80%" style="font-size:14px; color:white">' . 'DESCRIPCION DEL KIT' . '</th>';
                $table4 = $table4 . '<th width="10%" style="font-size:14px; color:white">' . 'REFERENCIA' . '</th>';
                $table4 = $table4 . '<th width="10%" style="font-size:14px; color:white">' . 'MEDIDA' . '</th>';
                $table4 = $table4 . '<th width="10%" style="font-size:14px; color:white">' . 'CANTIDAD' . '</th>';
                $table4 = $table4 . '<th width="10%" style="font-size:14px; color:white">' . 'VLR. UND.' . '</th>';
                $table4 = $table4 . '<th width="10%" style="font-size:14px; color:white">' . 'V. TOTAL' . '</th>';
                $table4 = $table4 . '</tr>';
                $table4 = $table4 . '</thead>';
                ...
                while ($row21k = mysqli_fetch_array($request4)) {
                    ...
                    $table4 = $table4 . '<tr><td width="5%" style="font-size:14px;" align="center">' . $t2e . '</a></td>'
                            . '<td  width="10%" style="font-size:14px;" align="center">' . $row21k['codigo'] . '</font></td>'
                            . '<td  width="40%" style="font-size:14px;" align="center">' . $row21k['producto'] . ' ' . $ck . '</font></td>'
                            . '<td width="10%" style="font-size:14px;" align="center">' . $row21k["referencia_p"] . '<font></a></td>
                        <td  width="10%" style="font-size:14px;" align="center">N/A</td>'
                            . '<td width="10%" style="font-size:14px;" align="center">' . $row21k["cantidad_k"] . '</td>'
                            . '<td  width="10%" style="font-size:14px;" align="center">$' . number_format($ddm / $row21k["cantidad_k"]) . '</td>'
                            . '<td width="10%" style="font-size:14px;" align="center">' . number_format($ddm) . '</td>'
                            . '</tr>';
                }
                $table4 = $table4 . '</table>';
