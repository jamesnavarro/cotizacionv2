...
//        include '../vistas/imprimir_reportes_2.php';
    ...
    $fecha2 = $_POST['fecha2'].' 23:00:00';
      ...
      ?>
        ...
        <?php
        if(isset($_POST['fecha'])!=''){
            $ciudad = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo, b.usuario FROM cotizacion a, usuarios b where a.estado='En proceso' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.registrado=b.usuario group by b.usuario order by count(*) desc");
        ...
        $fila=  mysqli_fetch_array($result);
            ...
            $ciudad = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo, b.usuario FROM cotizacion a, usuarios b where  a.estado='En proceso' and a.registrado=b.usuario group by b.usuario order by count(*) desc");
        ...
        if(isset($_POST['fecha'])!=''){
                ...
                $productos = mysqli_query($conexion,"(SELECT count(*), sum(cantidad_c), producto FROM producto a, cotizaciones c, cotizacion b where c.id_cot=b.id_cot and c.id_referencia=a.id_p  and b.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.registrado like '".$_POST['empresa']."%' group by id_p order by sum(cantidad_c) desc)");
        }else{
       ...
       <?php
        if(isset($_POST['fecha'])){
                ...
                $linea = mysqli_query($conexion,"(SELECT count(*), sum(cantidad_c), a.linea FROM producto a, cotizaciones c, cotizacion b where c.id_cot=b.id_cot and c.id_referencia=a.id_p  and b.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.registrado like '".$_POST['empresa']."%' group by a.linea order by sum(cantidad_c) desc)");
        }else{
        ...
        ?>
         ...
         <?php
        if(isset($_POST['fecha'])){
            $por_aprobar = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Pedido por aprobar' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.registrado=b.usuario group by b.usuario order by count(*) desc");
        ...
        $fila=  mysqli_fetch_array($result);
            ...
            $por_aprobar = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Pedido por aprobar' and a.registrado=b.usuario group by b.usuario order by count(*) desc");
        ...
        ?>
          ...
          <?php
        if(isset($_POST['fecha'])){
            $aprobar = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Aprobado' and a.fecha_reg_c between '".$fecha."'  and '".$fecha2."' and b.usuario like '".$_POST['empresa']."%' and  a.registrado=b.usuario group by b.usuario order by count(*) desc");
        ...
        $fila=  mysqli_fetch_array($result);
            ...
            $aprobar = mysqli_query($conexion,"SELECT count(*), concat(b.nombre, ' ',b.apellido) as nombre_completo FROM cotizacion a, usuarios b where a.estado='Aprobado' and a.registrado=b.usuario group by b.usuario order by count(*) desc");
