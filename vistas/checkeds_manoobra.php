                      ...
                      <!-- START Widget Collapse -->
                        ...
                        <div class="span12 widget dark stacked">
                            ...
                            <header>
                                ...
                                <h4 class="title">Listado de Mano de Obra</h4>
                        ...
                        <div class="span12 widget lime">
                            ...
                            <section class="body">
                                ...
                                <div class="body-inner no-padding">
                                    ...
                                    <form name="buscarA" action="../vistas/checkeds_manoobra.php?cod=<?php echo $_GET['cod'] ?>&add" method="post" enctype="multipart/form-data">
...
$request=mysqli_query($conexion,"SELECT * FROM `referencia_mo` ");
}
...
//    echo'<hr>';
	...
	{       
                  $cont=$cont+1;
                  $table = $table.'<tr>
                <td  width="10%">'.$row["id_ref_mo"].'</td>'
                          . '<td width="40%">'.$row['descripcion_mo'].'</a></td>'
                          . '<td width="10%">'.$row['referencia'].'</a></td>'
                          . '<td  width="10%">'.$row["valor_mo"].'</td><td  width="10%">'.$row["instalacion"].'</td>
               <td width="10%"><input type="checkbox" value="'.$row["id_ref_mo"].'" name="id'.$cont.'"></td>
                   </tr>';   
