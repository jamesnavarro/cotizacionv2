...
<html>
    <head>
        ...
        <script src="controlador.js?v=<?php echo rand(1, 999) ?>"></script>
    </head>
    <body>
        <div>
                       ...
                       <table class="tbl-registro" width="100%">
                           <tr>
                               ...
                               <td>Radicado
                                   <?php 
                                       //if($acces_user[33]=='1'){
                                       if($_SESSION['k_username']=='admin' || $_SESSION['k_username']=='JRACINI'){
                                       ?>
                                   <button onclick="fom_savemovimiento()" id="btnfom">F</button>
                                   <?php } ?>
                               </td>
