...
//    echo'<hr>';
       $table = '<table class="table table-bordered table-striped table-hover" id="">';
             $table = $table.'<thead >';
              ...
              $table = $table.'</tr>';
              $table = $table.'</thead>';
 $reques=mysqli_query($conexion,"SELECT * FROM producto a, cotizaciones c, producto_rep_rej b, referencias d where b.id_referencia=d.id_referencia and a.id_p=b.id_p and c.id_referencia=a.id_p and c.id_cot=".$_GET["cot"]." ");
$total2=0;
        $tacot =0;
        $cont =0; $xx=0; 
        $peso_rej=0;
...
$request_maq=mysqli_query($conexion,"SELECT * FROM producto a, producto_rep_mo b, referencia_mo c, cotizaciones d where  d.id_referencia=a.id_p and  b.id_ref_mo=c.id_ref_mo and a.id_p=b.id_p and d.id_cot=".$_GET["cot"]);
