<script> 
   ...
   function ver_cotizacion2(cot){
       window.open("../vistas/sala_ventas_1.php?c="+cot,"Pruebas","width=1300px, height=600px");
   }
                            ...
                            <nav id="nav" class="accordion">
                                <ul id="navigation">
                                    ...
                                    <li class="accordion-group">
                                        ...
                                        <?php
                                        $sin = mysqli_query($conexion,"select count(*) from producto where aprobado=0");
                                        $sip = mysqli_fetch_array($sin);
                                        ?>
                                        <ul id="submenu3" class="<?php  if($_GET['id']=='lista_anuladas' ||$_GET['id']=='lista_ok' ||$_GET['id']=='lista' || $_GET['id']=='add_cot' || $_GET['id']=='lista_sa' || $_GET['id']=='add_fachada' || $_GET['id']=='lineas' || $_GET['id']=='add_fac'){echo 'collapse in';}else{echo 'collapse';}  ?>">
                                            ...
                                            <li class=""><a href="../vistas/?id=monty2"><span class="icon icone-angle-right"></span>Productos Monty 2</a></li>
                                    ...
                                    <li class="accordion-group ">
                                        ...
                                        <!-- START Submenu Menu -->
                                        <ul id="submenu10" class="<?php  if($_GET['id']=='add_vidrios' ||$_GET['id']=='conf_kits' ||$_GET['id']=='md' || $_GET['id'] == 'maq' || $_GET['id']=='porcentajes' || $_GET['id']=='add_per' || $_GET['id']=='temple' || $_GET['id']=='add_gastos' || $_GET['id']=='add_mo' || $_GET['id']=='add_otro' || $_GET['id']=='precios' || $_GET['id']=='precios_area' || $_GET['id']=='color'){echo 'collapse in';}else{echo 'collapse';}  ?>">
...
<!--                                            <li class=""><a href="../vistas/?id=precios"><span class="icon icone-angle-right"></span> Lista de Precios</a></li>-->
                                            ...
                                            <li class=""><a href="../vistas/?id=color"><span class="icon icone-angle-right"></span>Acabados de Aluminios</a></li>
                                            <li class=""><a href="../vistas/?id=add_per"><span class="icon icone-angle-right"></span>Lista de Materiales</a></li>
                                            <li class=""><a href="../vistas/?id=add_vidrios"><span class="icon icone-angle-right"></span>Lista de Vidrios</a></li>
                                            ...
                                            <li class=""><a href="../vistas/?id=md"><span class="icon icone-angle-right"></span>Costo aluminio crudo</a></li>
                                    ...
                                    <?php 
                                           if($_SESSION['k_username']=='admin'){
                                               $rex=mysqli_query($conexion,"SELECT count(*) FROM requerimientos where estado!='Solucionado' ");
                                           }else{
                                               $rex=mysqli_query($conexion,"SELECT count(*) FROM requerimientos where estado!='Solucionado' and usuario='".$_SESSION['k_username']."' ");
                                           }
                                           
                                           $t = mysqli_fetch_array($rex);
                                           $y = $t['count(*)']
                                          ?>
                                    <li class="accordion-group ">
