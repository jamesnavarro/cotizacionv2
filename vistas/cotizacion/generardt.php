<?php
$sqle=mysqli_query($conexion, "SELECT relacionado  FROM orden_detalle a, cotizaciones b, producto c where a.codigo=".$_GET['id']." and a.parte_otro = 0 AND a.relacionado = b.id_cotizacion AND b.id_referencia = c.id_p group by c.id_p");
$roe=mysqli_fetch_assoc($sqle);

 include 'consultar_item.php';
 include 'consultar_vidrio.php';
$costo_total_item = 0;
$costo_total_item_desp = 0;
$cantidad_cotizada = $cant_item = $_GET['can'];
 ?>
...
<div class="row-fluid"> 
  ...
  <form class="span12 widget shadowed dark form-horizontal bordered" action="<?php if(isset($_GET['item'])){echo '../modelo/producto.php?editar='.$_GET['cod'].'';}else{echo '../modelo/producto.php';} ?>" method="post" id="form_validate_html" enctype="multipart/form-data">
                            <header><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
                                <h4 class="title">DT DEL PRODUCTO <?php echo $roe[0] ?></h4>
                                ...
                                <div class="body-inner"> 
                                        ...
                                        <center>   <table class="table table-bordered table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if(isset($_GET['can'])){echo $cant_item;} ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <?php echo 'Item No.: '.$id_referencia.'<br>Id dolar: '.$dolar_actual; ?>
                                                    </td>
                                                </tr>
