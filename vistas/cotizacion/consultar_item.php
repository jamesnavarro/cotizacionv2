<?php
 $sql21 = ("SELECT * FROM producto a, cotizaciones c where c.id_referencia=a.id_p and c.id_cotizacion=".$_GET['item']."");
            ...
            $result_cie = mysql_query("SELECT descripcion FROM referencias   where id_referencia='$cierres' ");
            $cie = mysql_fetch_array($result_cie);
            $descierres = $cie[0];
            
            $result_rod = mysql_query("SELECT descripcion FROM referencias   where id_referencia='$rodajas' ");
