...
$request_ack=mysql_query("SELECT * FROM referencia_acce a, referencias b where a.num_ref=b.id_referencia and a.cotizacion=".$_GET['cot']." and a.id_cot=".$_GET['idcot']."  ");
...
$request4=mysql_query("SELECT * FROM producto a, cotizaciones_kit b where a.id_p=b.id_producto and b.id_cot=".$_GET['cot']." and b.id_prod_mas=".$_GET['idcot']." and b.comp='1'  ");
...
$fi =mysql_fetch_array(mysql_query($coti));
$d1= $fi["desc"]/100;
