...
//                  echo '<fieldset style="height:670px;">';
					...
					$table3 = $table3 .'<th  width="24%" style="font-size:8px; color:white">' . 'DISEÑO' . '</th>';
...
if($row['msg']!=''){$noti='<br><b> <font color="red">'.$row['msg'].' </b>';}else{$noti='';}
    ...
    $table3 = $table3.'<tr>'
                    ...
                    . '<td  width="24%"><p align="center">'.$img.' </p></td>
                       <td  width="3%" style="font-size:8px"><p align="center">'.$row["cantidad_c"].' </p></h6></td>
                       <td  width="7%" style="font-size:8px"><p align="center">$'.number_format($unidad_aiu_und).'</p></td>
                       <td  width="8%" style="font-size:8px"><p align="center">$'.number_format($unidad_aiu_total).'</p></td></tr></div>';   
           $table3 = $table3.'</table>';
           $nombr ='';$nombr2='';
                echo $table3;
                ...
                if ($cont == $_GET['total_item']) {//Codigo Agregado (Jaime)
                    ...
                    echo '<p align="justify" style="font-size:9px">Nota: ' . $fila3['nota'] . '</p><br>';
                    if ($ft2 == 0) {
//                        if(isset($_GET['extra'])){
                            ...
                            $aiu_iva = $aiu_uti * 1.19;
                            $aiu_iva_total = $aiu_iva - $aiu_uti;
                            $aiu_gran_total = $aiu_adm+$aiu_imp+$aiu_uti+$aiu_iva_total+$aiu_total;
                    
                    echo '<table  align="right" class="estilo2" border="1"  cellpadding="0" cellspacing="0">'
                . '<tr BGCOLOR="#13173B"><td style="font-size:80%;color:white;" width="180px" align="right">SUB TOTAL.: $<td align="right" width="100px" style="font-size:80%;color:white;">'.  number_format($aiu_total).'</td></tr>'
                . '<tr BGCOLOR="#13173B"><td style="font-size:80%;color:white;" width="180px" align="right">ADMINISTRACION 10%: $<td  align="right" width="100px" style="font-size:80%;color:white;">'.  number_format($aiu_adm).'</td></tr>'
                              . '<tr BGCOLOR="#13173B"><td style="font-size:80%;color:white;" width="180px" align="right">IMPREVISTO 10%: $<td  align="right" width="100px" style="font-size:80%;color:white;">'.  number_format($aiu_imp).'</td></tr>'
                              . '<tr BGCOLOR="#13173B"><td style="font-size:80%;color:white;" width="180px" align="right">UTILIDAD 5%: $<td  align="right" width="100px" style="font-size:80%;color:white;">'.  number_format($aiu_uti).'</td></tr>'
                              . '<tr BGCOLOR="#13173B"><td style="font-size:80%;color:white;" width="180px" align="right">IVA UTILIDAD: $<td  align="right" width="100px" style="font-size:80%;color:white;">'.  number_format($aiu_iva_total).'</td></tr>'
                            . '<tr BGCOLOR="#13173B"><td style="font-size:80%;color:white;" width="180px" align="right">TOTAL: $<td  align="right" width="100px" style="font-size:80%;color:white;">'.  number_format($aiu_gran_total).'</td></tr>'
                . '</table><br><br>';
//                }else{
//                        echo '<table  align="right" class="estilo2" border="1"  cellpadding="0" cellspacing="0">'
...
//                }
                        ...
                        echo '<table  align="right" class="estilo2" border="1"  cellpadding="0" cellspacing="0">'
                        . '<tr BGCOLOR="#13173B"><td style="font-size:80%;color:white;" width="180px" align="right">TOTAL REF.: $<td align="right" width="100px" style="font-size:80%;color:white;">' . number_format($aiu_total) . '</td></tr>'
                        . '</table><br>';
                        $t1 = ($tad - $des);
                    }
                }
...
//-----------------------------------------servicios-----------------------------------------------
            $request2 = mysqli_query($conexion,"SELECT * FROM referencia_mo a, cotizaciones_servicios b where a.id_ref_mo=b.id_servicio and b.id_cotizacion=" . $_GET['cot'] . " and b.id_cot_mas=0 and suma!='No'");
            ...
            $fr = ($row2["precio_servicio"]) ; 
             ...
             $total_serv = $dd / 0.336;
                    ...
                    $srvund = (($total_serv ) / $row2["cantidad_serv"]);
                     $unidad_aiu = $srvund * 1.19;
                $unidad_aiu2 = ($unidad_aiu * ((20.6034140531967/100)+1))-$unidad_aiu;
                $unidad_aiu_und = $unidad_aiu-$unidad_aiu2;
                $unidad_aiu_total = $unidad_aiu_und * $row2["cantidad_serv"];
                $aiu_total_serv += $unidad_aiu_total;
                    $table2 = $table2 . '<tr>'
                            ...
                            . '<td width="10%" style="font-size:8px;"   align="center">$ ' . number_format($unidad_aiu_und) . '</td>'
                      
                            . '<td width="10%" style="font-size:8px;"   align="center" >$ ' . number_format(($unidad_aiu_total)) . '</td>'
                            . '</tr>';
                }
                $table2 = $table2 . '</table>';
				...
				echo "<br>";
                echo '<table  align="right" class="estilo2" border="1"  cellpadding="0" cellspacing="0">'
                . '<tr BGCOLOR="#13173B"><td style="font-size:80%;color:white;" width="180px" align="right">TOTAL SERV.: $<td align="right" width="100px" style="font-size:80%;color:white;">' . number_format($aiu_total_serv) . '</td></tr>'
                . '</table><br>';
            } else {
                $to_serv = 0;
            }
