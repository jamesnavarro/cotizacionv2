...
if(isset($_GET['cot'])){ 
 $request=mysql_query("SELECT * FROM producto a, cotizaciones c where c.id_compuesto=0 and c.id_referencia=a.id_p and c.id_cot=".$_GET["cot"]." order by c.fila asc ");
...
//            mysql_query($sq, $conexion);
            ...
            mysql_query($sqlm, $conexion);
                  ...
                  mysql_query($sqlr, $conexion);echo '<script lanquage="javascript">alert("Se ha Actualizado los porcentajes");location.href="../vistas/porcentajes.php?cot='.$_GET['cot'].'&cli='.$_GET['cli'].'"</script>'; 
}}
if(isset($_GET['por1'])){
