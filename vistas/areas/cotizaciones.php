<?php 
$request=mysqli_query($conexion,'select count(*) from cotizacion where estado="Cotizado"');
if($request){
...
if(isset($_POST['nombre']) || isset($_POST['fecha']) || isset($_POST['user'])){
    ...
    $request=mysqli_query($conexion,"SELECT * FROM cotizacion a where  a.estado='Cotizado'  and a.id_cliente like '%".$_POST['nombre']."%' and a.fecha_reg_c like '%".$fecha."%' and a.registrado like '%".$_POST['user']."%'");
}else{
$request=mysqli_query($conexion,"SELECT * FROM cotizacion a where a.estado='Cotizado' ".$limit);
  }
