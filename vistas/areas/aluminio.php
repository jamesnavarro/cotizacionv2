...
$res=mysqli_query($conexion,"SELECT * FROM subproceso where sede_sub='Aluminio'");
...
if(isset($_GET['orden'])){
    $request=mysqli_query($conexion,'select * from producto a, subproceso b, pt_procesos c, orden_detalle d, procesos_activos e where e.save=1 and a.id_p=c.id_proceso and c.id_subpro=b.id_subpro and b.id_subpro='.$valor1.'  and e.barra='.$_GET['orden'].' and a.id_p=d.id_producto and d.id_orden_d=e.id_orden_d and e.paso=c.orden ');

}else{
    $request=mysqli_query($conexion,'select * from producto a, subproceso b, pt_procesos c, orden_detalle d, procesos_activos e where e.save=1 and a.id_p=c.id_proceso and c.id_subpro=b.id_subpro  and b.id_subpro='.$valor1.' and  a.id_p=d.id_producto and d.id_orden_d=e.id_orden_d and e.paso=c.orden');
