 ...
 if($s[0]){
     ...
     $disabled = '';
                 ...
                 <td colspan="5"><b>SOLICITUD DE COMPRA</b></td>
                             ...
                             <table class="table table-bordered table-striped table-hover" style="width:100%">
                                           ...
                                           <tbody id="mostrar_items">
                                            <?php
                                                    $cot = $_GET['cot'];
        $query = mysql_query("select * from  solicitudes_items where id_cotizacion='$cot' order by referencia_sc, perfil_sc asc");
        $iten = 0;
        $pesot=0;
        $areat=0;
        $co = 0;
        while($m = mysql_fetch_array($query)){
            ...
            $result = mysql_query("select * from  referencias where codigo='".$m['codigo']."'");
