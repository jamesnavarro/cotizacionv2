...
<?php
    ...
    <html>
        ...
        <body onload="window.print()">
            ...
            function tabla($RR) {
                $request = mysql_query("SELECT * FROM producto a, cotizaciones c where c.id_referencia=a.id_p and c.id_cot=" . $_GET["cot"] . " and c.id_compuesto=0 order by c.tip asc");
