...
<?php 
 ...
 $sql21 = "SELECT * FROM cotizacion where id_cot=".$_GET['cot'];
	...
	$i = 0;
	$table2 = "";
    $request1=mysqli_query($conexion,"SELECT * FROM producto a, cotizaciones c WHERE id_compuesto=0 and c.id_referencia = a.id_p AND c.id_cot = '" . $_GET['cot'] . "' ORDER BY c.fila ASC");
	if($request1){
		...
		while ($row_total_vidrios = mysqli_fetch_array($query_total_vidrios)) {
			...
			if ($row_total_vidrios['pertenece'] == 1) {
				...
				if ($row['id_vidrio'] != 0) {
					...
					$resultc = mysqli_query($conexion,$consulta);
					$total = 0;
					$total_TEMPLE = 0;
					$total_KG = 0;
					$total_UND = 0;
				...
				if($row['id_vidrio2'] != 0){
					...
					while ($fila = mysqli_fetch_array($result6)) {
						...
						if ($valor1 == '7') {
							...
							$fit = mysqli_fetch_array(mysqli_query($conexion,$st4));
							$cost = $fit['costo'];
							$st = $m2 * $cost;
							$total_TEMPLE = $total_TEMPLE + $st;
						} else {
				...
				if ($row['id_vidrio3'] != 0) {
					...
					while ($fila = mysqli_fetch_array($result7)) {
						...
						if ($valor1 == '7') {
							...
							$fit = mysqli_fetch_array(mysqli_query($conexion,$st7));
							$cost= $fit['costo'];
							$st = $m2 * $cost;
							$total_TEMPLE = $total_TEMPLE + $st;
						} else {
				...
				if ($row['id_vidrio4'] != 0) {
					...
					$result8 =  mysqli_query($conexion,$consulta7);
					$total = 0;
					$total_TEMPLE = 0;
					$total_KG = 0;
					$total_UND = 0;
					...
					while ($fila = mysqli_fetch_array($result8)) {
						...
						if ($valor1 == '7') {
							...
							$fit = mysqli_fetch_array(mysqli_query($conexion,$st8));
							$cost = $fit['costo'];
							$st = $m2 * $cost;
							$total_TEMPLE = $total_TEMPLE + $st;
						} else {
				...
				if ($row['id_vidrio5'] != 0) {
					...
					$result9 = mysqli_query($conexion,$consulta9);
					$total = 0;
					$total_TEMPLE = 0;
					$total_KG = 0;
					$total_UND = 0;
					...
					while ($fila = mysqli_fetch_array($result9)) {
						...
						if ($valor1 == '7') {
							...
							$fit = mysqli_fetch_array(mysqli_query($conexion,$st9));
							$cost = $fit['costo'];
							$st = $m2 * $cost;
							$total_TEMPLE = $total_TEMPLE + $st;
						} else {
				...
				if ($row['id_vidrio6'] != 0) {
					...
					$total_und = 0;
					$stt = 0;
					while ($fila = mysqli_fetch_array($result11)) {
						$valor1 = $fila['id_subpro'];
						$valor2 = $fila['nombre_subpro'];
						$precio_a = $fila['precio'];
						$und_med = $fila['medida'];
						...
						if ($valor1 == '7') {
							...
							$fit = mysqli_fetch_array(mysqli_query($conexion,$st11));
							$cost = $fit['costo'];
							$st = $m2 * $cost;
							$total_TEMPLE = $total_TEMPLE + $st;
						} else{
