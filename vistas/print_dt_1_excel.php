...
<?php
 ...
 $fil =mysql_fetch_array(mysql_query($sql));
        ...
        $sql4='select * from cotizaciones where id_cotizacion="'.$_GET['idcot'].'"';
         $rf =mysql_fetch_array(mysql_query($sql4));
         $rf['pelicula'];
                            ...
                            <section class="body">
                                <div class="body-inner">
                                       ...
                                       <center>   <table class="CSSTableGenerator">
                                                ...
                                                <tr>
                                                    <td colspan="6">DESCRIPCION TECNICA DE <?php if(isset($_GET['ref'])){echo $producto;} ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                        <td>Anchura Cuerpo Fijo ó rejilla</td>
                                                    <td><?php if(isset($_GET['ref'])){echo $anchura;} ?></td>
                                                
                                                    <td>Anchura de Ventana Corrediza</td>
                                                    <td><?php if(isset($_GET['ref'])){$anchura_v_c =$_GET['ancho']- $anchura; echo $altura_v_c;} ?></td>
                                                </tr>
...
if(isset($_GET['cot'])){ 
 $requestcomp=mysql_query("SELECT * FROM producto a, cotizaciones_sub c, tipo_vidrio d where d.id_vidrio=c.id_vidrio_sub  and c.id_referencia_sub=a.id_p and c.id_cot_sub=".$_GET["cot"]." and c.id_producto_cot=".$_GET['idcot']."");
