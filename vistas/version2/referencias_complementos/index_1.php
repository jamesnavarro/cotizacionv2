        ...
        <div class="page-content">
            ...
            <div style="border: 1px solid #307ECC;box-shadow: 0 0 5px #307ECC;" class="col-xs-12">
                ...
                <div class="datagrid">
                    ...
                    $codigo=$_GET['sistema'];
                    $p = explode(",", $codigo);
                    $codigo = "'".$p[0]."','".$p[1]."','".$p[2]."','".$p[3]."','".$p[4]."'";
                            if($_GET['parametro']=='tipo_cie'){
                                $mod = 'Cierres';
                            }else if($_GET['parametro']=='tipo_rod'){
                                $mod = 'Rodajas';
                            }else if($_GET['parametro']=='tipo_bis'){
                                $mod = 'Bisagras';
                            }else{
                                $mod = 'Brazos';
                            }
                    ...
                    <table class="table table-bordered table-condensed table-hover">
                                <thead>
                                    <tr>
                                           <th>Codigo</th>
                                           <th>Descripcion Kits <?php  echo $mod ?></th>
                                            <th>Valor</th>
                        ...
                        <tbody id="">
                            ...
                            $result = mysqli_query($con,"SELECT * FROM receta_kits a, receta_kits_sistemas b where a.idkit=b.idkit and b.sistema in ($codigo) and a.modulo='$mod' ");
                            $costo=0;
