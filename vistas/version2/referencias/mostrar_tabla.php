...
$request=mysql_query('SELECT referencia FROM referencias where referencia like "%'.$_GET['ref'].'%"  and descripcion like "%'.$_GET['des'].'%" and grupo="Perfileria"  group by referencia ') or die(mysql_error());
            if($request){
            ...
            echo '<tr><td colspan="3">';
                ...
                ?>
                                    ...
                                    $sql = mysql_query("SELECT * FROM `referencias` where referencia like '%".$_GET['ref']."%'  and descripcion like '%".$_GET['des']."%' and grupo='Perfileria' group by referencia "
                                            . " ".$limit);
			$item = 0;
