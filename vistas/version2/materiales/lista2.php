...
if(isset($_SESSION['k_username'])){
    ...
    $col=$_GET['col'];
    $page= $_GET['page'];
    $request = mysqli_query($conexion,"SELECT count(*) FROM referencias where codigo like '%".$cod."%' and descripcion like '%".$des."%' and referencia like '%".$ref."%'  and estado_cr = '".$est."'  and colores like '%".$col."%' ");
...
$request_ac = mysqli_query($conexion,"SELECT * FROM referencias where  codigo like '%".$cod."%' and descripcion like '%".$des."%' and referencia like '%".$ref."%'  and estado_cr = '".$est."'  and colores like '%".$col."%' " .$limit );
 $total2=0;
