...
<!--    Brazos <input type="checkbox" name="brazos" <?php if(isset($_GET['cod'])){echo $check_bra;} ?> value="true"> |
...
//    echo'<hr>';
	...
	{    
           ...
           $formula = '('.$nw_ope.''.$x.''.$s.''.$row["descuento"].')'.$row["signo"].''.$row["variable"];
                                               ...
                                               <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td><select name="lado" style="width:80px;">
                                                      ...
                                                      <td>Multiplica por Horizontales | Verticales <select name="mul" style="width:60px">
                                                              <?php echo '<option value="'.$mul.'">'.$mul.'</option>'; ?>
                                                              <option value="Si">Si</option>
                                                               <option value="No">No</option>
                                                          </select> X <select name="ambos" style="width:60px">
                                              <?php echo '<option value="'.$ambos.'">'.$ambos.'</option> '; ?>
                                                <option value="1">1</option> 
                                                <option value="2">2</option> 
                                              </select></td>
                                                      <td>
                                                           Ambos lado del perfil
                                                  </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea id="obs_n" name="obs_n" class="form-control" style="width:  290px;" placeholder=""> <?php echo $obs; ?></textarea></td>
                                                </tr>
                                            </table>
...
$sqlx=("SELECT * FROM producto a, producto_rep_alu b, referencias c where b.id_ref_alum=c.id_referencia and a.id_p=b.id_p and a.id_p=".$_GET['cod']." and b.id_r_a=".$rowz["id_referencia_med"]."");
           ...
           $cant_rej = number_format(($al / $rowz['var3']) * $rowz['multiplo']);
            ...
            //----------------------------------------
             ...
             $taa = $cant_rej * $res;
            $table = $table.'<tr><td width="5%">'.$row['codigo'].'</td><td width="30%">'.$row['descripcion'].'<br><i>'.$row['observacion_acc'].'</i></td><td width="5%">'.$row['referencia'].'</td><td width="7%">'.$row['lado'].'</td><td width="7%">'.$row["color_acc"].'<font></a></td><td width="5%">'.$row["yes"].'<font></a></td>
               <td width="5%">'.$taa.' '.$row["calcular"].'</font></td><td width="7%">'.$valor.'</font></td><td class="hidden-phone">'.$row["para"].'</font></td>'
                    . '<td><a href="../vistas/?id=nuevo_producto&cod='.$_GET['cod'].'&up_5='.$row["id_r_ac"].'"><button><img src="../imagenes/modificar.png"></button></a> </td><td> <a href="../vistas/?id=nuevo_producto&cod='.$_GET['cod'].'&del_4='.$row["id_r_ac"].'"><button><img src="../imagenes/eliminar.png"></button></a></font></td></tr>';   
                                        ...
                                        <div class="control-group">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><textarea id="obs_n" id="obs_n" class="form-control" style="width:  290px;" placeholder=""></textarea></td>
                                                </tr>
                                            </table>
