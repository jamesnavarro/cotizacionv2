...
//require '../vistas/empresa/otros.php';
                                ...
                                if(isset($_GET['cod'])){
$request=mysql_query("SELECT * FROM cotizacion a, sis_empresa c where  a.id_cliente=c.id_empresa and a.id_cliente='".$_GET['cod']."'");
if($request){
...
$request=mysql_query("SELECT * FROM cotizacion a, sis_empresa c where  a.id_cliente=c.id_empresa and a.id_cliente='".$_GET['cod']."' ".$limit);
