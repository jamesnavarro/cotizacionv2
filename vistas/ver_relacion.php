...
<?php 
    ...
    $request=mysql_query("SELECT * FROM producto a, producto_rep_alu b where  a.id_p=b.id_p and b.id_ref_alum=".$_GET["id_refe"]." group by a.id_p ");

    while($datos = mysql_fetch_array($request)){
