        ...
        <body>
            ...
            function tabla($RR) {
                ...
                <table class="estilo1" border="0"  cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th ALIGN=left>PRINT: </th><td><?php echo date('Y-m-d') . ' ' . $hora; ?></td>

                        <th ALIGN=left>REGISTERED:</th>
                        <td><?php echo $fila3['fecha_reg_c'] . ' By: ' . $fila3['grabado']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php ?> </td>
                    </tr>
...
//                  echo '<fieldset style="height:670px;">';
					...
					$table3 = $table3 .'<th width="4%" style="font-size:8px; color:white">' . 'REF'.'</h6></th>';
					$table3 = $table3 .'<th width="35%" style="font-size:8px; color:white">' . 'GLASS TYPE ' . '</th>';
			
					$table3 = $table3 .'<th width="8%" style="font-size:8px; color:white">WIDTH(in)</th>';
					$table3 = $table3 .'<th  width="8%" style="font-size:8px; color:white">HEIGHT(in) </th>';
					$table3 = $table3 .'<th  width="5%" style="font-size:8px; color:white">TOTAL (SqFt) </th>';
					$table3 = $table3 .'<th  width="3%" style="font-size:8px; color:white">' . 'QTY.' . '</th>';
					$table3 = $table3 .'<th  width="6%" style="font-size:8px; color:white">UNIT PRICE </th>';
					$table3 = $table3 .'<th  width="6%" style="font-size:8px; color:white">TOTAL USD </th>';
					$table3 = $table3 . '</tr>';
					$table3 = $table3 . '</thead>';
                } else {
                    $table3 = '<table   border="1"  class="estilo2" width="965px">';
                ...
                if($row['descripcion_ingles']==''){
                    $descripcion = strtoupper($row['producto']).' '.$esp.' '.strtoupper($obs).' '.strtoupper($v).' '.strtoupper($peli).'  '.strtoupper($d1).'  '.strtoupper($obs2).'  '.$noti.''.$noti2.'<br>'.$row["descripcion_rollo"].''.$poli.' '.$referencia;
                }else{
                    $descripcion = $row['descripcion_ingles'];
                }
    ...
    $table3 = $table3.'<tr>'
            ...
            . '<td width="4%"  height="20" style="font-size:8px"><p align="center">'.$row['tip'].'</p></td>          
                       <td width="35%" style="font-size:8px"><p align="justify">  '.$descripcion.'</p></td>'
                    . '<td width="8%" style="font-size:8px"><p align="center">'.number_format($pulg1,2,',','.').'</p></td>             
                       <td  width="8%" style="font-size:8px"><p align="center">'.number_format($pulg2,2,',','.').'</p></td>'
                    . '<td  width="5%" style="font-size:8px"><p align="center">'.number_format($sqft,2,',','.').'</p></td>
                       <td  width="3%" style="font-size:8px"><p align="center">'.$row["cantidad_c"].' </p></h6></td>
                       <td  width="7%" style="font-size:8px"><p align="center">$'.number_format(($precio_dolar/$row["cantidad_c"]),2,',','.').'</p></td>
                       <td  width="8%" style="font-size:8px"><p align="center">$'.number_format($precio_dolar,2,',','.').'</p></td></tr></div>';   
           $table3 = $table3.'</table>';
           $nombr ='';$nombr2='';
                echo $table3;
			...
			//echo $cont;
                if ($cont == $_GET['total_item']) {//Codigo Agregado (Jaime)
                    ...
                    $table4 = '<table border="1"  class="estilo2" width="965px"><tr BGCOLOR="#13173B">'
                             . '<td width="2%" style="font-size:8px"></td>'
            . '<td width="4%"  height="20" style="font-size:8px"></td>          
                       <td width="35%" style="font-size:8px; color:white"><p align="justify"></td>'
                    . '<td width="8%" style="font-size:8px; color:white"></td>             
                       <td  width="8%" style="font-size:8px"></td>'
                    . '<td  width="5%" style="font-size:8px; color:white"><p align="center">'.number_format($sqft,2,',','.').'</p></td>
                       <td  width="3%" style="font-size:8px; color:white"><p align="center">'.$cantidad_glass.' </p></h6></td>
                       <td  width="7%" style="font-size:8px; color:white"><p align="center">TOTAL</td>
                       <td  width="8%" style="font-size:8px; color:white"><p align="center">$'.number_format($total_usd,2,',','.').'</p></td></tr></table>';
...
//---------------------------------fin kit---------------------------------------------
        ...
        echo '<br><br><footer>
        <div class="define">
            <p>TEMPLADO S.A CALLE 72 No 65-228, TEL : 57-5-3530218 , FX:57-5-3600173<br>BARRANQUILLA-COLOMBIA<br>www.templadosa.com - ventas@templadosa.com<br>Pág ' . $pag2 . '</p>
        </div>
    </footer>';
        ?>
        <h5></h5>&nbsp;
