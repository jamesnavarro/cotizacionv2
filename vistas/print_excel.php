...
<?php  }  ?>       
   ...
   $pag = 0;
	...
	{    
             ...
             if($cont==$a1 || $cont==$a2 || $cont==$a3 || $cont==$a4 || $cont==$aa5 || $cont==$aa6 || $cont == $aa7 || $cont==$aa8  || $cont==$aa9 || $cont==$aa10 || $cont==$aa11|| $cont==$aa12|| $cont==$aa13|| $cont==$aa14|| $cont==$aa15|| $cont==$aa16|| $cont==$aa17|| $cont==$aa18|| $cont==$aa19|| $cont==$aa20|| $cont==$aa21|| $cont==$aa22|| $cont==$aa23|| $cont==$aa24){
                $pag +=1;
             ...
             $table3 = $table3.'<thead >';
              ...
              $table3 = $table3.'<th width="8%" style="font-size:8px; color:white">'.'VIDRIO'.'</th>';
               ...
               $table3 = $table3.'<th  width="3%" style="font-size:8px; color:white">'.'UND'.'</th>';
                $table3 = $table3.'<th  width="5%" style="font-size:8px; color:white">'.'VLR UND.'.'</th>';
               $table3 = $table3.'<th  width="10%" style="font-size:8px; color:white">'.'V.TOTAL'.'</th>';
    ...
    while ($fila=mysql_fetch_array($compu)){
          ...
          $costo_fom_mp += $fila['valor_fom_sub'];
           ...
           $a = ((($row["valor_c"] + $tk)) + $pad) / $mult ;
            ...
            if($row["cuerpo"]!=0){$mx = '<br>- Cuerpo Fijo: '.$row["cuerpo"].' mm';}else{$mx = '';}
            $pu = ($a/$row["cantidad_c"]);
...
if($fv24['color_v']==''){$v24 = '';}else{$v24 = '+'.$fv24['color_v'];}
   ...
   $mc='';
   $img2 = '';
    $compu =mysql_query("SELECT * FROM producto a, cotizaciones_sub c, tipo_vidrio d where d.id_vidrio=c.id_vidrio_sub  and c.id_referencia_sub=a.id_p and c.id_cot_sub=".$_GET["cot"]." and c.id_producto_cot=".$row["id_cotizacion"]."");
    $art = 0;      
    while ($fila=mysql_fetch_array($compu)){
           IF($fila["ruta"]==''){
                $img3 = '<img src="../producto/no.jpg" width="60" heigth="40">';
      ...
      if($row['pelicula']=='No Aplica'){
                ...
                if($row['pelicula']=='Una Cara'){
                    ...
                    $peli = '<br>'.$fila21['descripcion_mo'];
            }else{
                  
               $peli = '<br>'.$fila21['descripcion_mo'].' ambos lados';
            }
            }
    if($row['install']=='Si'){
    ...
    $table3 = $table3.'<tr>'
                    ...
                    . '<td  width="26%"><p align="center"></td>
                       <td  width="3%" style="font-size:8px"><p align="center">'.$row["cantidad_c"].' </p></h6></td>
                       <td  width="5%" style="font-size:8px"><p align="center">$'.number_format($pudt).'</p></td>
                       <td  width="10%" style="font-size:8px"><p align="center">$'.number_format($ptt2).'</p></td></tr></div>';   
           $table3 = $table3.'</table>';
...
if($csv!=0){
       ...
       $table2 = '<table  class="estilo2" border="1"  cellpadding="0" cellspacing="0">';
             $table2 = $table2.'<thead >';
              ...
              $table2 = $table2.'<th width="40%" style="font-size:10px; color:white">'.'Descripcion del servicio'.'</th>';
	...
	{       
        ...
        $fr = ($row2["valor_mo"] + $tota) / $pr;
            ...
            $table2 = $table2.'<tr>'
                    ...
                    . '<td width="10%" style="font-size:10px;"  align="center" >'.$row2['id_ref_mo'].'</td>'
                    . '<td width="40%" style="font-size:10px; "  align="center">'.$row2['descripcion_mo'].'</td>'
...
//    echo'<hr>';
	...
	{       
            ...
            $table2 = $table2.'<tr><td width="5%" style="font-size:10px;" align="center">'.$total2.'</a></td>'
                    ...
                    . '<td width="40%" style="font-size:10px;" align="center">'.$row21['descripcion'].' '.$cm.'</font></td>'
