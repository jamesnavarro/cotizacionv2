...
if(isset($_SESSION['k_username'])){ 
    ...
    $nombres= $_GET['nombb'];
    $page= $_GET['page'];
            $request = mysqli_query($conexion,"SELECT count(*) FROM categoria_costo where nombre like '%".$nombres."%' ");
            if($request){
...
<div class="table-responsive">  
  ...
  <table class="table table-hover">
    ...
    $query = mysqli_query($conexion,"SELECT * FROM categoria_costo where nombre like '%".$nombres."%' ".$limit );
