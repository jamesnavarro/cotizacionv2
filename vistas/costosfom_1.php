...
<?php  }  ?>       
 ...
 $a1 = 0 * $_GET['col'];
	...
	{    
                     ...
                     || $cont==$aa11|| $cont==$aa12|| $cont==$aa13|| $cont==$aa14|| $cont==$aa15|| $cont==$aa16|| $cont==$aa17|| $cont==$aa18|| $cont==$aa19|| $cont==$aa20|| $cont==$aa21){
                $pag +=1;
...
//    echo $costo_fom_mp.'<br>';
    ...
    $k =  (($row['precio_fom_sp']*1.1) +$costo_fom_mp)*$row["cantidad_c"];
    ...
    $table3 = $table3.'<tr>'
                    ...
                    <td width="23%" style="font-size:8px"><p align="justify">  '.$row['producto'].', '.$m.','.$d1.','.$row['observaciones'].', Cierre:'.$row["cierre"].''.$c.' '.$v.', Observaciones:'.$row['observaciones2'].'</p></td>
                    '
            ...
            . '<td  width="7%" style="font-size:8px"><p align="center">$'.number_format($ptt/ $row["cantidad_c"]).'</p></td>'
            . '<td  width="8%" style="font-size:8px"><p align="center">$'.number_format($mas_porc).'</p></td>'
            . '<td  width="10%" style="font-size:8px"><p align="center">$'.number_format($ptt).'</p></td>'
            . '<td  width="7%" style="font-size:8px"><p align="center">$'.number_format($ptt - $mas_porc).'</p></td>'
