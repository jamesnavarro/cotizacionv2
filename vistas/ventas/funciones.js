...
function listado(){
    var cod = $("#idp").val();
                 window.open("../vistas/ventas/listado.php","ajustes","width=1000,height=600");
}
function perfiles(){
         window.open("../vistas/materiales_ventas.php","ajustes","width=1000,height=600");
}
function kits(){
         window.open("../vistas/kit_ventas.php","ajustes","width=1000,height=600");
}
...
function update_ced(){
     var idc = $("#idc").val();
    window.open("../vistas/ventas/index.php?id="+idc,"terceros","width=300,height=300");
}
