...
session_start();
$result = mysql_query("select pvi, nom_ter from cont_terceros where id_ter=".$_GET['id']);
...
<html>
    ...
    <body>
        ...
        if(isset($_POST['update'])){
            mysql_query("update cont_terceros set pvi='".$_POST['desc']."' where id_ter='".$_POST['id']."' ");
