...
if(isset($_SESSION['k_username'])){ 
    ...
    $nombr= $_GET['nombb'];
   $page= $_GET['page'];
            $request = mysql_query("SELECT count(*) FROM costos where categoria_costos like '%".$bus."%' and descripcion like '%".$nombr."%' ");
            if($request){
...
<div class="table-responsive">  
  ...
  <table class="table table-hover">
    ...
    $query = mysql_query("SELECT * FROM costos where categoria_costos like '%".$bus."%' and descripcion like '%".$nombr."%' ".$limit );
