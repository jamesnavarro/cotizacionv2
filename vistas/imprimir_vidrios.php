...
//                  echo '<fieldset style="height:670px;">';
                ...
                $cons_vir34 = "SELECT * FROM tipo_vidrio where id_vidrio=" . $row['id_vidrio5'] . " ";
                $fv5 = mysqli_fetch_array(mysqli_query($conexion,$cons_vir34));
...
//---------------------------------fin kit---------------------------------------------
         ...
         $query = mysqli_query($conexion,"select texto_pol from politicas where id_pol=1 ");
