...
if(isset($_SESSION['k_username'])){ 
      ...
      $barrio= $_GET['barrio'];
           ...
           if($usuario==''){
            ...
            $request = mysqli_query($conexion,"SELECT COUNT(a.id_paciente),a.estado, b.nombres,b.apellidos, b.numero_doc,b.estado,a.orden_servicio,b.barrio,a.user,a.id_paciente
...
<div class="table-responsive">  
  ...
  <table class="table table-hover">
    ...
    $query = mysqli_query($conexion,"SELECT COUNT(a.id_paciente),a.estado, b.nombres,b.apellidos, b.numero_doc,b.estado,a.orden_servicio,b.barrio,a.user,a.id_paciente, b.direccion1
    ...
    while ($fila = mysqli_fetch_array($query)){
     $que = mysqli_query($conexion,"select nombre, apellido, cargo from usuarios where usuario='".$fila[8]."' ");
     $u = mysqli_fetch_row($que);
