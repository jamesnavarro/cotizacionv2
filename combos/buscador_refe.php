...
$request=mysql_query("select referencia from referencias where concat(codigo,' ', descripcion,' ', referencia) like '%".$_POST['buscador']."%'  and grupo like '%".$_POST['grupo']."%' $grupo ");
