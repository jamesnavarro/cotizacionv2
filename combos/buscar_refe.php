...
include "../modelo/consultar_permisos.php";
    $request=mysqli_query($conexion,"SELECT count(*) FROM conf_referencias where "
  ...
  $limit = 'LIMIT ' .($page - 1) * $rows_by_page .',' .$rows_by_page; 
    ...
    ?>
        ...
        <tr>
            ...
            <td><a href="../vistas/?id=referencia&up_1=<?php echo $row["id_referencia"]; ?>"><?php echo $ver; ?></a> </td>   
