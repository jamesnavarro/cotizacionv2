...
if ($m>=1){
  $reg=$fi['id_emisor'];
    ...
    if($_GET['id']=='add_vidrios'){if($acceso_conf=='Habilitado'){include '../vistas/vidrio/index.php';}else{include '../vistas/form/denied.php';}}
    ...
    if($_GET['id']=='add_gastos'){if($acceso_conf=='Habilitado'){include '../vistas/gastos/index.php';}else{include '../vistas/form/denied.php';}}
    if($_GET['id']=='md'){if($acceso_conf=='Habilitado'){include '../vistas/form/conf_dolar.php';}else{include '../vistas/form/denied.php';}}
    if($_GET['id']=='add_mo'){if($acceso_conf=='Habilitado'){include '../vistas/mano_obra/index.php';}else{include '../vistas/form/denied.php';}}
    if($_GET['id']=='add_otro'){if($acceso_conf=='Habilitado'){include '../vistas/otro_g/index.php';}else{include '../vistas/form/denied.php';}}
    ...
    if($_GET['id']=='porcentajes'){if($acceso_conf=='Habilitado'){include '../vistas/porcentajes/index.php';}else{include '../vistas/form/denied.php';}}
    ...
    if($_GET['id']=='color'){if($acceso_conf=='Habilitado'){include '../vistas/aluminio/index.php';}else{include '../vistas/form/denied.php';}}
    ...
    if($_GET['id']=='temple'){if($acceso_conf=='Habilitado'){include '../vistas/temple/index.php';}else{include '../vistas/form/denied.php';}}
    ...
    if($_GET['id']=='lista_sa'){if($acceso_conf=='Habilitado'){include '../vistas/tablas/lista_sin_aprobar.php';}else{include '../vistas/form/denied.php';}}
     if($_GET['id']=='monty2'){if($acceso_conf=='Habilitado'){include '../vistas/tablas/lista_master.php';}else{include '../vistas/form/denied.php';}}
    ...
    if($_GET['id']=='generar_dt'){if($ver_pro=='Habilitado'){include '../vistas/cotizacion/generardt.php';}else{include '../vistas/form/denied.php';}}
