...
$conexion = mysql_connect("localhost", "root", "20031123003");
mysql_select_db("virtuald_templadosa", $conexion);
for($i=1;$i<=$ct;$i++){
...
$fil =mysql_fetch_array(mysql_query($sql3));
...
$sql21 = "SELECT a.*, b.* FROM orden_detalle a, producto b where a.id_proceso=b.id_p and a.codigo='".$_GET["orden"]."' and a.id_proceso=".$_GET["pro"]." ";
        ...
        $fila22 =mysql_fetch_array(mysql_query($sql22));
        $obra= $fila22["obra"];
